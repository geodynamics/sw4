...
OBJ  = EW.o Sarray.o version.o parseInputFile.o ForcingTwilight.o \
       ...
       oddIevenJinterp.o evenIevenJinterp.o CheckPoint.o Mspace.o RandomizedMaterial.o AllDims.o Patch.o
...
sw4: $(FSW4) $(FOBJ)
	...
	@echo "******************************************************"
	cd $(builddir); nvcc -g -dlink -o file_link.o $(OBJ) $(LINKFLAGS) -lcudadevrt -lcudart -lnvidia-ml
