...
$$
where $a^2k^2=a_h^2k_x^2+a_h^2k_y^2+a_vk_z^2$, and $H$ is the Hurst exponent. $a_h$ and $a_v$ are normalized
...
$$
where $\theta$ is a generated random number, scaled to have mean zero and variance $\sigma$. \par
...
sigma  & variance of perturbation, $\sigma$  & real & None & 0.1 \\ \hline
...
seed & Random number generator seed & int & None & read from {\tt /dev/random} \\ \hline
\end{tabular}
\end{center}
