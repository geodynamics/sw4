      ...
      for (i = 1; i <= n1_f; i++) {
        ...
        lh_f(i, j, k, 1) =
            ...
            (Jacobian_f(i - 2, j, k) * lambda_f(i - 2, j, k) *
                 (u_f_t(i - 2, j - 2, k, 2) / 12.0 -
                  u_f_t(i - 2, j - 1, k, 2) * 2.0 / 3.0 +
                  u_f_t(i - 2, j + 1, k, 2) * 2.0 / 3.0 -
                  u_f_t(i - 2, j + 2, k, 2) / 12.0) /
                 12.0 -
             Jacobian_f(i - 1, j, k) * lambda_f(i - 1, j, k) *
                 (u_f_t(i - 1, j - 2, k, 2) / 12.0 -
                  u_f_t(i - 1, j - 1, k, 2) * 2.0 / 3.0 +
                  u_f_t(i - 1, j + 1, k, 2) * 2.0 / 3.0 -
                  u_f_t(i - 1, j + 2, k, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(i + 1, j, k) * lambda_f(i + 1, j, k) *
            ...
            (Jacobian_f(i, j - 2, k) * mu_f(i, j - 2, k) *
                 (u_f_t(i - 2, j - 2, k, 2) / 12.0 -
                  u_f_t(i - 1, j - 2, k, 2) * 2.0 / 3.0 +
                  u_f_t(i + 1, j - 2, k, 2) * 2.0 / 3.0 -
                  u_f_t(i + 2, j - 2, k, 2) / 12.0) /
                 12.0 -
             Jacobian_f(i, j - 1, k) * mu_f(i, j - 1, k) *
                 (u_f_t(i - 2, j - 1, k, 2) / 12.0 -
                  u_f_t(i - 1, j - 1, k, 2) * 2.0 / 3.0 +
                  u_f_t(i + 1, j - 1, k, 2) * 2.0 / 3.0 -
                  u_f_t(i + 2, j - 1, k, 2) / 12.0) *
                 2.0 / 3.0 +
        ...
        lh_f(i, j, k, 2) =
            ...
            (Jacobian_f(i - 2, j, k) * mu_f(i - 2, j, k) *
                 (u_f_t(i - 2, j - 2, k, 1) / 12.0 -
                  u_f_t(i - 2, j - 1, k, 1) * 2.0 / 3.0 +
                  u_f_t(i - 2, j + 1, k, 1) * 2.0 / 3.0 -
                  u_f_t(i - 2, j + 2, k, 1) / 12.0) /
                 12.0 -
             Jacobian_f(i - 1, j, k) * mu_f(i - 1, j, k) *
                 (u_f_t(i - 1, j - 2, k, 1) / 12.0 -
                  u_f_t(i - 1, j - 1, k, 1) * 2.0 / 3.0 +
                  u_f_t(i - 1, j + 1, k, 1) * 2.0 / 3.0 -
                  u_f_t(i - 1, j + 2, k, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(i + 1, j, k) * mu_f(i + 1, j, k) *
            ...
            (Jacobian_f(i, j - 2, k) * lambda_f(i, j - 2, k) *
                 (u_f_t(i - 2, j - 2, k, 1) / 12.0 -
                  u_f_t(i - 1, j - 2, k, 1) * 2.0 / 3.0 +
                  u_f_t(i + 1, j - 2, k, 1) * 2.0 / 3.0 -
                  u_f_t(i + 2, j - 2, k, 1) / 12.0) /
                 12.0 -
             Jacobian_f(i, j - 1, k) * lambda_f(i, j - 1, k) *
                 (u_f_t(i - 2, j - 1, k, 1) / 12.0 -
                  u_f_t(i - 1, j - 1, k, 1) * 2.0 / 3.0 +
                  u_f_t(i + 1, j - 1, k, 1) * 2.0 / 3.0 -
                  u_f_t(i + 2, j - 1, k, 1) / 12.0) *
                 2.0 / 3.0 +
        ...
        for (k1 = 1; k1 <= 8; k1++) {
          for (m = 1; m <= 8; m++) {
            ...
            lh_f(k, j, i, 1) =
                ...
                (acof_no_gp(i, k1, m) * Jacobian_f(k, j, m) *
                 (mu_f(k, j, m) + lambda_f(k, j, m)) * XI13_f(k, j, m) *
                 XI23_f(k, j, m) * u_f_t(k, j, k1, 2)) /
                    pow(h3_f, 2) +
                (acof_no_gp(i, k1, m) * Jacobian_f(k, j, m) *
                 (mu_f(k, j, m) + lambda_f(k, j, m)) * XI13_f(k, j, m) *
                 XI33_f(k, j, m) * u_f_t(k, j, k1, 3)) /
                    pow(h3_f, 2);
            ...
            lh_f(k, j, i, 3) =
                ...
                (acof_no_gp(i, k1, m) * Jacobian_f(k, j, m) *
                 (mu_f(k, j, m) + lambda_f(k, j, m)) * XI13_f(k, j, m) *
                 XI33_f(k, j, m) * u_f_t(k, j, k1, 1)) /
                    pow(h3_f, 2) +
                (acof_no_gp(i, k1, m) * Jacobian_f(k, j, m) *
                 (mu_f(k, j, m) + lambda_f(k, j, m)) * XI23_f(k, j, m) *
                 XI33_f(k, j, m) * u_f_t(k, j, k1, 2)) /
                    pow(h3_f, 2) +
                (acof_no_gp(i, k1, m) * Jacobian_f(k, j, m) *
                 ((2.0 * mu_f(k, j, m) + lambda_f(k, j, m)) *
                      pow(XI33_f(k, j, m), 2) +
        ...
        for (k1 = 1; k1 <= 6; k1++) {
          ...
          lh_f(j, i, k, 1) =
              ...
              (Jacobian_f(j - 2, i, k) *
                   ...
                   XI13_f(j - 2, i, k) * bof(k, k1) * u_f_t(j - 2, i, k1, 1) /
                   12.0 -
               Jacobian_f(j - 1, i, k) *
                   (2.0 * mu_f(j - 1, i, k) + lambda_f(j - 1, i, k)) *
                   XI13_f(j - 1, i, k) * bof(k, k1) * u_f_t(j - 1, i, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_f(j + 1, i, k) *
                   (2.0 * mu_f(j + 1, i, k) + lambda_f(j + 1, i, k)) *
                   XI13_f(j + 1, i, k) * bof(k, k1) * u_f_t(j + 1, i, k1, 1) *
              ...
              (Jacobian_f(j - 2, i, k) * lambda_f(j - 2, i, k) *
                   XI23_f(j - 2, i, k) * bof(k, k1) * u_f_t(j - 2, i, k1, 2) /
                   12.0 -
               Jacobian_f(j - 1, i, k) * lambda_f(j - 1, i, k) *
                   XI23_f(j - 1, i, k) * bof(k, k1) * u_f_t(j - 1, i, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_f(j + 1, i, k) * lambda_f(j + 1, i, k) *
                   XI23_f(j + 1, i, k) * bof(k, k1) * u_f_t(j + 1, i, k1, 2) *
                   2.0 / 3.0 -
               Jacobian_f(j + 2, i, k) * lambda_f(j + 2, i, k) *
                  ...
                  l1 / h1_f / h3_f +
              (Jacobian_f(j - 2, i, k) * lambda_f(j - 2, i, k) *
                   XI33_f(j - 2, i, k) * bof(k, k1) * u_f_t(j - 2, i, k1, 3) /
                   12.0 -
               Jacobian_f(j - 1, i, k) * lambda_f(j - 1, i, k) *
                   XI33_f(j - 1, i, k) * bof(k, k1) * u_f_t(j - 1, i, k1, 3) *
                   2.0 / 3.0 +
               Jacobian_f(j + 1, i, k) * lambda_f(j + 1, i, k) *
                   XI33_f(j + 1, i, k) * bof(k, k1) * u_f_t(j + 1, i, k1, 3) *
                   2.0 / 3.0 -
              ...
              (Jacobian_f(j, i - 2, k) * mu_f(j, i - 2, k) *
                   XI23_f(j, i - 2, k) * bof(k, k1) * u_f_t(j, i - 2, k1, 1) /
                   12.0 -
               Jacobian_f(j, i - 1, k) * mu_f(j, i - 1, k) *
                   XI23_f(j, i - 1, k) * bof(k, k1) * u_f_t(j, i - 1, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_f(j, i + 1, k) * mu_f(j, i + 1, k) *
                   XI23_f(j, i + 1, k) * bof(k, k1) * u_f_t(j, i + 1, k1, 1) *
                   2.0 / 3.0 -
               Jacobian_f(j, i + 2, k) * mu_f(j, i + 2, k) *
                  ...
                  l2 / h2_f / h3_f +
              (Jacobian_f(j, i - 2, k) * mu_f(j, i - 2, k) *
                   XI13_f(j, i - 2, k) * bof(k, k1) * u_f_t(j, i - 2, k1, 2) /
                   12.0 -
               Jacobian_f(j, i - 1, k) * mu_f(j, i - 1, k) *
                   XI13_f(j, i - 1, k) * bof(k, k1) * u_f_t(j, i - 1, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_f(j, i + 1, k) * mu_f(j, i + 1, k) *
                   XI13_f(j, i + 1, k) * bof(k, k1) * u_f_t(j, i + 1, k1, 2) *
                   2.0 / 3.0 -
          ...
          lh_f(j, i, n3_f + 1 - k, 1) =
              ...
              (-Jacobian_f(j - 2, i, n3_f + 1 - k) *
                   ...
                   u_f_t(j - 2, i, n3_f + 1 - k1, 2) / 12.0 +
               Jacobian_f(j - 1, i, n3_f + 1 - k) *
                   lambda_f(j - 1, i, n3_f + 1 - k) *
                   XI23_f(j - 1, i, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j - 1, i, n3_f + 1 - k1, 2) * 2.0 / 3.0 -
               Jacobian_f(j + 1, i, n3_f + 1 - k) *
                   lambda_f(j + 1, i, n3_f + 1 - k) *
                   XI23_f(j + 1, i, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j + 1, i, n3_f + 1 - k1, 2) * 2.0 / 3.0 +
              ...
              (-Jacobian_f(j - 2, i, n3_f + 1 - k) *
                   ...
                   u_f_t(j - 2, i, n3_f + 1 - k1, 3) / 12.0 +
               Jacobian_f(j - 1, i, n3_f + 1 - k) *
                   lambda_f(j - 1, i, n3_f + 1 - k) *
                   XI33_f(j - 1, i, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j - 1, i, n3_f + 1 - k1, 3) * 2.0 / 3.0 -
               Jacobian_f(j + 1, i, n3_f + 1 - k) *
                   lambda_f(j + 1, i, n3_f + 1 - k) *
                   XI33_f(j + 1, i, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j + 1, i, n3_f + 1 - k1, 3) * 2.0 / 3.0 +
              ...
              (-Jacobian_f(j, i - 2, n3_f + 1 - k) *
                   ...
                   u_f_t(j, i - 2, n3_f + 1 - k1, 1) / 12.0 +
               Jacobian_f(j, i - 1, n3_f + 1 - k) *
                   mu_f(j, i - 1, n3_f + 1 - k) *
                   XI23_f(j, i - 1, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j, i - 1, n3_f + 1 - k1, 1) * 2.0 / 3.0 -
               Jacobian_f(j, i + 1, n3_f + 1 - k) *
                   mu_f(j, i + 1, n3_f + 1 - k) *
                   XI23_f(j, i + 1, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j, i + 1, n3_f + 1 - k1, 1) * 2.0 / 3.0 +
              ...
              (-Jacobian_f(j, i - 2, n3_f + 1 - k) *
                   ...
                   u_f_t(j, i - 2, n3_f + 1 - k1, 2) / 12.0 +
               Jacobian_f(j, i - 1, n3_f + 1 - k) *
                   mu_f(j, i - 1, n3_f + 1 - k) *
                   XI13_f(j, i - 1, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j, i - 1, n3_f + 1 - k1, 2) * 2.0 / 3.0 -
               Jacobian_f(j, i + 1, n3_f + 1 - k) *
                   mu_f(j, i + 1, n3_f + 1 - k) *
                   XI13_f(j, i + 1, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j, i + 1, n3_f + 1 - k1, 2) * 2.0 / 3.0 +
          ...
          lh_f(j, i, k, 2) =
              ...
              (Jacobian_f(j - 2, i, k) * mu_f(j - 2, i, k) *
                   XI23_f(j - 2, i, k) * bof(k, k1) * u_f_t(j - 2, i, k1, 1) /
                   12.0 -
               Jacobian_f(j - 1, i, k) * mu_f(j - 1, i, k) *
                   XI23_f(j - 1, i, k) * bof(k, k1) * u_f_t(j - 1, i, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_f(j + 1, i, k) * mu_f(j + 1, i, k) *
                   XI23_f(j + 1, i, k) * bof(k, k1) * u_f_t(j + 1, i, k1, 1) *
                   2.0 / 3.0 -
               Jacobian_f(j + 2, i, k) * mu_f(j + 2, i, k) *
                  ...
                  l1 / h1_f / h3_f +
              (Jacobian_f(j - 2, i, k) * mu_f(j - 2, i, k) *
                   XI13_f(j - 2, i, k) * bof(k, k1) * u_f_t(j - 2, i, k1, 2) /
                   12.0 -
               Jacobian_f(j - 1, i, k) * mu_f(j - 1, i, k) *
                   XI13_f(j - 1, i, k) * bof(k, k1) * u_f_t(j - 1, i, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_f(j + 1, i, k) * mu_f(j + 1, i, k) *
                   XI13_f(j + 1, i, k) * bof(k, k1) * u_f_t(j + 1, i, k1, 2) *
                   2.0 / 3.0 -
              ...
              (Jacobian_f(j, i - 2, k) * lambda_f(j, i - 2, k) *
                   XI13_f(j, i - 2, k) * bof(k, k1) * u_f_t(j, i - 2, k1, 1) /
                   12.0 -
               Jacobian_f(j, i - 1, k) * lambda_f(j, i - 1, k) *
                   XI13_f(j, i - 1, k) * bof(k, k1) * u_f_t(j, i - 1, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_f(j, i + 1, k) * lambda_f(j, i + 1, k) *
                   XI13_f(j, i + 1, k) * bof(k, k1) * u_f_t(j, i + 1, k1, 1) *
                   2.0 / 3.0 -
              ...
              (Jacobian_f(j, i - 2, k) *
                   ...
                   XI23_f(j, i - 2, k) * bof(k, k1) * u_f_t(j, i - 2, k1, 2) /
                   12.0 -
               Jacobian_f(j, i - 1, k) *
                   (2.0 * mu_f(j, i - 1, k) + lambda_f(j, i - 1, k)) *
                   XI23_f(j, i - 1, k) * bof(k, k1) * u_f_t(j, i - 1, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_f(j, i + 1, k) *
                   (2.0 * mu_f(j, i + 1, k) + lambda_f(j, i + 1, k)) *
                   XI23_f(j, i + 1, k) * bof(k, k1) * u_f_t(j, i + 1, k1, 2) *
               ...
               Jacobian_f(j, i + 2, k) *
                  ...
                  l2 / h2_f / h3_f +
              (Jacobian_f(j, i - 2, k) * lambda_f(j, i - 2, k) *
                   XI33_f(j, i - 2, k) * bof(k, k1) * u_f_t(j, i - 2, k1, 3) /
                   12.0 -
               Jacobian_f(j, i - 1, k) * lambda_f(j, i - 1, k) *
                   XI33_f(j, i - 1, k) * bof(k, k1) * u_f_t(j, i - 1, k1, 3) *
                   2.0 / 3.0 +
               Jacobian_f(j, i + 1, k) * lambda_f(j, i + 1, k) *
                   XI33_f(j, i + 1, k) * bof(k, k1) * u_f_t(j, i + 1, k1, 3) *
                   2.0 / 3.0 -
          ...
          lh_f(j, i, n3_f + 1 - k, 2) =
              ...
              (-Jacobian_f(j, i - 2, n3_f + 1 - k) *
                   ...
                   u_f_t(j, i - 2, n3_f + 1 - k1, 3) / 12.0 +
               Jacobian_f(j, i - 1, n3_f + 1 - k) *
                   lambda_f(j, i - 1, n3_f + 1 - k) *
                   XI33_f(j, i - 1, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j, i - 1, n3_f + 1 - k1, 3) * 2.0 / 3.0 -
               Jacobian_f(j, i + 1, n3_f + 1 - k) *
                   lambda_f(j, i + 1, n3_f + 1 - k) *
                   XI33_f(j, i + 1, n3_f + 1 - k) * bof(k, k1) *
                   u_f_t(j, i + 1, n3_f + 1 - k1, 3) * 2.0 / 3.0 +
          ...
          lh_f(j, i, k, 3) = lh_f(j, i, k, 3) +
                             (Jacobian_f(j - 2, i, k) * mu_f(j - 2, i, k) *
                                  ...
                                  u_f_t(j - 2, i, k1, 1) / 12.0 -
                              Jacobian_f(j - 1, i, k) * mu_f(j - 1, i, k) *
                                  XI33_f(j - 1, i, k) * bof(k, k1) *
                                  u_f_t(j - 1, i, k1, 1) * 2.0 / 3.0 +
                              Jacobian_f(j + 1, i, k) * mu_f(j + 1, i, k) *
                                  XI33_f(j + 1, i, k) * bof(k, k1) *
                                  u_f_t(j + 1, i, k1, 1) * 2.0 / 3.0 -
                              Jacobian_f(j + 2, i, k) * mu_f(j + 2, i, k) *
                             ...
                             (Jacobian_f(j - 2, i, k) * mu_f(j - 2, i, k) *
                                  ...
                                  u_f_t(j - 2, i, k1, 3) / 12.0 -
                              Jacobian_f(j - 1, i, k) * mu_f(j - 1, i, k) *
                                  XI13_f(j - 1, i, k) * bof(k, k1) *
                                  u_f_t(j - 1, i, k1, 3) * 2.0 / 3.0 +
                              Jacobian_f(j + 1, i, k) * mu_f(j + 1, i, k) *
                                  XI13_f(j + 1, i, k) * bof(k, k1) *
                                  u_f_t(j + 1, i, k1, 3) * 2.0 / 3.0 -
                              Jacobian_f(j + 2, i, k) * mu_f(j + 2, i, k) *
                             ...
                             (Jacobian_f(j, i - 2, k) * mu_f(j, i - 2, k) *
                                  ...
                                  u_f_t(j, i - 2, k1, 2) / 12.0 -
                              Jacobian_f(j, i - 1, k) * mu_f(j, i - 1, k) *
                                  XI33_f(j, i - 1, k) * bof(k, k1) *
                                  u_f_t(j, i - 1, k1, 2) * 2.0 / 3.0 +
                              Jacobian_f(j, i + 1, k) * mu_f(j, i + 1, k) *
                                  XI33_f(j, i + 1, k) * bof(k, k1) *
                                  u_f_t(j, i + 1, k1, 2) * 2.0 / 3.0 -
                              Jacobian_f(j, i + 2, k) * mu_f(j, i + 2, k) *
                             ...
                             (Jacobian_f(j, i - 2, k) * mu_f(j, i - 2, k) *
                                  ...
                                  u_f_t(j, i - 2, k1, 3) / 12.0 -
                              Jacobian_f(j, i - 1, k) * mu_f(j, i - 1, k) *
                                  XI23_f(j, i - 1, k) * bof(k, k1) *
                                  u_f_t(j, i - 1, k1, 3) * 2.0 / 3.0 +
                              Jacobian_f(j, i + 1, k) * mu_f(j, i + 1, k) *
                                  XI23_f(j, i + 1, k) * bof(k, k1) *
                                  u_f_t(j, i + 1, k1, 3) * 2.0 / 3.0 -
                              Jacobian_f(j, i + 2, k) * mu_f(j, i + 2, k) *
      ...
      for (j = 1; j <= n1_f; j++) {
        ...
        lh_f(j, i, k, 1) =
            ...
            (Jacobian_f(j - 2, i, k) *
                 (2.0 * mu_f(j - 2, i, k) + lambda_f(j - 2, i, k)) *
                 XI13_f(j - 2, i, k) *
                 (u_f_t(j - 2, i, k - 2, 1) / 12.0 -
                  u_f_t(j - 2, i, k - 1, 1) * 2.0 / 3.0 +
                  u_f_t(j - 2, i, k + 1, 1) * 2.0 / 3.0 -
                  u_f_t(j - 2, i, k + 2, 1) / 12.0) /
                 12.0 -
             Jacobian_f(j - 1, i, k) *
                 (2.0 * mu_f(j - 1, i, k) + lambda_f(j - 1, i, k)) *
                 XI13_f(j - 1, i, k) *
                 (u_f_t(j - 1, i, k - 2, 1) / 12.0 -
                  u_f_t(j - 1, i, k - 1, 1) * 2.0 / 3.0 +
                  u_f_t(j - 1, i, k + 1, 1) * 2.0 / 3.0 -
                  u_f_t(j - 1, i, k + 2, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(j + 1, i, k) *
            ...
            (Jacobian_f(j - 2, i, k) * lambda_f(j - 2, i, k) *
                 XI23_f(j - 2, i, k) *
                 (u_f_t(j - 2, i, k - 2, 2) / 12.0 -
                  u_f_t(j - 2, i, k - 1, 2) * 2.0 / 3.0 +
                  u_f_t(j - 2, i, k + 1, 2) * 2.0 / 3.0 -
                  u_f_t(j - 2, i, k + 2, 2) / 12.0) /
                 12.0 -
             Jacobian_f(j - 1, i, k) * lambda_f(j - 1, i, k) *
                 XI23_f(j - 1, i, k) *
                 (u_f_t(j - 1, i, k - 2, 2) / 12.0 -
                  u_f_t(j - 1, i, k - 1, 2) * 2.0 / 3.0 +
                  u_f_t(j - 1, i, k + 1, 2) * 2.0 / 3.0 -
                  u_f_t(j - 1, i, k + 2, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(j + 1, i, k) * lambda_f(j + 1, i, k) *
            ...
            (Jacobian_f(j - 2, i, k) * lambda_f(j - 2, i, k) *
                 XI33_f(j - 2, i, k) *
                 (u_f_t(j - 2, i, k - 2, 3) / 12.0 -
                  u_f_t(j - 2, i, k - 1, 3) * 2.0 / 3.0 +
                  u_f_t(j - 2, i, k + 1, 3) * 2.0 / 3.0 -
                  u_f_t(j - 2, i, k + 2, 3) / 12.0) /
                 12.0 -
             Jacobian_f(j - 1, i, k) * lambda_f(j - 1, i, k) *
                 XI33_f(j - 1, i, k) *
                 (u_f_t(j - 1, i, k - 2, 3) / 12.0 -
                  u_f_t(j - 1, i, k - 1, 3) * 2.0 / 3.0 +
                  u_f_t(j - 1, i, k + 1, 3) * 2.0 / 3.0 -
                  u_f_t(j - 1, i, k + 2, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(j + 1, i, k) * lambda_f(j + 1, i, k) *
            ...
            (Jacobian_f(j, i - 2, k) * mu_f(j, i - 2, k) * XI23_f(j, i - 2, k) *
                 (u_f_t(j, i - 2, k - 2, 1) / 12.0 -
                  u_f_t(j, i - 2, k - 1, 1) * 2.0 / 3.0 +
                  u_f_t(j, i - 2, k + 1, 1) * 2.0 / 3.0 -
                  u_f_t(j, i - 2, k + 2, 1) / 12.0) /
                 12.0 -
             Jacobian_f(j, i - 1, k) * mu_f(j, i - 1, k) * XI23_f(j, i - 1, k) *
                 (u_f_t(j, i - 1, k - 2, 1) / 12.0 -
                  u_f_t(j, i - 1, k - 1, 1) * 2.0 / 3.0 +
                  u_f_t(j, i - 1, k + 1, 1) * 2.0 / 3.0 -
                  u_f_t(j, i - 1, k + 2, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(j, i + 1, k) * mu_f(j, i + 1, k) * XI23_f(j, i + 1, k) *
            ...
            (Jacobian_f(j, i - 2, k) * mu_f(j, i - 2, k) * XI13_f(j, i - 2, k) *
                 (u_f_t(j, i - 2, k - 2, 2) / 12.0 -
                  u_f_t(j, i - 2, k - 1, 2) * 2.0 / 3.0 +
                  u_f_t(j, i - 2, k + 1, 2) * 2.0 / 3.0 -
                  u_f_t(j, i - 2, k + 2, 2) / 12.0) /
                 12.0 -
             Jacobian_f(j, i - 1, k) * mu_f(j, i - 1, k) * XI13_f(j, i - 1, k) *
                 (u_f_t(j, i - 1, k - 2, 2) / 12.0 -
                  u_f_t(j, i - 1, k - 1, 2) * 2.0 / 3.0 +
                  u_f_t(j, i - 1, k + 1, 2) * 2.0 / 3.0 -
                  u_f_t(j, i - 1, k + 2, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(j, i + 1, k) * mu_f(j, i + 1, k) * XI13_f(j, i + 1, k) *
        ...
        lh_f(j, i, k, 2) =
            ...
            (Jacobian_f(j, i - 2, k) * lambda_f(j, i - 2, k) *
                 XI33_f(j, i - 2, k) *
                 (u_f_t(j, i - 2, k - 2, 3) / 12.0 -
                  u_f_t(j, i - 2, k - 1, 3) * 2.0 / 3.0 +
                  u_f_t(j, i - 2, k + 1, 3) * 2.0 / 3.0 -
                  u_f_t(j, i - 2, k + 2, 3) / 12.0) /
                 12.0 -
             Jacobian_f(j, i - 1, k) * lambda_f(j, i - 1, k) *
                 XI33_f(j, i - 1, k) *
                 (u_f_t(j, i - 1, k - 2, 3) / 12.0 -
                  u_f_t(j, i - 1, k - 1, 3) * 2.0 / 3.0 +
                  u_f_t(j, i - 1, k + 1, 3) * 2.0 / 3.0 -
                  u_f_t(j, i - 1, k + 2, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(j, i + 1, k) * lambda_f(j, i + 1, k) *
      ...
      for (k = 1; k <= n1_f; k++) {
        ...
        lh_f(k, j, i, 1) =
            ...
            (Jacobian_f(k, j, i - 2) *
                 (2.0 * mu_f(k, j, i - 2) + lambda_f(k, j, i - 2)) *
                 XI13_f(k, j, i - 2) *
                 (u_f_t(k - 2, j, i - 2, 1) / 12.0 -
                  u_f_t(k - 1, j, i - 2, 1) * 2.0 / 3.0 +
                  u_f_t(k + 1, j, i - 2, 1) * 2.0 / 3.0 -
                  u_f_t(k + 2, j, i - 2, 1) / 12.0) /
                 12.0 -
             Jacobian_f(k, j, i - 1) *
                 (2.0 * mu_f(k, j, i - 1) + lambda_f(k, j, i - 1)) *
                 XI13_f(k, j, i - 1) *
                 (u_f_t(k - 2, j, i - 1, 1) / 12.0 -
                  u_f_t(k - 1, j, i - 1, 1) * 2.0 / 3.0 +
                  u_f_t(k + 1, j, i - 1, 1) * 2.0 / 3.0 -
                  u_f_t(k + 2, j, i - 1, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(k, j, i + 1) *
            ...
            (Jacobian_f(k, j, i - 2) * mu_f(k, j, i - 2) * XI23_f(k, j, i - 2) *
                 (u_f_t(k - 2, j, i - 2, 2) / 12.0 -
                  u_f_t(k - 1, j, i - 2, 2) * 2.0 / 3.0 +
                  u_f_t(k + 1, j, i - 2, 2) * 2.0 / 3.0 -
                  u_f_t(k + 2, j, i - 2, 2) / 12.0) /
                 12.0 -
             Jacobian_f(k, j, i - 1) * mu_f(k, j, i - 1) * XI23_f(k, j, i - 1) *
                 (u_f_t(k - 2, j, i - 1, 2) / 12.0 -
                  u_f_t(k - 1, j, i - 1, 2) * 2.0 / 3.0 +
                  u_f_t(k + 1, j, i - 1, 2) * 2.0 / 3.0 -
                  u_f_t(k + 2, j, i - 1, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(k, j, i + 1) * mu_f(k, j, i + 1) * XI23_f(k, j, i + 1) *
            ...
            (Jacobian_f(k, j, i - 2) * mu_f(k, j, i - 2) * XI33_f(k, j, i - 2) *
                 (u_f_t(k - 2, j, i - 2, 3) / 12.0 -
                  u_f_t(k - 1, j, i - 2, 3) * 2.0 / 3.0 +
                  u_f_t(k + 1, j, i - 2, 3) * 2.0 / 3.0 -
                  u_f_t(k + 2, j, i - 2, 3) / 12.0) /
                 12.0 -
             Jacobian_f(k, j, i - 1) * mu_f(k, j, i - 1) * XI33_f(k, j, i - 1) *
                 (u_f_t(k - 2, j, i - 1, 3) / 12.0 -
                  u_f_t(k - 1, j, i - 1, 3) * 2.0 / 3.0 +
                  u_f_t(k + 1, j, i - 1, 3) * 2.0 / 3.0 -
                  u_f_t(k + 2, j, i - 1, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(k, j, i + 1) * mu_f(k, j, i + 1) * XI33_f(k, j, i + 1) *
             ...
             Jacobian_f(k, j, i + 2) * mu_f(k, j, i + 2) * XI33_f(k, j, i + 2) *
                ...
                l1 / h1_f / h3_f +
            (Jacobian_f(k, j, i - 2) * mu_f(k, j, i - 2) * XI23_f(k, j, i - 2) *
                 (u_f_t(k, j - 2, i - 2, 1) / 12.0 -
                  u_f_t(k, j - 1, i - 2, 1) * 2.0 / 3.0 +
                  u_f_t(k, j + 1, i - 2, 1) * 2.0 / 3.0 -
                  u_f_t(k, j + 2, i - 2, 1) / 12.0) /
                 12.0 -
             Jacobian_f(k, j, i - 1) * mu_f(k, j, i - 1) * XI23_f(k, j, i - 1) *
                 (u_f_t(k, j - 2, i - 1, 1) / 12.0 -
                  u_f_t(k, j - 1, i - 1, 1) * 2.0 / 3.0 +
                  u_f_t(k, j + 1, i - 1, 1) * 2.0 / 3.0 -
                  u_f_t(k, j + 2, i - 1, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(k, j, i + 1) * mu_f(k, j, i + 1) * XI23_f(k, j, i + 1) *
            ...
            (Jacobian_f(k, j, i - 2) * lambda_f(k, j, i - 2) *
                 XI13_f(k, j, i - 2) *
                 (u_f_t(k, j - 2, i - 2, 2) / 12.0 -
                  u_f_t(k, j - 1, i - 2, 2) * 2.0 / 3.0 +
                  u_f_t(k, j + 1, i - 2, 2) * 2.0 / 3.0 -
                  u_f_t(k, j + 2, i - 2, 2) / 12.0) /
                 12.0 -
             Jacobian_f(k, j, i - 1) * lambda_f(k, j, i - 1) *
                 XI13_f(k, j, i - 1) *
                 (u_f_t(k, j - 2, i - 1, 2) / 12.0 -
                  u_f_t(k, j - 1, i - 1, 2) * 2.0 / 3.0 +
                  u_f_t(k, j + 1, i - 1, 2) * 2.0 / 3.0 -
                  u_f_t(k, j + 2, i - 1, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(k, j, i + 1) * lambda_f(k, j, i + 1) *
        ...
        lh_f(k, j, i, 2) =
            ...
            (Jacobian_f(k, j, i - 2) *
             ...
             Jacobian_f(k, j, i + 2) *
                ...
                l2 / h3_f / h2_f +
            (Jacobian_f(k, j, i - 2) * mu_f(k, j, i - 2) * XI33_f(k, j, i - 2) *
                 (u_f_t(k, j - 2, i - 2, 3) / 12.0 -
                  u_f_t(k, j - 1, i - 2, 3) * 2.0 / 3.0 +
                  u_f_t(k, j + 1, i - 2, 3) * 2.0 / 3.0 -
                  u_f_t(k, j + 2, i - 2, 3) / 12.0) /
                 12.0 -
             Jacobian_f(k, j, i - 1) * mu_f(k, j, i - 1) * XI33_f(k, j, i - 1) *
                 (u_f_t(k, j - 2, i - 1, 3) / 12.0 -
                  u_f_t(k, j - 1, i - 1, 3) * 2.0 / 3.0 +
                  u_f_t(k, j + 1, i - 1, 3) * 2.0 / 3.0 -
                  u_f_t(k, j + 2, i - 1, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_f(k, j, i + 1) * mu_f(k, j, i + 1) * XI33_f(k, j, i + 1) *
        ...
        for (k1 = 1; k1 <= 6; k1++) {
          ...
          lh_f(k, j, i, 1) =
              ...
              (bof(i, k1) * Jacobian_f(k, j, k1) *
               ...
               (u_f_t(k - 2, j, k1, 1) / 12.0 -
                u_f_t(k - 1, j, k1, 1) * 2.0 / 3.0 +
                u_f_t(k + 1, j, k1, 1) * 2.0 / 3.0 -
                u_f_t(k + 2, j, k1, 1) / 12.0)) /
                  l1 / h3_f / h1_f +
              (bof(i, k1) * Jacobian_f(k, j, k1) * mu_f(k, j, k1) *
               XI23_f(k, j, k1) *
               (u_f_t(k - 2, j, k1, 2) / 12.0 -
                u_f_t(k - 1, j, k1, 2) * 2.0 / 3.0 +
                u_f_t(k + 1, j, k1, 2) * 2.0 / 3.0 -
                u_f_t(k + 2, j, k1, 2) / 12.0)) /
                  l1 / h3_f / h1_f +
              (bof(i, k1) * Jacobian_f(k, j, k1) * mu_f(k, j, k1) *
               XI33_f(k, j, k1) *
               (u_f_t(k - 2, j, k1, 3) / 12.0 -
                u_f_t(k - 1, j, k1, 3) * 2.0 / 3.0 +
                u_f_t(k + 1, j, k1, 3) * 2.0 / 3.0 -
                u_f_t(k + 2, j, k1, 3) / 12.0)) /
                  l1 / h1_f / h3_f +
              (bof(i, k1) * Jacobian_f(k, j, k1) * mu_f(k, j, k1) *
               XI23_f(k, j, k1) *
               (u_f_t(k, j - 2, k1, 1) / 12.0 -
                u_f_t(k, j - 1, k1, 1) * 2.0 / 3.0 +
                u_f_t(k, j + 1, k1, 1) * 2.0 / 3.0 -
                u_f_t(k, j + 2, k1, 1) / 12.0)) /
                  l2 / h3_f / h2_f +
              (bof(i, k1) * Jacobian_f(k, j, k1) * lambda_f(k, j, k1) *
               XI13_f(k, j, k1) *
               (u_f_t(k, j - 2, k1, 2) / 12.0 -
                u_f_t(k, j - 1, k1, 2) * 2.0 / 3.0 +
                u_f_t(k, j + 1, k1, 2) * 2.0 / 3.0 -
                u_f_t(k, j + 2, k1, 2) / 12.0)) /
                  l2 / h3_f / h2_f;
          ...
          lh_f(k, j, n3_f + 1 - i, 1) =
              ...
              (-bof(i, k1) * Jacobian_f(k, j, n3_f + 1 - k1) *
               ...
               (u_f_t(k - 2, j, n3_f + 1 - k1, 1) / 12.0 -
                u_f_t(k - 1, j, n3_f + 1 - k1, 1) * 2.0 / 3.0 +
                u_f_t(k + 1, j, n3_f + 1 - k1, 1) * 2.0 / 3.0 -
                u_f_t(k + 2, j, n3_f + 1 - k1, 1) / 12.0)) /
                  l1 / h3_f / h1_f +
              (-bof(i, k1) * Jacobian_f(k, j, n3_f + 1 - k1) *
               mu_f(k, j, n3_f + 1 - k1) * XI23_f(k, j, n3_f + 1 - k1) *
               (u_f_t(k - 2, j, n3_f + 1 - k1, 2) / 12.0 -
                u_f_t(k - 1, j, n3_f + 1 - k1, 2) * 2.0 / 3.0 +
                u_f_t(k + 1, j, n3_f + 1 - k1, 2) * 2.0 / 3.0 -
                u_f_t(k + 2, j, n3_f + 1 - k1, 2) / 12.0)) /
                  l1 / h3_f / h1_f +
              (-bof(i, k1) * Jacobian_f(k, j, n3_f + 1 - k1) *
               mu_f(k, j, n3_f + 1 - k1) * XI33_f(k, j, n3_f + 1 - k1) *
               (u_f_t(k - 2, j, n3_f + 1 - k1, 3) / 12.0 -
                u_f_t(k - 1, j, n3_f + 1 - k1, 3) * 2.0 / 3.0 +
                u_f_t(k + 1, j, n3_f + 1 - k1, 3) * 2.0 / 3.0 -
                u_f_t(k + 2, j, n3_f + 1 - k1, 3) / 12.0)) /
                  l1 / h1_f / h3_f +
              (-bof(i, k1) * Jacobian_f(k, j, n3_f + 1 - k1) *
               mu_f(k, j, n3_f + 1 - k1) * XI23_f(k, j, n3_f + 1 - k1) *
               (u_f_t(k, j - 2, n3_f + 1 - k1, 1) / 12.0 -
                u_f_t(k, j - 1, n3_f + 1 - k1, 1) * 2.0 / 3.0 +
                u_f_t(k, j + 1, n3_f + 1 - k1, 1) * 2.0 / 3.0 -
                u_f_t(k, j + 2, n3_f + 1 - k1, 1) / 12.0)) /
                  l2 / h3_f / h2_f +
              (-bof(i, k1) * Jacobian_f(k, j, n3_f + 1 - k1) *
               lambda_f(k, j, n3_f + 1 - k1) * XI13_f(k, j, n3_f + 1 - k1) *
               (u_f_t(k, j - 2, n3_f + 1 - k1, 2) / 12.0 -
                u_f_t(k, j - 1, n3_f + 1 - k1, 2) * 2.0 / 3.0 +
                u_f_t(k, j + 1, n3_f + 1 - k1, 2) * 2.0 / 3.0 -
                u_f_t(k, j + 2, n3_f + 1 - k1, 2) / 12.0)) /
                  l2 / h3_f / h2_f;
          // second set equation
          lh_f(k, j, i, 2) =
              ...
              (bof(i, k1) * Jacobian_f(k, j, k1) * mu_f(k, j, k1) *
               XI33_f(k, j, k1) *
               (u_f_t(k, j - 2, k1, 3) / 12.0 -
                u_f_t(k, j - 1, k1, 3) * 2.0 / 3.0 +
                u_f_t(k, j + 1, k1, 3) * 2.0 / 3.0 -
                u_f_t(k, j + 2, k1, 3) / 12.0)) /
                  l2 / h3_f / h2_f;
          ...
          lh_f(k, j, n3_f + 1 - i, 2) =
              ...
              (-bof(i, k1) * Jacobian_f(k, j, n3_f + 1 - k1) *
               mu_f(k, j, n3_f + 1 - k1) * XI33_f(k, j, n3_f + 1 - k1) *
               (u_f_t(k, j - 2, n3_f + 1 - k1, 3) / 12.0 -
                u_f_t(k, j - 1, n3_f + 1 - k1, 3) * 2.0 / 3.0 +
                u_f_t(k, j + 1, n3_f + 1 - k1, 3) * 2.0 / 3.0 -
                u_f_t(k, j + 2, n3_f + 1 - k1, 3) / 12.0)) /
                  l2 / h3_f / h2_f;
          // third set equation
      ...
      for (i = 1; i <= n1_c; i++) {
        ...
        lh_c(i, j, k, 1) =
            ...
            (Jacobian_c(i - 2, j, k) * lambda_c(i - 2, j, k) *
                 (u_c_t(i - 2, j - 2, k, 2) / 12.0 -
                  u_c_t(i - 2, j - 1, k, 2) * 2.0 / 3.0 +
                  u_c_t(i - 2, j + 1, k, 2) * 2.0 / 3.0 -
                  u_c_t(i - 2, j + 2, k, 2) / 12.0) /
                 12.0 -
             Jacobian_c(i - 1, j, k) * lambda_c(i - 1, j, k) *
                 (u_c_t(i - 1, j - 2, k, 2) / 12.0 -
                  u_c_t(i - 1, j - 1, k, 2) * 2.0 / 3.0 +
                  u_c_t(i - 1, j + 1, k, 2) * 2.0 / 3.0 -
                  u_c_t(i - 1, j + 2, k, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(i + 1, j, k) * lambda_c(i + 1, j, k) *
            ...
            (Jacobian_c(i, j - 2, k) * mu_c(i, j - 2, k) *
                 (u_c_t(i - 2, j - 2, k, 2) / 12.0 -
                  u_c_t(i - 1, j - 2, k, 2) * 2.0 / 3.0 +
                  u_c_t(i + 1, j - 2, k, 2) * 2.0 / 3.0 -
                  u_c_t(i + 2, j - 2, k, 2) / 12.0) /
                 12.0 -
             Jacobian_c(i, j - 1, k) * mu_c(i, j - 1, k) *
                 (u_c_t(i - 2, j - 1, k, 2) / 12.0 -
                  u_c_t(i - 1, j - 1, k, 2) * 2.0 / 3.0 +
                  u_c_t(i + 1, j - 1, k, 2) * 2.0 / 3.0 -
                  u_c_t(i + 2, j - 1, k, 2) / 12.0) *
                 2.0 / 3.0 +
        ...
        lh_c(i, j, k, 2) =
            ...
            (Jacobian_c(i - 2, j, k) * mu_c(i - 2, j, k) *
                 (u_c_t(i - 2, j - 2, k, 1) / 12.0 -
                  u_c_t(i - 2, j - 1, k, 1) * 2.0 / 3.0 +
                  u_c_t(i - 2, j + 1, k, 1) * 2.0 / 3.0 -
                  u_c_t(i - 2, j + 2, k, 1) / 12.0) /
                 12.0 -
             Jacobian_c(i - 1, j, k) * mu_c(i - 1, j, k) *
                 (u_c_t(i - 1, j - 2, k, 1) / 12.0 -
                  u_c_t(i - 1, j - 1, k, 1) * 2.0 / 3.0 +
                  u_c_t(i - 1, j + 1, k, 1) * 2.0 / 3.0 -
                  u_c_t(i - 1, j + 2, k, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(i + 1, j, k) * mu_c(i + 1, j, k) *
            ...
            (Jacobian_c(i, j - 2, k) * lambda_c(i, j - 2, k) *
                 (u_c_t(i - 2, j - 2, k, 1) / 12.0 -
                  u_c_t(i - 1, j - 2, k, 1) * 2.0 / 3.0 +
                  u_c_t(i + 1, j - 2, k, 1) * 2.0 / 3.0 -
                  u_c_t(i + 2, j - 2, k, 1) / 12.0) /
                 12.0 -
             Jacobian_c(i, j - 1, k) * lambda_c(i, j - 1, k) *
                 (u_c_t(i - 2, j - 1, k, 1) / 12.0 -
                  u_c_t(i - 1, j - 1, k, 1) * 2.0 / 3.0 +
                  u_c_t(i + 1, j - 1, k, 1) * 2.0 / 3.0 -
                  u_c_t(i + 2, j - 1, k, 1) / 12.0) *
                 2.0 / 3.0 +
        ...
        for (k1 = 1; k1 <= 6; k1++) {
          ...
          lh_c(j, i, k, 1) =
              ...
              (Jacobian_c(j - 2, i, k) *
                   ...
                   XI13_c(j - 2, i, k) * bof(k, k1) * u_c_t(j - 2, i, k1, 1) /
                   12.0 -
               Jacobian_c(j - 1, i, k) *
                   (2.0 * mu_c(j - 1, i, k) + lambda_c(j - 1, i, k)) *
                   XI13_c(j - 1, i, k) * bof(k, k1) * u_c_t(j - 1, i, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_c(j + 1, i, k) *
                   (2.0 * mu_c(j + 1, i, k) + lambda_c(j + 1, i, k)) *
                   XI13_c(j + 1, i, k) * bof(k, k1) * u_c_t(j + 1, i, k1, 1) *
              ...
              (Jacobian_c(j - 2, i, k) * lambda_c(j - 2, i, k) *
                   XI23_c(j - 2, i, k) * bof(k, k1) * u_c_t(j - 2, i, k1, 2) /
                   12.0 -
               Jacobian_c(j - 1, i, k) * lambda_c(j - 1, i, k) *
                   XI23_c(j - 1, i, k) * bof(k, k1) * u_c_t(j - 1, i, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_c(j + 1, i, k) * lambda_c(j + 1, i, k) *
                   XI23_c(j + 1, i, k) * bof(k, k1) * u_c_t(j + 1, i, k1, 2) *
                   2.0 / 3.0 -
               Jacobian_c(j + 2, i, k) * lambda_c(j + 2, i, k) *
                  ...
                  l1 / h1_c / h3_c +
              (Jacobian_c(j - 2, i, k) * lambda_c(j - 2, i, k) *
                   XI33_c(j - 2, i, k) * bof(k, k1) * u_c_t(j - 2, i, k1, 3) /
                   12.0 -
               Jacobian_c(j - 1, i, k) * lambda_c(j - 1, i, k) *
                   XI33_c(j - 1, i, k) * bof(k, k1) * u_c_t(j - 1, i, k1, 3) *
                   2.0 / 3.0 +
               Jacobian_c(j + 1, i, k) * lambda_c(j + 1, i, k) *
                   XI33_c(j + 1, i, k) * bof(k, k1) * u_c_t(j + 1, i, k1, 3) *
                   2.0 / 3.0 -
              ...
              (Jacobian_c(j, i - 2, k) * mu_c(j, i - 2, k) *
                   XI23_c(j, i - 2, k) * bof(k, k1) * u_c_t(j, i - 2, k1, 1) /
                   12.0 -
               Jacobian_c(j, i - 1, k) * mu_c(j, i - 1, k) *
                   XI23_c(j, i - 1, k) * bof(k, k1) * u_c_t(j, i - 1, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_c(j, i + 1, k) * mu_c(j, i + 1, k) *
                   XI23_c(j, i + 1, k) * bof(k, k1) * u_c_t(j, i + 1, k1, 1) *
                   2.0 / 3.0 -
               Jacobian_c(j, i + 2, k) * mu_c(j, i + 2, k) *
                  ...
                  l2 / h2_c / h3_c +
              (Jacobian_c(j, i - 2, k) * mu_c(j, i - 2, k) *
                   XI13_c(j, i - 2, k) * bof(k, k1) * u_c_t(j, i - 2, k1, 2) /
                   12.0 -
               Jacobian_c(j, i - 1, k) * mu_c(j, i - 1, k) *
                   XI13_c(j, i - 1, k) * bof(k, k1) * u_c_t(j, i - 1, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_c(j, i + 1, k) * mu_c(j, i + 1, k) *
                   XI13_c(j, i + 1, k) * bof(k, k1) * u_c_t(j, i + 1, k1, 2) *
                   2.0 / 3.0 -
          ...
          lh_c(j, i, n3_c + 1 - k, 1) =
              ...
              (-Jacobian_c(j - 2, i, n3_c + 1 - k) *
                   ...
                   u_c_t(j - 2, i, n3_c + 1 - k1, 2) / 12.0 +
               Jacobian_c(j - 1, i, n3_c + 1 - k) *
                   lambda_c(j - 1, i, n3_c + 1 - k) *
                   XI23_c(j - 1, i, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j - 1, i, n3_c + 1 - k1, 2) * 2.0 / 3.0 -
               Jacobian_c(j + 1, i, n3_c + 1 - k) *
                   lambda_c(j + 1, i, n3_c + 1 - k) *
                   XI23_c(j + 1, i, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j + 1, i, n3_c + 1 - k1, 2) * 2.0 / 3.0 +
              ...
              (-Jacobian_c(j - 2, i, n3_c + 1 - k) *
                   ...
                   u_c_t(j - 2, i, n3_c + 1 - k1, 3) / 12.0 +
               Jacobian_c(j - 1, i, n3_c + 1 - k) *
                   lambda_c(j - 1, i, n3_c + 1 - k) *
                   XI33_c(j - 1, i, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j - 1, i, n3_c + 1 - k1, 3) * 2.0 / 3.0 -
               Jacobian_c(j + 1, i, n3_c + 1 - k) *
                   lambda_c(j + 1, i, n3_c + 1 - k) *
                   XI33_c(j + 1, i, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j + 1, i, n3_c + 1 - k1, 3) * 2.0 / 3.0 +
              ...
              (-Jacobian_c(j, i - 2, n3_c + 1 - k) *
                   ...
                   u_c_t(j, i - 2, n3_c + 1 - k1, 1) / 12.0 +
               Jacobian_c(j, i - 1, n3_c + 1 - k) *
                   mu_c(j, i - 1, n3_c + 1 - k) *
                   XI23_c(j, i - 1, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j, i - 1, n3_c + 1 - k1, 1) * 2.0 / 3.0 -
               Jacobian_c(j, i + 1, n3_c + 1 - k) *
                   mu_c(j, i + 1, n3_c + 1 - k) *
                   XI23_c(j, i + 1, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j, i + 1, n3_c + 1 - k1, 1) * 2.0 / 3.0 +
              ...
              (-Jacobian_c(j, i - 2, n3_c + 1 - k) *
                   ...
                   u_c_t(j, i - 2, n3_c + 1 - k1, 2) / 12.0 +
               Jacobian_c(j, i - 1, n3_c + 1 - k) *
                   mu_c(j, i - 1, n3_c + 1 - k) *
                   XI13_c(j, i - 1, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j, i - 1, n3_c + 1 - k1, 2) * 2.0 / 3.0 -
               Jacobian_c(j, i + 1, n3_c + 1 - k) *
                   mu_c(j, i + 1, n3_c + 1 - k) *
                   XI13_c(j, i + 1, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j, i + 1, n3_c + 1 - k1, 2) * 2.0 / 3.0 +
          ...
          lh_c(j, i, k, 2) =
              ...
              (Jacobian_c(j - 2, i, k) * mu_c(j - 2, i, k) *
                   XI23_c(j - 2, i, k) * bof(k, k1) * u_c_t(j - 2, i, k1, 1) /
                   12.0 -
               Jacobian_c(j - 1, i, k) * mu_c(j - 1, i, k) *
                   XI23_c(j - 1, i, k) * bof(k, k1) * u_c_t(j - 1, i, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_c(j + 1, i, k) * mu_c(j + 1, i, k) *
                   XI23_c(j + 1, i, k) * bof(k, k1) * u_c_t(j + 1, i, k1, 1) *
                   2.0 / 3.0 -
               Jacobian_c(j + 2, i, k) * mu_c(j + 2, i, k) *
                  ...
                  l1 / h1_c / h3_c +
              (Jacobian_c(j - 2, i, k) * mu_c(j - 2, i, k) *
                   XI13_c(j - 2, i, k) * bof(k, k1) * u_c_t(j - 2, i, k1, 2) /
                   12.0 -
               Jacobian_c(j - 1, i, k) * mu_c(j - 1, i, k) *
                   XI13_c(j - 1, i, k) * bof(k, k1) * u_c_t(j - 1, i, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_c(j + 1, i, k) * mu_c(j + 1, i, k) *
                   XI13_c(j + 1, i, k) * bof(k, k1) * u_c_t(j + 1, i, k1, 2) *
                   2.0 / 3.0 -
              ...
              (Jacobian_c(j, i - 2, k) * lambda_c(j, i - 2, k) *
                   XI13_c(j, i - 2, k) * bof(k, k1) * u_c_t(j, i - 2, k1, 1) /
                   12.0 -
               Jacobian_c(j, i - 1, k) * lambda_c(j, i - 1, k) *
                   XI13_c(j, i - 1, k) * bof(k, k1) * u_c_t(j, i - 1, k1, 1) *
                   2.0 / 3.0 +
               Jacobian_c(j, i + 1, k) * lambda_c(j, i + 1, k) *
                   XI13_c(j, i + 1, k) * bof(k, k1) * u_c_t(j, i + 1, k1, 1) *
                   2.0 / 3.0 -
              ...
              (Jacobian_c(j, i - 2, k) *
                   ...
                   XI23_c(j, i - 2, k) * bof(k, k1) * u_c_t(j, i - 2, k1, 2) /
                   12.0 -
               Jacobian_c(j, i - 1, k) *
                   (2.0 * mu_c(j, i - 1, k) + lambda_c(j, i - 1, k)) *
                   XI23_c(j, i - 1, k) * bof(k, k1) * u_c_t(j, i - 1, k1, 2) *
                   2.0 / 3.0 +
               Jacobian_c(j, i + 1, k) *
                   (2.0 * mu_c(j, i + 1, k) + lambda_c(j, i + 1, k)) *
                   XI23_c(j, i + 1, k) * bof(k, k1) * u_c_t(j, i + 1, k1, 2) *
               ...
               Jacobian_c(j, i + 2, k) *
                  ...
                  l2 / h2_c / h3_c +
              (Jacobian_c(j, i - 2, k) * lambda_c(j, i - 2, k) *
                   XI33_c(j, i - 2, k) * bof(k, k1) * u_c_t(j, i - 2, k1, 3) /
                   12.0 -
               Jacobian_c(j, i - 1, k) * lambda_c(j, i - 1, k) *
                   XI33_c(j, i - 1, k) * bof(k, k1) * u_c_t(j, i - 1, k1, 3) *
                   2.0 / 3.0 +
               Jacobian_c(j, i + 1, k) * lambda_c(j, i + 1, k) *
                   XI33_c(j, i + 1, k) * bof(k, k1) * u_c_t(j, i + 1, k1, 3) *
                   2.0 / 3.0 -
          ...
          lh_c(j, i, n3_c + 1 - k, 2) =
              ...
              (-Jacobian_c(j, i - 2, n3_c + 1 - k) *
                   ...
                   u_c_t(j, i - 2, n3_c + 1 - k1, 3) / 12.0 +
               Jacobian_c(j, i - 1, n3_c + 1 - k) *
                   lambda_c(j, i - 1, n3_c + 1 - k) *
                   XI33_c(j, i - 1, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j, i - 1, n3_c + 1 - k1, 3) * 2.0 / 3.0 -
               Jacobian_c(j, i + 1, n3_c + 1 - k) *
                   lambda_c(j, i + 1, n3_c + 1 - k) *
                   XI33_c(j, i + 1, n3_c + 1 - k) * bof(k, k1) *
                   u_c_t(j, i + 1, n3_c + 1 - k1, 3) * 2.0 / 3.0 +
          ...
          lh_c(j, i, k, 3) = lh_c(j, i, k, 3) +
                             (Jacobian_c(j - 2, i, k) * mu_c(j - 2, i, k) *
                                  ...
                                  u_c_t(j - 2, i, k1, 1) / 12.0 -
                              Jacobian_c(j - 1, i, k) * mu_c(j - 1, i, k) *
                                  XI33_c(j - 1, i, k) * bof(k, k1) *
                                  u_c_t(j - 1, i, k1, 1) * 2.0 / 3.0 +
                              Jacobian_c(j + 1, i, k) * mu_c(j + 1, i, k) *
                                  XI33_c(j + 1, i, k) * bof(k, k1) *
                                  u_c_t(j + 1, i, k1, 1) * 2.0 / 3.0 -
                              Jacobian_c(j + 2, i, k) * mu_c(j + 2, i, k) *
                             ...
                             (Jacobian_c(j - 2, i, k) * mu_c(j - 2, i, k) *
                                  ...
                                  u_c_t(j - 2, i, k1, 3) / 12.0 -
                              Jacobian_c(j - 1, i, k) * mu_c(j - 1, i, k) *
                                  XI13_c(j - 1, i, k) * bof(k, k1) *
                                  u_c_t(j - 1, i, k1, 3) * 2.0 / 3.0 +
                              Jacobian_c(j + 1, i, k) * mu_c(j + 1, i, k) *
                                  XI13_c(j + 1, i, k) * bof(k, k1) *
                                  u_c_t(j + 1, i, k1, 3) * 2.0 / 3.0 -
                              Jacobian_c(j + 2, i, k) * mu_c(j + 2, i, k) *
                             ...
                             (Jacobian_c(j, i - 2, k) * mu_c(j, i - 2, k) *
                                  ...
                                  u_c_t(j, i - 2, k1, 2) / 12.0 -
                              Jacobian_c(j, i - 1, k) * mu_c(j, i - 1, k) *
                                  XI33_c(j, i - 1, k) * bof(k, k1) *
                                  u_c_t(j, i - 1, k1, 2) * 2.0 / 3.0 +
                              Jacobian_c(j, i + 1, k) * mu_c(j, i + 1, k) *
                                  XI33_c(j, i + 1, k) * bof(k, k1) *
                                  u_c_t(j, i + 1, k1, 2) * 2.0 / 3.0 -
                              Jacobian_c(j, i + 2, k) * mu_c(j, i + 2, k) *
                             ...
                             (Jacobian_c(j, i - 2, k) * mu_c(j, i - 2, k) *
                                  ...
                                  u_c_t(j, i - 2, k1, 3) / 12.0 -
                              Jacobian_c(j, i - 1, k) * mu_c(j, i - 1, k) *
                                  XI23_c(j, i - 1, k) * bof(k, k1) *
                                  u_c_t(j, i - 1, k1, 3) * 2.0 / 3.0 +
                              Jacobian_c(j, i + 1, k) * mu_c(j, i + 1, k) *
                                  XI23_c(j, i + 1, k) * bof(k, k1) *
                                  u_c_t(j, i + 1, k1, 3) * 2.0 / 3.0 -
                              Jacobian_c(j, i + 2, k) * mu_c(j, i + 2, k) *
      ...
      for (j = 1; j <= n1_c; j++) {
        ...
        lh_c(j, i, k, 1) =
            ...
            (Jacobian_c(j - 2, i, k) *
                 (2.0 * mu_c(j - 2, i, k) + lambda_c(j - 2, i, k)) *
                 XI13_c(j - 2, i, k) *
                 (u_c_t(j - 2, i, k - 2, 1) / 12.0 -
                  u_c_t(j - 2, i, k - 1, 1) * 2.0 / 3.0 +
                  u_c_t(j - 2, i, k + 1, 1) * 2.0 / 3.0 -
                  u_c_t(j - 2, i, k + 2, 1) / 12.0) /
                 12.0 -
             Jacobian_c(j - 1, i, k) *
                 (2.0 * mu_c(j - 1, i, k) + lambda_c(j - 1, i, k)) *
                 XI13_c(j - 1, i, k) *
                 (u_c_t(j - 1, i, k - 2, 1) / 12.0 -
                  u_c_t(j - 1, i, k - 1, 1) * 2.0 / 3.0 +
                  u_c_t(j - 1, i, k + 1, 1) * 2.0 / 3.0 -
                  u_c_t(j - 1, i, k + 2, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(j + 1, i, k) *
            ...
            (Jacobian_c(j - 2, i, k) * lambda_c(j - 2, i, k) *
                 XI23_c(j - 2, i, k) *
                 (u_c_t(j - 2, i, k - 2, 2) / 12.0 -
                  u_c_t(j - 2, i, k - 1, 2) * 2.0 / 3.0 +
                  u_c_t(j - 2, i, k + 1, 2) * 2.0 / 3.0 -
                  u_c_t(j - 2, i, k + 2, 2) / 12.0) /
                 12.0 -
             Jacobian_c(j - 1, i, k) * lambda_c(j - 1, i, k) *
                 XI23_c(j - 1, i, k) *
                 (u_c_t(j - 1, i, k - 2, 2) / 12.0 -
                  u_c_t(j - 1, i, k - 1, 2) * 2.0 / 3.0 +
                  u_c_t(j - 1, i, k + 1, 2) * 2.0 / 3.0 -
                  u_c_t(j - 1, i, k + 2, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(j + 1, i, k) * lambda_c(j + 1, i, k) *
            ...
            (Jacobian_c(j - 2, i, k) * lambda_c(j - 2, i, k) *
                 XI33_c(j - 2, i, k) *
                 (u_c_t(j - 2, i, k - 2, 3) / 12.0 -
                  u_c_t(j - 2, i, k - 1, 3) * 2.0 / 3.0 +
                  u_c_t(j - 2, i, k + 1, 3) * 2.0 / 3.0 -
                  u_c_t(j - 2, i, k + 2, 3) / 12.0) /
                 12.0 -
             Jacobian_c(j - 1, i, k) * lambda_c(j - 1, i, k) *
                 XI33_c(j - 1, i, k) *
                 (u_c_t(j - 1, i, k - 2, 3) / 12.0 -
                  u_c_t(j - 1, i, k - 1, 3) * 2.0 / 3.0 +
                  u_c_t(j - 1, i, k + 1, 3) * 2.0 / 3.0 -
                  u_c_t(j - 1, i, k + 2, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(j + 1, i, k) * lambda_c(j + 1, i, k) *
            ...
            (Jacobian_c(j, i - 2, k) * mu_c(j, i - 2, k) * XI23_c(j, i - 2, k) *
                 (u_c_t(j, i - 2, k - 2, 1) / 12.0 -
                  u_c_t(j, i - 2, k - 1, 1) * 2.0 / 3.0 +
                  u_c_t(j, i - 2, k + 1, 1) * 2.0 / 3.0 -
                  u_c_t(j, i - 2, k + 2, 1) / 12.0) /
                 12.0 -
             Jacobian_c(j, i - 1, k) * mu_c(j, i - 1, k) * XI23_c(j, i - 1, k) *
                 (u_c_t(j, i - 1, k - 2, 1) / 12.0 -
                  u_c_t(j, i - 1, k - 1, 1) * 2.0 / 3.0 +
                  u_c_t(j, i - 1, k + 1, 1) * 2.0 / 3.0 -
                  u_c_t(j, i - 1, k + 2, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(j, i + 1, k) * mu_c(j, i + 1, k) * XI23_c(j, i + 1, k) *
            ...
            (Jacobian_c(j, i - 2, k) * mu_c(j, i - 2, k) * XI13_c(j, i - 2, k) *
                 (u_c_t(j, i - 2, k - 2, 2) / 12.0 -
                  u_c_t(j, i - 2, k - 1, 2) * 2.0 / 3.0 +
                  u_c_t(j, i - 2, k + 1, 2) * 2.0 / 3.0 -
                  u_c_t(j, i - 2, k + 2, 2) / 12.0) /
                 12.0 -
             Jacobian_c(j, i - 1, k) * mu_c(j, i - 1, k) * XI13_c(j, i - 1, k) *
                 (u_c_t(j, i - 1, k - 2, 2) / 12.0 -
                  u_c_t(j, i - 1, k - 1, 2) * 2.0 / 3.0 +
                  u_c_t(j, i - 1, k + 1, 2) * 2.0 / 3.0 -
                  u_c_t(j, i - 1, k + 2, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(j, i + 1, k) * mu_c(j, i + 1, k) * XI13_c(j, i + 1, k) *
        ...
        lh_c(j, i, k, 2) =
            ...
            (Jacobian_c(j, i - 2, k) * lambda_c(j, i - 2, k) *
                 XI33_c(j, i - 2, k) *
                 (u_c_t(j, i - 2, k - 2, 3) / 12.0 -
                  u_c_t(j, i - 2, k - 1, 3) * 2.0 / 3.0 +
                  u_c_t(j, i - 2, k + 1, 3) * 2.0 / 3.0 -
                  u_c_t(j, i - 2, k + 2, 3) / 12.0) /
                 12.0 -
             Jacobian_c(j, i - 1, k) * lambda_c(j, i - 1, k) *
                 XI33_c(j, i - 1, k) *
                 (u_c_t(j, i - 1, k - 2, 3) / 12.0 -
                  u_c_t(j, i - 1, k - 1, 3) * 2.0 / 3.0 +
                  u_c_t(j, i - 1, k + 1, 3) * 2.0 / 3.0 -
                  u_c_t(j, i - 1, k + 2, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(j, i + 1, k) * lambda_c(j, i + 1, k) *
      ...
      for (k = 1; k <= n1_c; k++) {
        ...
        lh_c(k, j, i, 1) =
            ...
            (Jacobian_c(k, j, i - 2) *
                 ...
                 XI13_c(k, j, i - 2) *
                 (u_c_t(k - 2, j, i - 2, 1) / 12.0 -
                  u_c_t(k - 1, j, i - 2, 1) * 2.0 / 3.0 +
                  u_c_t(k + 1, j, i - 2, 1) * 2.0 / 3.0 -
                  u_c_t(k + 2, j, i - 2, 1) / 12.0) /
                 12.0 -
             Jacobian_c(k, j, i - 1) *
                 ...
                 XI13_c(k, j, i - 1) *
                 (u_c_t(k - 2, j, i - 1, 1) / 12.0 -
                  u_c_t(k - 1, j, i - 1, 1) * 2.0 / 3.0 +
                  u_c_t(k + 1, j, i - 1, 1) * 2.0 / 3.0 -
                  u_c_t(k + 2, j, i - 1, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(k, j, i + 1) *
            ...
            (Jacobian_c(k, j, i - 2) * mu_c(k, j, i - 2) * XI23_c(k, j, i - 2) *
                 (u_c_t(k - 2, j, i - 2, 2) / 12.0 -
                  u_c_t(k - 1, j, i - 2, 2) * 2.0 / 3.0 +
                  u_c_t(k + 1, j, i - 2, 2) * 2.0 / 3.0 -
                  u_c_t(k + 2, j, i - 2, 2) / 12.0) /
                 12.0 -
             Jacobian_c(k, j, i - 1) * mu_c(k, j, i - 1) * XI23_c(k, j, i - 1) *
                 (u_c_t(k - 2, j, i - 1, 2) / 12.0 -
                  u_c_t(k - 1, j, i - 1, 2) * 2.0 / 3.0 +
                  u_c_t(k + 1, j, i - 1, 2) * 2.0 / 3.0 -
                  u_c_t(k + 2, j, i - 1, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(k, j, i + 1) * mu_c(k, j, i + 1) * XI23_c(k, j, i + 1) *
            ...
            (Jacobian_c(k, j, i - 2) * mu_c(k, j, i - 2) * XI33_c(k, j, i - 2) *
                 (u_c_t(k - 2, j, i - 2, 3) / 12.0 -
                  u_c_t(k - 1, j, i - 2, 3) * 2.0 / 3.0 +
                  u_c_t(k + 1, j, i - 2, 3) * 2.0 / 3.0 -
                  u_c_t(k + 2, j, i - 2, 3) / 12.0) /
                 12.0 -
             Jacobian_c(k, j, i - 1) * mu_c(k, j, i - 1) * XI33_c(k, j, i - 1) *
                 (u_c_t(k - 2, j, i - 1, 3) / 12.0 -
                  u_c_t(k - 1, j, i - 1, 3) * 2.0 / 3.0 +
                  u_c_t(k + 1, j, i - 1, 3) * 2.0 / 3.0 -
                  u_c_t(k + 2, j, i - 1, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(k, j, i + 1) * mu_c(k, j, i + 1) * XI33_c(k, j, i + 1) *
        ...
        lh_c(k, j, i, 1) =
            lh_c(k, j, i, 1) +
            (Jacobian_c(k, j, i - 2) * mu_c(k, j, i - 2) * XI23_c(k, j, i - 2) *
                 (u_c_t(k, j - 2, i - 2, 1) / 12.0 -
                  u_c_t(k, j - 1, i - 2, 1) * 2.0 / 3.0 +
                  u_c_t(k, j + 1, i - 2, 1) * 2.0 / 3.0 -
                  u_c_t(k, j + 2, i - 2, 1) / 12.0) /
                 12.0 -
             Jacobian_c(k, j, i - 1) * mu_c(k, j, i - 1) * XI23_c(k, j, i - 1) *
                 (u_c_t(k, j - 2, i - 1, 1) / 12.0 -
                  u_c_t(k, j - 1, i - 1, 1) * 2.0 / 3.0 +
                  u_c_t(k, j + 1, i - 1, 1) * 2.0 / 3.0 -
                  u_c_t(k, j + 2, i - 1, 1) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(k, j, i + 1) * mu_c(k, j, i + 1) * XI23_c(k, j, i + 1) *
            ...
            (Jacobian_c(k, j, i - 2) * lambda_c(k, j, i - 2) *
                 XI13_c(k, j, i - 2) *
                 (u_c_t(k, j - 2, i - 2, 2) / 12.0 -
                  u_c_t(k, j - 1, i - 2, 2) * 2.0 / 3.0 +
                  u_c_t(k, j + 1, i - 2, 2) * 2.0 / 3.0 -
                  u_c_t(k, j + 2, i - 2, 2) / 12.0) /
                 12.0 -
             Jacobian_c(k, j, i - 1) * lambda_c(k, j, i - 1) *
                 XI13_c(k, j, i - 1) *
                 (u_c_t(k, j - 2, i - 1, 2) / 12.0 -
                  u_c_t(k, j - 1, i - 1, 2) * 2.0 / 3.0 +
                  u_c_t(k, j + 1, i - 1, 2) * 2.0 / 3.0 -
                  u_c_t(k, j + 2, i - 1, 2) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(k, j, i + 1) * lambda_c(k, j, i + 1) *
        ...
        lh_c(k, j, i, 2) =
            ...
            (Jacobian_c(k, j, i - 2) *
             ...
             Jacobian_c(k, j, i + 2) *
                ...
                l2 / h3_c / h2_c +
            (Jacobian_c(k, j, i - 2) * mu_c(k, j, i - 2) * XI33_c(k, j, i - 2) *
                 (u_c_t(k, j - 2, i - 2, 3) / 12.0 -
                  u_c_t(k, j - 1, i - 2, 3) * 2.0 / 3.0 +
                  u_c_t(k, j + 1, i - 2, 3) * 2.0 / 3.0 -
                  u_c_t(k, j + 2, i - 2, 3) / 12.0) /
                 12.0 -
             Jacobian_c(k, j, i - 1) * mu_c(k, j, i - 1) * XI33_c(k, j, i - 1) *
                 (u_c_t(k, j - 2, i - 1, 3) / 12.0 -
                  u_c_t(k, j - 1, i - 1, 3) * 2.0 / 3.0 +
                  u_c_t(k, j + 1, i - 1, 3) * 2.0 / 3.0 -
                  u_c_t(k, j + 2, i - 1, 3) / 12.0) *
                 2.0 / 3.0 +
             Jacobian_c(k, j, i + 1) * mu_c(k, j, i + 1) * XI33_c(k, j, i + 1) *
        ...
        for (k1 = 1; k1 <= 6; k1++) {
          ...
          lh_c(k, j, i, 1) =
              ...
              (bof(i, k1) * Jacobian_c(k, j, k1) *
               ...
               (u_c_t(k - 2, j, k1, 1) / 12.0 -
                u_c_t(k - 1, j, k1, 1) * 2.0 / 3.0 +
                u_c_t(k + 1, j, k1, 1) * 2.0 / 3.0 -
                u_c_t(k + 2, j, k1, 1) / 12.0)) /
                  l1 / h3_c / h1_c +
              (bof(i, k1) * Jacobian_c(k, j, k1) * mu_c(k, j, k1) *
               XI23_c(k, j, k1) *
               (u_c_t(k - 2, j, k1, 2) / 12.0 -
                u_c_t(k - 1, j, k1, 2) * 2.0 / 3.0 +
                u_c_t(k + 1, j, k1, 2) * 2.0 / 3.0 -
                u_c_t(k + 2, j, k1, 2) / 12.0)) /
                  l1 / h3_c / h1_c +
              (bof(i, k1) * Jacobian_c(k, j, k1) * mu_c(k, j, k1) *
               XI33_c(k, j, k1) *
               (u_c_t(k - 2, j, k1, 3) / 12.0 -
                u_c_t(k - 1, j, k1, 3) * 2.0 / 3.0 +
                u_c_t(k + 1, j, k1, 3) * 2.0 / 3.0 -
                u_c_t(k + 2, j, k1, 3) / 12.0)) /
                  l1 / h1_c / h3_c;
          ...
          lh_c(k, j, n3_c + 1 - i, 1) =
              ...
              (-bof(i, k1) * Jacobian_c(k, j, n3_c + 1 - k1) *
               ...
               (u_c_t(k - 2, j, n3_c + 1 - k1, 1) / 12.0 -
                u_c_t(k - 1, j, n3_c + 1 - k1, 1) * 2.0 / 3.0 +
                u_c_t(k + 1, j, n3_c + 1 - k1, 1) * 2.0 / 3.0 -
                u_c_t(k + 2, j, n3_c + 1 - k1, 1) / 12.0)) /
                  l1 / h3_c / h1_c +
              (-bof(i, k1) * Jacobian_c(k, j, n3_c + 1 - k1) *
               mu_c(k, j, n3_c + 1 - k1) * XI23_c(k, j, n3_c + 1 - k1) *
               (u_c_t(k - 2, j, n3_c + 1 - k1, 2) / 12.0 -
                u_c_t(k - 1, j, n3_c + 1 - k1, 2) * 2.0 / 3.0 +
                u_c_t(k + 1, j, n3_c + 1 - k1, 2) * 2.0 / 3.0 -
                u_c_t(k + 2, j, n3_c + 1 - k1, 2) / 12.0)) /
                  l1 / h3_c / h1_c +
              (-bof(i, k1) * Jacobian_c(k, j, n3_c + 1 - k1) *
               mu_c(k, j, n3_c + 1 - k1) * XI33_c(k, j, n3_c + 1 - k1) *
               (u_c_t(k - 2, j, n3_c + 1 - k1, 3) / 12.0 -
                u_c_t(k - 1, j, n3_c + 1 - k1, 3) * 2.0 / 3.0 +
                u_c_t(k + 1, j, n3_c + 1 - k1, 3) * 2.0 / 3.0 -
                u_c_t(k + 2, j, n3_c + 1 - k1, 3) / 12.0)) /
                  l1 / h1_c / h3_c;
          // second set equation
          ...
          lh_c(k, j, i, 1) = lh_c(k, j, i, 1) +
                             (bof(i, k1) * Jacobian_c(k, j, k1) *
                              ...
                              (u_c_t(k, j - 2, k1, 1) / 12.0 -
                               u_c_t(k, j - 1, k1, 1) * 2.0 / 3.0 +
                               u_c_t(k, j + 1, k1, 1) * 2.0 / 3.0 -
                               u_c_t(k, j + 2, k1, 1) / 12.0)) /
                                 l2 / h3_c / h2_c +
                             (bof(i, k1) * Jacobian_c(k, j, k1) *
                              lambda_c(k, j, k1) * XI13_c(k, j, k1) *
                              (u_c_t(k, j - 2, k1, 2) / 12.0 -
                               u_c_t(k, j - 1, k1, 2) * 2.0 / 3.0 +
                               u_c_t(k, j + 1, k1, 2) * 2.0 / 3.0 -
                               u_c_t(k, j + 2, k1, 2) / 12.0)) /
                                 l2 / h3_c / h2_c;
          ...
          lh_c(k, j, n3_c + 1 - i, 1) =
              ...
              (-bof(i, k1) * Jacobian_c(k, j, n3_c + 1 - k1) *
               mu_c(k, j, n3_c + 1 - k1) * XI23_c(k, j, n3_c + 1 - k1) *
               (u_c_t(k, j - 2, n3_c + 1 - k1, 1) / 12.0 -
                u_c_t(k, j - 1, n3_c + 1 - k1, 1) * 2.0 / 3.0 +
                u_c_t(k, j + 1, n3_c + 1 - k1, 1) * 2.0 / 3.0 -
                u_c_t(k, j + 2, n3_c + 1 - k1, 1) / 12.0)) /
                  l2 / h3_c / h2_c +
              (-bof(i, k1) * Jacobian_c(k, j, n3_c + 1 - k1) *
               lambda_c(k, j, n3_c + 1 - k1) * XI13_c(k, j, n3_c + 1 - k1) *
               (u_c_t(k, j - 2, n3_c + 1 - k1, 2) / 12.0 -
                u_c_t(k, j - 1, n3_c + 1 - k1, 2) * 2.0 / 3.0 +
                u_c_t(k, j + 1, n3_c + 1 - k1, 2) * 2.0 / 3.0 -
                u_c_t(k, j + 2, n3_c + 1 - k1, 2) / 12.0)) /
                  l2 / h3_c / h2_c;
          // second set equation
          lh_c(k, j, i, 2) =
              ...
              (bof(i, k1) * Jacobian_c(k, j, k1) * mu_c(k, j, k1) *
               XI33_c(k, j, k1) *
               (u_c_t(k, j - 2, k1, 3) / 12.0 -
                u_c_t(k, j - 1, k1, 3) * 2.0 / 3.0 +
                u_c_t(k, j + 1, k1, 3) * 2.0 / 3.0 -
                u_c_t(k, j + 2, k1, 3) / 12.0)) /
                  l2 / h3_c / h2_c;
          ...
          lh_c(k, j, n3_c + 1 - i, 2) =
              ...
              (-bof(i, k1) * Jacobian_c(k, j, n3_c + 1 - k1) *
               mu_c(k, j, n3_c + 1 - k1) * XI33_c(k, j, n3_c + 1 - k1) *
               (u_c_t(k, j - 2, n3_c + 1 - k1, 3) / 12.0 -
                u_c_t(k, j - 1, n3_c + 1 - k1, 3) * 2.0 / 3.0 +
                u_c_t(k, j + 1, n3_c + 1 - k1, 3) * 2.0 / 3.0 -
                u_c_t(k, j + 2, n3_c + 1 - k1, 3) / 12.0)) /
                  l2 / h3_c / h2_c;
          // third set equation
  ...
  for (j = 1; j <= n2_c; j++) {
    for (k = 1; k <= n1_c; k++) {
          ...
          for (m = 1; m <= 8; m++) {
            ...
            lh_c(k, j, i, 1) =
                ...
                (acof(i, k1, m) * Jacobian_c(k, j, m) *
                 ...
                 XI23_c(k, j, m) * u_c_t(k, j, k1, 2)) /
                    pow(h3_c, 2) +
                (acof(i, k1, m) * Jacobian_c(k, j, m) *
                 (mu_c(k, j, m) + lambda_c(k, j, m)) * XI13_c(k, j, m) *
                 XI33_c(k, j, m) * u_c_t(k, j, k1, 3)) /
                    pow(h3_c, 2);
                ...
                (acof(i, k1, m) * Jacobian_c(k, j, n3_c + 1 - m) *
                 ((2.0 * mu_c(k, j, n3_c + 1 - m) +
                  ...
                  mu_c(k, j, n3_c + 1 - m) *
                      (pow(XI23_c(k, j, n3_c + 1 - m), 2) +
                       pow(XI33_c(k, j, n3_c + 1 - m), 2))) *
                 u_c_t(k, j, n3_c + 1 - k1, 1)) /
                    pow(h3_c, 2) +
                (acof(i, k1, m) * Jacobian_c(k, j, n3_c + 1 - m) *
                 (mu_c(k, j, n3_c + 1 - m) + lambda_c(k, j, n3_c + 1 - m)) *
                 XI13_c(k, j, n3_c + 1 - m) * XI23_c(k, j, n3_c + 1 - m) *
                 u_c_t(k, j, n3_c + 1 - k1, 2)) /
                    pow(h3_c, 2) +
                (acof(i, k1, m) * Jacobian_c(k, j, n3_c + 1 - m) *
                 (mu_c(k, j, n3_c + 1 - m) + lambda_c(k, j, n3_c + 1 - m)) *
                 XI13_c(k, j, n3_c + 1 - m) * XI33_c(k, j, n3_c + 1 - m) *
                 u_c_t(k, j, n3_c + 1 - k1, 3)) /
                    pow(h3_c, 2);
            // second set equation
            lh_c(k, j, i, 2) =
                lh_c(k, j, i, 2) +
            ...
            lh_c(k, j, i, 3) =
                ...
                (acof(i, k1, m) * Jacobian_c(k, j, m) *
                 (mu_c(k, j, m) + lambda_c(k, j, m)) * XI13_c(k, j, m) *
                 XI33_c(k, j, m) * u_c_t(k, j, k1, 1)) /
                    pow(h3_c, 2) +
                (acof(i, k1, m) * Jacobian_c(k, j, m) *
                 (mu_c(k, j, m) + lambda_c(k, j, m)) * XI23_c(k, j, m) *
                 XI33_c(k, j, m) * u_c_t(k, j, k1, 2)) /
                    pow(h3_c, 2) +
                (acof(i, k1, m) * Jacobian_c(k, j, m) *
                 ((2.0 * mu_c(k, j, m) + lambda_c(k, j, m)) *
                      pow(XI33_c(k, j, m), 2) +
      ...
      lh_c(k, j, 1, 1) = lh_c(k, j, 1, 1) +
                         (u_c_t(k, j, 0, 1) * ghcof(1) * Jacobian_c(k, j, 1) *
                          ((2.0 * mu_c(k, j, 1) + lambda_c(k, j, 1)) *
                               pow(XI13_c(k, j, 1), 2) +
                           mu_c(k, j, 1) * (pow(XI23_c(k, j, 1), 2) +
                                            pow(XI33_c(k, j, 1), 2)))) /
                             pow(h3_c, 2) +
                         (u_c_t(k, j, 0, 2) * ghcof(1) * Jacobian_c(k, j, 1) *
                          (mu_c(k, j, 1) + lambda_c(k, j, 1)) *
                          XI13_c(k, j, 1) * XI23_c(k, j, 1)) /
                             pow(h3_c, 2) +
                         (u_c_t(k, j, 0, 3) * ghcof(1) * Jacobian_c(k, j, 1) *
                          (mu_c(k, j, 1) + lambda_c(k, j, 1)) *
      ...
      lh_c(k, j, n3_c, 1) =
          lh_c(k, j, n3_c, 1) +
          (u_c_t(k, j, n3_c + 1, 1) * ghcof(1) * Jacobian_c(k, j, n3_c) *
           ((2.0 * mu_c(k, j, n3_c) + lambda_c(k, j, n3_c)) *
                pow(XI13_c(k, j, n3_c), 2) +
            mu_c(k, j, n3_c) *
                (pow(XI23_c(k, j, n3_c), 2) + pow(XI33_c(k, j, n3_c), 2)))) /
              pow(h3_c, 2) +
          (u_c_t(k, j, n3_c + 1, 2) * ghcof(1) * Jacobian_c(k, j, n3_c) *
           (mu_c(k, j, n3_c) + lambda_c(k, j, n3_c)) * XI13_c(k, j, n3_c) *
           XI23_c(k, j, n3_c)) /
              pow(h3_c, 2) +
          (u_c_t(k, j, n3_c + 1, 3) * ghcof(1) * Jacobian_c(k, j, n3_c) *
           (mu_c(k, j, n3_c) + lambda_c(k, j, n3_c)) * XI13_c(k, j, n3_c) *
           XI33_c(k, j, n3_c)) /
              pow(h3_c, 2);
      // second set equation
