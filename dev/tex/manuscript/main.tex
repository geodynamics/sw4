...
\begin{breakablealgorithm}
	...
	\begin{itemize}
	\item  {Compute the predictor at the interior grid points for both fine and coarse domains {\color{red}(We use L instead of E, right?)}{\color{blue} fixed}
		\begin{equation*}
