...
\usepackage{amsfonts}
\usepackage{mathrsfs}
%\usepackage[top=1.0in,bottom=.0in,left=1.0in,right=1.0in]{geometry}
...
\begin{document}
\author{Lu Zhang\thanks{Department of Mathematics, Southern Methodist University, Dallas, TX 75275, USA. \href{mailto:luzhang@smu.edu}{Email: luzhang@smu.edu}}\and Siyang Wang\thanks{Division of Applied Mathematics, UKK, M\"alardalen University, V\"aster\aa s, 
