...
After applying the forward and backward mapping, reader can refer to \cite{petersson2015wave} for details, the elastic wave equation (\ref{elastic_eq_carte}) can be written as
