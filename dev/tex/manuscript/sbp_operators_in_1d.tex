...
\end{equation}
Here, the bilinear form $S_\gamma(\cdot,\cdot)$ is symmetric positive semi-definite, and does not use any ghost points. The operators $\wt{\bf b}_1$ and $\wt{\bf b}_n$ take the form %Using the right boundary as an example, we have 
