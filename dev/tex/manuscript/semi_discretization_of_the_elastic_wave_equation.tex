...
\end{equation}
Here,  $\left((\Lambda^{2h}J^{2h})\otimes{\bf I}\right)^{-1}\wt{\mathcal{A}}_3^{2h}{\bf c}$ and $\left((\Lambda^hJ^h)\otimes{\bf I}\right)^{-1}\mathcal{A}_3^h{\bf f}$ are approximations of the traction at the interface on the coarse grid and fine grid, respectively. $\wt{\mathcal{A}}_3^{2h}{\bf c}$ is a sum of three terms  $\wt{\mathcal{A}}_3^{2h}{\bf c}= {N}_{31}^{2h}{D}^{2h}_1{\bf c} + {N}_{32}^{2h}{D}^{2h}_2{\bf c} + {N}_{33}^{2h}\wt{\mathcal{D}}^{2h}_3{\bf c}$ given in Appendix \ref{appendix_cdomain}. $\mathcal{A}_3^h{\bf f}$ is defined analogously: ${\mathcal{A}}_3^{h}{\bf f}= {N}_{31}^{h}{D}^{h}_1{\bf f} + {N}_{32}^{h}{D}^{h}_2{\bf f} + {N}_{33}^{h}{\mathcal{D}}^{h}_3{\bf f}$ is given in Appendix \ref{appendix_cdomain}.   The operator $\mathcal{R}$ is a scaled restriction operator with the structure 
