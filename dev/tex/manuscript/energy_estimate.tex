...
\begin{proof}
	...
	&=& 8h_1h_2h_3\sum_{i = 1}^{n_1^{2h}}\sum_{j=1}^{n_2^{2h}}\sum_{k=1}^{n_3^{2h}}\omega_kJ^{2h}_{i,j,k}{\bf c}_t\cdot\left((\rho^{2h}\otimes{\bf I})\frac{d^2{\bf c}}{dt^2}\right),\nonumber\\
	&=& ({\bf c}_t, (\rho^{2h}\otimes {\bf I}){\bf c}_{tt})_{2h} = ({\bf c}_t,(J^{2h}\otimes {\bf I})^{-1}\wt{\mathcal{L}}^{2h}{\bf c})_{2h} = -\mathcal{S}_{2h}({\bf c}_t,{\bf c}) + B_{2h}({\bf c}_t,{{\bf c}}),\nonumber
	\end{eqnarray}
	...
	&=&\! h_1h_2h_3\sum_{i = 1}^{n_1^{h}}\sum_{j=1}^{n_2^{h}}\sum_{k=1}^{n_3^{h}}\omega_kJ^{h}_{i,j,k}{\bf f}_t\cdot\left((\rho^{h}\otimes{\bf I})\frac{d^2{\bf f}}{dt^2}\right), \nonumber\\
