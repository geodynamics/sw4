program Elastic_3D_Interface_nonconforming_cg_pre1
  ...
  real(dp) :: tol = 1e-7, numerator, denominator, rold_sum, rnew_sum, alpha, beta,num

  real(dp), dimension (:,:), allocatable :: Mass_f1,Vass_temp
  real(dp), dimension (:), allocatable :: Vass, LHS, pdir, rold, rnew, zprec, zprec_new
  ...
  allocate(Vass_temp(1:n1_c,1:n2_c))
  allocate(LHS(1:n1_c*n2_c*3))
  allocate(pdir(1:n1_c*n2_c*3))
  allocate(rold(1:n1_c*n2_c*3))
  allocate(rnew(1:n1_c*n2_c*3))
  allocate(zprec(1:n1_c*n2_c*3))
  allocate(zprec_new(1:n1_c*n2_c*3))
  ...
  ! update ghost points value for the interface with conjugate gradient method
  ...
  do j = 1,n2_c
     do i = 1,n1_c
        call dgetrs('N',3,1,Mass_pre(:,:,i,j),3,IPIV_pre(:,i,j),&
          zprec((j-1)*3*n1_c+3*(i-1)+1:(j-1)*3*n1_c+3*(i-1)+3),3,INFO)
        if (INFO .ne. 0) then
  ...
  pdir = zprec
  do while (maxval(abs(rold)) .gt. tol)
    !print *, maxval(abs(rold))
     call Interface_LHS_cg(pdir)
     numerator = 0.d0
     denominator = 0.d0
     do j = 1,n2_c
        do i = 1,n1_c
           numerator = numerator + rold((j-1)*3*n1_c+(i-1)*3+1)*zprec((j-1)*3*n1_c+(i-1)*3+1)&
             + rold((j-1)*3*n1_c+(i-1)*3+2)*zprec((j-1)*3*n1_c+(i-1)*3+2) &
             + rold((j-1)*3*n1_c+(i-1)*3+3)*zprec((j-1)*3*n1_c+(i-1)*3+3)
           denominator = denominator + pdir((j-1)*3*n1_c+(i-1)*3+1)*LHS((j-1)*3*n1_c+(i-1)*3+1) &
             + pdir((j-1)*3*n1_c+(i-1)*3+2)*LHS((j-1)*3*n1_c+(i-1)*3+2) &
             + pdir((j-1)*3*n1_c+(i-1)*3+3)*LHS((j-1)*3*n1_c+(i-1)*3+3)
        end do
     end do
     ...
     do j = 1,n2_c
        do i = 1,n1_c
           u_c(i,j,n3_c+1,1,1) = u_c(i,j,n3_c+1,1,1)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+1)
           u_c(i,j,n3_c+1,2,1) = u_c(i,j,n3_c+1,2,1)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+2)
           u_c(i,j,n3_c+1,3,1) = u_c(i,j,n3_c+1,3,1)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+3)
           rnew((j-1)*3*n1_c+(i-1)*3+1) = rold((j-1)*3*n1_c+(i-1)*3+1)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+1)
           rnew((j-1)*3*n1_c+(i-1)*3+2) = rold((j-1)*3*n1_c+(i-1)*3+2)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+2)
           rnew((j-1)*3*n1_c+(i-1)*3+3) = rold((j-1)*3*n1_c+(i-1)*3+3)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+3)
           zprec_new((j-1)*3*n1_c+(i-1)*3+1) = rnew((j-1)*3*n1_c+(i-1)*3+1)
           zprec_new((j-1)*3*n1_c+(i-1)*3+2) = rnew((j-1)*3*n1_c+(i-1)*3+2)
           zprec_new((j-1)*3*n1_c+(i-1)*3+3) = rnew((j-1)*3*n1_c+(i-1)*3+3)
        end do
     end do
     do j = 1,n2_c
        do i = 1,n1_c
          call dgetrs('N',3,1,Mass_pre(:,:,i,j),3,IPIV_pre(:,i,j),&
             zprec_new((j-1)*3*n1_c+3*(i-1)+1:(j-1)*3*n1_c+3*(i-1)+3),3,INFO)
          if (INFO .ne. 0) then
             write(*,"(A20)") 'Solving fails at (i,j) = ', i,j
          end if
          rold_sum = rold_sum+rold((j-1)*3*n1_c+(i-1)*3+1)*zprec((j-1)*3*n1_c+(i-1)*3+1)&
             +rold((j-1)*3*n1_c+(i-1)*3+2)*zprec((j-1)*3*n1_c+(i-1)*3+2) &
             +rold((j-1)*3*n1_c+(i-1)*3+3)*zprec((j-1)*3*n1_c+(i-1)*3+3)
          rnew_sum = rnew_sum+rnew((j-1)*3*n1_c+(i-1)*3+1)*zprec_new((j-1)*3*n1_c+(i-1)*3+1)&
             +rnew((j-1)*3*n1_c+(i-1)*3+2)*zprec_new((j-1)*3*n1_c+(i-1)*3+2)&
             +rnew((j-1)*3*n1_c+(i-1)*3+3)*zprec_new((j-1)*3*n1_c+(i-1)*3+3)
        end do
     end do
     beta = rnew_sum/rold_sum
     do j = 1,n2_c
        do i = 1,n1_c
           pdir((j-1)*3*n1_c+(i-1)*3+1) = zprec_new((j-1)*3*n1_c+(i-1)*3+1)+beta*pdir((j-1)*3*n1_c+(i-1)*3+1)
           pdir((j-1)*3*n1_c+(i-1)*3+2) = zprec_new((j-1)*3*n1_c+(i-1)*3+2)+beta*pdir((j-1)*3*n1_c+(i-1)*3+2)
           pdir((j-1)*3*n1_c+(i-1)*3+3) = zprec_new((j-1)*3*n1_c+(i-1)*3+3)+beta*pdir((j-1)*3*n1_c+(i-1)*3+3)
        end do
     end do
     rold = rnew
     zprec = zprec_new
  ...
  do time_index = 1, nt
     ...
     do j = 1,n2_c
        do i = 1,n1_c
           pdir((j-1)*3*n1_c+(i-1)*3+1) = u_c(i,j,n3_c+1,1,2)
           pdir((j-1)*3*n1_c+(i-1)*3+2) = u_c(i,j,n3_c+1,2,2)
           pdir((j-1)*3*n1_c+(i-1)*3+3) = u_c(i,j,n3_c+1,3,2)
        end do
     end do
     call Interface_LHS_cg(pdir)
     rold = Vass-LHS
     ...
     do while (maxval(abs(rold)) .gt. tol)
       ...
       !print *, maxval(abs(rold))
        ...
        do j = 1,n2_c
           do i = 1,n1_c
              u_c(i,j,n3_c+1,1,2) = u_c(i,j,n3_c+1,1,2)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+1)
              u_c(i,j,n3_c+1,2,2) = u_c(i,j,n3_c+1,2,2)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+2)
              u_c(i,j,n3_c+1,3,2) = u_c(i,j,n3_c+1,3,2)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+3)
              rnew((j-1)*3*n1_c+(i-1)*3+1) = rold((j-1)*3*n1_c+(i-1)*3+1)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+1)
              rnew((j-1)*3*n1_c+(i-1)*3+2) = rold((j-1)*3*n1_c+(i-1)*3+2)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+2)
              rnew((j-1)*3*n1_c+(i-1)*3+3) = rold((j-1)*3*n1_c+(i-1)*3+3)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+3)
              zprec_new((j-1)*3*n1_c+(i-1)*3+1) = rnew((j-1)*3*n1_c+(i-1)*3+1)
     ...
     do j = 1,n2_c
        do i = 1,n1_c
           pdir((j-1)*3*n1_c+(i-1)*3+1) = u_c(i,j,n3_c+1,1,3)
           pdir((j-1)*3*n1_c+(i-1)*3+2) = u_c(i,j,n3_c+1,2,3)
           pdir((j-1)*3*n1_c+(i-1)*3+3) = u_c(i,j,n3_c+1,3,3)
        end do
     end do
     call Interface_LHS_cg(pdir)
     rold = Vass-LHS
     ...
     do while (maxval(abs(rold)) .gt. tol)
       ...
       !print *, maxval(abs(rold))
        ...
        do j = 1,n2_c
           do i = 1,n1_c
              u_c(i,j,n3_c+1,1,3) = u_c(i,j,n3_c+1,1,3)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+1)
              u_c(i,j,n3_c+1,2,3) = u_c(i,j,n3_c+1,2,3)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+2)
              u_c(i,j,n3_c+1,3,3) = u_c(i,j,n3_c+1,3,3)+alpha*pdir((j-1)*3*n1_c+(i-1)*3+3)
              rnew((j-1)*3*n1_c+(i-1)*3+1) = rold((j-1)*3*n1_c+(i-1)*3+1)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+1)
              rnew((j-1)*3*n1_c+(i-1)*3+2) = rold((j-1)*3*n1_c+(i-1)*3+2)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+2)
              rnew((j-1)*3*n1_c+(i-1)*3+3) = rold((j-1)*3*n1_c+(i-1)*3+3)-alpha*LHS((j-1)*3*n1_c+(i-1)*3+3)
              zprec_new((j-1)*3*n1_c+(i-1)*3+1) = rnew((j-1)*3*n1_c+(i-1)*3+1)
  ...
  do k=1,n3_f
     do i=1,n2_f
        do j=1,n1_f
           ...
           l2_err_f = l2_err_f + h1_f*h2_f*h3_f*((u_f(j,i,k,1,4)-u_f(j,i,k,1,3))**2 &
  ...
  do k=1,n3_c
     do i=1,n2_c
        do j=1,n1_c
           ...
           l2_err_c = l2_err_c + h1_c*h2_c*h3_c*((u_c(j,i,k,1,4)-u_c(j,i,k,1,3))**2 &
  ...
  subroutine Interface_RHS(index)
    ...
    do k = -1,n2_c+1
       do i = -1,n1_c+1
          do j = -1,2
             do l = -1,2
                Mass_f1(2*i,2*k)=Mass_f1(2*i,2*k)+P(j)*(P(l)*sqrt(int_cof_c(i+l,k+j))*lh_c(i+l,k+j,n3_c,1)/rho_c(i+l,k+j,n3_c))
             end do
          end do
      end do
    end do
    ...
    do k = -1,n2_c+1
       do i = 0,n1_c+1
          do j = -1,2
             Mass_f1(2*i-1,2*k)=Mass_f1(2*i-1,2*k)+P(j)*sqrt(int_cof_c(i,k+j))*lh_c(i,k+j,n3_c,1)/rho_c(i,j+k,n3_c)
          end do
       end do
    end do
    !
    do k = 0,n2_c+1
       do i = -1,n1_c+1
          do j = -1,2
             Mass_f1(2*i,2*k-1)=Mass_f1(2*i,2*k-1)+P(j)*sqrt(int_cof_c(i+j,k))*lh_c(i+j,k,n3_c,1)/rho_c(i+j,k,n3_c)
          end do
       end do
    end do
    !
    do k = 0,n2_c+1
       do i = 0,n1_c+1
          Mass_f1(2*i-1,2*k-1)=sqrt(int_cof_c(i,k))*lh_c(i,k,n3_c,1)/rho_c(i,k,n3_c)
       end do
    end do
    ! restrict
    ! first set
          ...
          do j = -4,2
             do l = -4,2
                Vass((k-1)*3*n1_c+(i-1)*3+1)=Vass((k-1)*3*n1_c+(i-1)*3+1)&
                     ...
                     /int_cof_f(2*i+l,2*k+j)/sqrt(int_cof_c(i,k))
             end do
          end do
       end do
    end do
    ...
    do k = -1,n2_c+1
       do i = -1,n1_c+1
          do j = -1,2
             do l = -1,2
                Mass_f1(2*i,2*k)=Mass_f1(2*i,2*k)+P(j)*(P(l)*sqrt(int_cof_c(i+l,k+j))*lh_c(i+l,k+j,n3_c,2)/rho_c(i+l,k+j,n3_c))
             end do
          end do
      end do
    end do
    ...
    do k = -1,n2_c+1
       do i = 0,n1_c+1
          do j = -1,2
             Mass_f1(2*i-1,2*k)=Mass_f1(2*i-1,2*k)+P(j)*sqrt(int_cof_c(i,k+j))*lh_c(i,k+j,n3_c,2)/rho_c(i,j+k,n3_c)
          end do
       end do
    end do
    !
    do k = 0,n2_c+1
       do i = -1,n1_c+1
          do j = -1,2
             Mass_f1(2*i,2*k-1)=Mass_f1(2*i,2*k-1)+P(j)*sqrt(int_cof_c(i+j,k))*lh_c(i+j,k,n3_c,2)/rho_c(i+j,k,n3_c)
          end do
       end do
    end do
    !
    do k = 0,n2_c+1
       do i = 0,n1_c+1
          Mass_f1(2*i-1,2*k-1)=sqrt(int_cof_c(i,k))*lh_c(i,k,n3_c,2)/rho_c(i,k,n3_c)
       end do
    end do
    ! restriction
    ! second set
    ...
    do k = -1,n2_c+1
       do i = -1,n1_c+1
          do j = -1,2
             do l = -1,2
                Mass_f1(2*i,2*k)=Mass_f1(2*i,2*k)+P(j)*(P(l)*sqrt(int_cof_c(i+l,k+j))*lh_c(i+l,k+j,n3_c,3)/rho_c(i+l,k+j,n3_c))
             end do
          end do
      end do
    end do
    ...
    do k = -1,n2_c+1
       do i = 0,n1_c+1
          do j = -1,2
             Mass_f1(2*i-1,2*k)=Mass_f1(2*i-1,2*k)+P(j)*sqrt(int_cof_c(i,k+j))*lh_c(i,k+j,n3_c,3)/rho_c(i,j+k,n3_c)
          end do
       end do
    end do
    !
    do k = 0,n2_c+1
       do i = -1,n1_c+1
          do j = -1,2
             Mass_f1(2*i,2*k-1)=Mass_f1(2*i,2*k-1)+P(j)*sqrt(int_cof_c(i+j,k))*lh_c(i+j,k,n3_c,3)/rho_c(i+j,k,n3_c)
          end do
       end do
    end do
    !
    do k = 0,n2_c+1
       do i = 0,n1_c+1
          Mass_f1(2*i-1,2*k-1)=sqrt(int_cof_c(i,k))*lh_c(i,k,n3_c,3)/rho_c(i,k,n3_c)
       end do
    end do
    ! restrict
    ! third set
   ...
   do k = 1,n2_c
      do i = 1,n1_c
         do j = -4,2
            do l = -4,2
               ! first set
               Vass_temp(i,k) = Vass_temp(i,k)+Rop(j)*(Rop(l)*sqrt(int_cof_f(2*i+l,2*k+j))*lh_f(2*i+l,2*k+j,1,1))&
                  /int_cof_f(2*i+l,2*k+j)
            end do
        end do
        Vass_temp(i,k) = Vass_temp(i,k)/sqrt(int_cof_c(i,k))
        Vass((k-1)*3*n1_c+(i-1)*3+1) = Vass((k-1)*3*n1_c+(i-1)*3+1)+Vass_temp(i,k)
      end do
   end do
   !
   Vass_temp = 0.d0
   do k = 1,n2_c
      do i = 1,n1_c
         do j = -4,2
            do l = -4,2
               ! second set
               Vass_temp(i,k) = Vass_temp(i,k)+Rop(j)*(Rop(l)*sqrt(int_cof_f(2*i+l,2*k+j))*lh_f(2*i+l,2*k+j,1,2))&
                  /int_cof_f(2*i+l,2*k+j)
            end do
        end do
        Vass_temp(i,k) = Vass_temp(i,k)/sqrt(int_cof_c(i,k))
        Vass((k-1)*3*n1_c+(i-1)*3+2) = Vass((k-1)*3*n1_c+(i-1)*3+2)+Vass_temp(i,k)
      end do
   end do
   !
   Vass_temp = 0.d0
   do k = 1,n2_c
      do i = 1,n1_c
         do j = -4,2
            do l = -4,2
               ! third set
               Vass_temp(i,k) = Vass_temp(i,k)+Rop(j)*(Rop(l)*sqrt(int_cof_f(2*i+l,2*k+j))*lh_f(2*i+l,2*k+j,1,3))&
                  /int_cof_f(2*i+l,2*k+j)
            end do
        end do
        Vass_temp(i,k) = Vass_temp(i,k)/sqrt(int_cof_c(i,k))
        Vass((k-1)*3*n1_c+(i-1)*3+3) = Vass((k-1)*3*n1_c+(i-1)*3+3)+Vass_temp(i,k)
      end do
   end do
  !
...
end program Elastic_3D_Interface_nonconforming_cg_pre1
