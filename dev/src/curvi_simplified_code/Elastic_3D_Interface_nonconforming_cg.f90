program Elastic_3D_Interface_nonconforming_cg1
  ...
  real(dp), dimension (:), allocatable :: Vass, LHS, pdir, rold, rnew
  ...
  do j = 1,n2_c
     do i = 1,n1_c
        pdir((j-1)*3*n1_c+3*(i-1)+1) = u_c(i,j,n3_c+1,1,1)
        pdir((j-1)*3*n1_c+3*(i-1)+2) = u_c(i,j,n3_c+1,2,1)
        pdir((j-1)*3*n1_c+3*(i-1)+3) = u_c(i,j,n3_c+1,3,1)
     end do
  end do
  call Interface_LHS_cg(pdir)
  rold = Vass-LHS
  pdir = rold
  do while (maxval(rold) .gt. tol)
     !print *, maxval(rold)
     call Interface_LHS_cg(pdir)
     numerator = 0.d0
     denominator = 0.d0
     do j = 1,n2_c
        do i = 1,n1_c
           numerator = numerator + rold((j-1)*3*n1_c+(i-1)*3+1)**2
           denominator = denominator + pdir((j-1)*3*n1_c+(i-1)*3+1)*LHS((j-1)*3*n1_c+(i-1)*3+1)
           numerator = numerator + rold((j-1)*3*n1_c+(i-1)*3+2)**2
           denominator = denominator + pdir((j-1)*3*n1_c+(i-1)*3+2)*LHS((j-1)*3*n1_c+(i-1)*3+2)
           numerator = numerator + rold((j-1)*3*n1_c+(i-1)*3+3)**2
           denominator = denominator + pdir((j-1)*3*n1_c+(i-1)*3+3)*LHS((j-1)*3*n1_c+(i-1)*3+3)
        end do
     end do
     ...
     do j = 1,n2_c
        do i = 1,n1_c
           ...
           rold_sum = rold_sum+rold((j-1)*3*n1_c+(i-1)*3+1)**2+rold((j-1)*3*n1_c+(i-1)*3+2)**2+rold((j-1)*3*n1_c+(i-1)*3+3)**2
           rnew_sum = rnew_sum+rnew((j-1)*3*n1_c+(i-1)*3+1)**2+rnew((j-1)*3*n1_c+(i-1)*3+2)**2+rnew((j-1)*3*n1_c+(i-1)*3+3)**2
        end do
     end do
     beta = rnew_sum/rold_sum
     do j = 1,n2_c
        do i = 1,n1_c
           pdir((j-1)*3*n1_c+(i-1)*3+1) = rnew((j-1)*3*n1_c+(i-1)*3+1)+beta*pdir((j-1)*3*n1_c+(i-1)*3+1)
           pdir((j-1)*3*n1_c+(i-1)*3+2) = rnew((j-1)*3*n1_c+(i-1)*3+2)+beta*pdir((j-1)*3*n1_c+(i-1)*3+2)
           pdir((j-1)*3*n1_c+(i-1)*3+3) = rnew((j-1)*3*n1_c+(i-1)*3+3)+beta*pdir((j-1)*3*n1_c+(i-1)*3+3)
        end do
     end do
     rold = rnew
  end do
...
end program Elastic_3D_Interface_nonconforming_cg1
