program energy_test
  ...
  do time_index = 1, nt
     ...
     call discrete_energy(u_c(:,:,:,:,2),u_c(:,:,:,:,4),u_f(:,:,:,:,2), &
       u_f(:,:,:,:,4),dt,energy_discrete(time_index))
...
contains
  ...
  ! compute the discrete energy
  subroutine discrete_energy(uc_old,uc_new,uf_old,uf_new,dt,energy_num)
    real(dp), dimension(1-nrg:n1_c+nrg,1-nrg:n2_c+nrg,1-nrg:n3_c+nrg,1:dim) :: uc_old,uc_new
    real(dp), dimension(1-nrg:n1_f+nrg,1-nrg:n2_f+nrg,1-nrg:n3_f+nrg,1:dim) :: uf_old,uf_new
    real(dp), dimension(1:n1_c,1:n2_c,1:n3_c) :: Dc1,Dc2
    real(dp), dimension(1:n1_f,1:n2_f,1:n3_f) :: Df1,Df2
    ...
    ! term w.r.t N11
    do l2 = 1,3
      call FD_r1(h1_c,-1,n1_c+2,1,n2_c,1,n3_c,uc_new(-1:n1_c+2,1:n2_c,1:n3_c,l2),Dc1)
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r1(h1_c,-1,n1_c+2,1,n2_c,1,n3_c,uc_new(-1:n1_c+2,1:n2_c,1:n3_c,l1),Dc2)
        energy_temp_c = energy_temp_c + N11_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N12
    do l2 = 1,3
      call FD_r1(h1_c,-1,n1_c+2,1,n2_c,1,n3_c,uc_new(-1:n1_c+2,1:n2_c,1:n3_c,l2),Dc1)
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r2(h2_c,1,n1_c,-1,n2_c+2,1,n3_c,uc_new(1:n1_c,-1:n2_c+2,1:n3_c,l1),Dc2)
        energy_temp_c = energy_temp_c + N12_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N13
    do l2 = 1,3
      ...
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r3(h3_c,1,n1_c,1,n2_c,1,n3_c,uc_new(1:n1_c,1:n2_c,1:n3_c,l1),Dc2,bof)
        energy_temp_c = energy_temp_c + N13_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N21
    do l2 = 1,3
      call FD_r2(h2_c,1,n1_c,-1,n2_c+2,1,n3_c,uc_new(1:n1_c,-1:n2_c+2,1:n3_c,l2),Dc1)
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r1(h1_c,-1,n1_c+2,1,n2_c,1,n3_c,uc_new(-1:n1_c+2,1:n2_c,1:n3_c,l1),Dc2)
        energy_temp_c = energy_temp_c + N21_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N22
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r2(h2_c,1,n1_c,-1,n2_c+2,1,n3_c,uc_new(1:n1_c,-1:n2_c+2,1:n3_c,l1),Dc2)
        energy_temp_c = energy_temp_c + N22_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N23
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r3(h3_c,1,n1_c,1,n2_c,1,n3_c,uc_new(1:n1_c,1:n2_c,1:n3_c,l1),Dc2,bof)
        energy_temp_c = energy_temp_c + N23_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N31
    do l2 = 1,3
      call FD_r3(h3_c,1,n1_c,1,n2_c,1,n3_c,uc_new(1:n1_c,1:n2_c,1:n3_c,l2),Dc1,bof)
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r1(h1_c,-1,n1_c+2,1,n2_c,1,n3_c,uc_new(-1:n1_c+2,1:n2_c,1:n3_c,l1),Dc2)
        energy_temp_c = energy_temp_c + N31_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N32
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r2(h2_c,1,n1_c,-1,n2_c+2,1,n3_c,uc_new(1:n1_c,-1:n2_c+2,1:n3_c,l1),Dc2)
        energy_temp_c = energy_temp_c + N32_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! term w.r.t N33
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r3(h3_c,1,n1_c,1,n2_c,1,n3_c,uc_new(1:n1_c,1:n2_c,1:n3_c,l1),Dc2,bof)
        energy_temp_c = energy_temp_c + N33_c(1:n1_c,1:n2_c,1:n3_c,l2,l1)*Dc2
      end do
      energy_num_temp_c = energy_num_temp_c + Dc1*energy_temp_c
    end do
    ! add of grid points with corresponding weights
    energy_num = 0.d0
    do k = 5,n3_c-4
      do j = 1,n2_c
        do i = 1,n1_c
    ...
    do j = 1,n2_c
      do i = 1,n1_c
        energy_num = energy_num + h1_c*h2_c*h3_c*50.d0/48.d0*energy_num_temp_c(i,j,2) &
          + h1_c*h2_c*h3_c*50.d0/48.d0*energy_num_temp_c(i,j,n3_c-1)
      end do
    end do
    !
    do j = 1,n2_c
    ...
    energy_num_temp_f = energy_num_temp_f*Jacobian_f(1:n1_f,1:n2_f,1:n3_f)
    ! term w.r.t N11
    do l2 = 1,3
      call FD_r1(h1_f,-1,n1_f+2,1,n2_f,1,n3_f,uf_new(-1:n1_f+2,1:n2_f,1:n3_f,l2),Df1)
      energy_temp_f = 0.d0
      do l1 = 1,3
        call FD_r1(h1_f,-1,n1_f+2,1,n2_f,1,n3_f,uf_new(-1:n1_f+2,1:n2_f,1:n3_f,l1),Df2)
        energy_temp_f = energy_temp_f + N11_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N12
    do l2 = 1,3
      call FD_r1(h1_f,-1,n1_f+2,1,n2_f,1,n3_f,uf_new(-1:n1_f+2,1:n2_f,1:n3_f,l2),Df1)
      energy_temp_f = 0.d0
      do l1 = 1,3
        call FD_r2(h2_f,1,n1_f,-1,n2_f+2,1,n3_f,uf_new(1:n1_f,-1:n2_f+2,1:n3_f,l1),Df2)
        energy_temp_f = energy_temp_f + N12_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N13
    do l2 = 1,3
      ...
      energy_temp_f = 0.d0
      do l1 = 1,3
        call FD_r3(h3_f,1,n1_f,1,n2_f,1,n3_f,uf_new(1:n1_f,1:n2_f,1:n3_f,l1),Df2,bof)
        energy_temp_f = energy_temp_f + N13_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N21
    do l2 = 1,3
      call FD_r2(h2_f,1,n1_f,-1,n2_f+2,1,n3_f,uf_new(1:n1_f,-1:n2_f+2,1:n3_f,l2),Df1)
      energy_temp_f = 0.d0
      do l1 = 1,3
        call FD_r1(h1_f,-1,n1_f+2,1,n2_f,1,n3_f,uf_new(-1:n1_f+2,1:n2_f,1:n3_f,l1),Df2)
        energy_temp_f = energy_temp_f + N21_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N22
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r2(h2_f,1,n1_f,-1,n2_f+2,1,n3_f,uf_new(1:n1_f,-1:n2_f+2,1:n3_f,l1),Df2)
        energy_temp_f = energy_temp_f + N22_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N23
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r3(h3_f,1,n1_f,1,n2_f,1,n3_f,uf_new(1:n1_f,1:n2_f,1:n3_f,l1),Df2,bof)
        energy_temp_f = energy_temp_f + N23_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N31
    do l2 = 1,3
      call FD_r3(h3_f,1,n1_f,1,n2_f,1,n3_f,uf_new(1:n1_f,1:n2_f,1:n3_f,l2),Df1,bof)
      energy_temp_f = 0.d0
      do l1 = 1,3
        call FD_r1(h1_f,-1,n1_f+2,1,n2_f,1,n3_f,uf_new(-1:n1_f+2,1:n2_f,1:n3_f,l1),Df2)
        energy_temp_f = energy_temp_f + N31_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N32
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r2(h2_f,1,n1_f,-1,n2_f+2,1,n3_f,uf_new(1:n1_f,-1:n2_f+2,1:n3_f,l1),Df2)
        energy_temp_f = energy_temp_f + N32_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! term w.r.t N33
    do l2 = 1,3
      ...
      do l1 = 1,3
        call FD_r3(h3_f,1,n1_f,1,n2_f,1,n3_f,uf_new(1:n1_f,1:n2_f,1:n3_f,l1),Df2,bof)
        energy_temp_f = energy_temp_f + N33_f(1:n1_f,1:n2_f,1:n3_f,l2,l1)*Df2
      end do
      energy_num_temp_f = energy_num_temp_f + Df1*energy_temp_f
    end do
    ! add of grid points with corresponding weights
    ...
    do j = 1,n2_f
      do i = 1,n1_f
        energy_num = energy_num + h1_f*h2_f*h3_f*17.d0/48.d0*energy_num_temp_f(i,j,1) &
          + h1_f*h2_f*h3_f*17.d0/48.d0*energy_num_temp_f(i,j,n3_f)
      end do
    end do
    !
    do j = 1,n2_f
      do i = 1,n1_f
        energy_num = energy_num + h1_f*h2_f*h3_f*50.d0/48.d0*energy_num_temp_f(i,j,2) &
          + h1_f*h2_f*h3_f*50.d0/48.d0*energy_num_temp_f(i,j,n3_f-1)
      end do
    end do
    !
    do j = 1,n2_f
      do i = 1,n1_f
        energy_num = energy_num + h1_f*h2_f*h3_f*43.d0/48.d0*energy_num_temp_f(i,j,3) &
          + h1_f*h2_f*h3_f*43.d0/48.d0*energy_num_temp_f(i,j,n3_f-2)
      end do
    end do
    !
    do j = 1,n2_f
      do i = 1,n1_f
        energy_num = energy_num + h1_f*h2_f*h3_f*49.d0/48.d0*energy_num_temp_f(i,j,4) &
          + h1_f*h2_f*h3_f*49.d0/48.d0*energy_num_temp_f(i,j,n3_f-3)
      end do
    end do
