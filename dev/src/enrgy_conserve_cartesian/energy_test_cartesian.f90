...
contains
  ...
  subroutine discrete_energy(uc_old,uc_new,dt,energy_num)
    ...
    ! term w.r.t S_h(unew,uold)
    ! term w.r.t N11
    do l2 = 1,3
      call FD_r1(h1_c,-1,n1_c+2,1,n2_c,1,n3_c,uc_new(-1:n1_c+2,1:n2_c,1:n3_c,l2),Dc1)
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r1(h1_c,-1,n1_c+2,1,n2_c,1,n3_c,uc_old(-1:n1_c+2,1:n2_c,1:n3_c,l1),Dc2)
    ...
    do l2 = 1,3
      ...
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r2(h2_c,1,n1_c,-1,n2_c+2,1,n3_c,uc_old(1:n1_c,-1:n2_c+2,1:n3_c,l1),Dc2)
    ...
    do l2 = 1,3
      ...
      energy_temp_c = 0.d0
      do l1 = 1,3
        call FD_r3(h3_c,1,n1_c,1,n2_c,1,n3_c,uc_old(1:n1_c,1:n2_c,1:n3_c,l1),Dc2,bof)
