program Elastic_3D_Interface_conforming_static_reorder
  ...
  ! discrete energy
  real(dp), dimension (1:nt) :: energy_discrete
  real(dp), dimension (1:nt) :: times
...
contains
  ...
  subroutine discrete_energy(uc_old,uc_new,uf_old,uf_new,dt,energy_num)
    ...
    do k = 1,n3_c
      do j = 1,n2_c
        do i = 1,n1_c
          energy_num = energy_num + energy_num_temp_c(i,j,k)*Jacobian_c(i,j,k)
        end do
      end do
    end do
    !
    ...
    do k = 1,n3_f
      do j = 1,n2_f
        do i = 1,n1_f
          energy_num = energy_num + energy_num_temp_f(i,j,k)*Jacobian_f(i,j,k)
        end do
      end do
    end do
    !
...
end program Elastic_3D_Interface_conforming_static_reorder
