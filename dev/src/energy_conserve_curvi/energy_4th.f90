program energy_4th
  ...
  !
  real(dp), dimension(1:1000) :: energy_discrete, Times
  ...
  !!!
  do j = 1,n2_c
     u_c(1,j,n3_c+1,1,1) = 0.d0
     u_c(1,j,n3_c+1,2,1) = 0.d0
     u_c(1,j,n3_c+1,3,1) = 0.d0
     u_c(n1_c,j,n3_c+1,1,1) = 0.d0
     u_c(n1_c,j,n3_c+1,2,1) = 0.d0
     u_c(n1_c,j,n3_c+1,3,1) = 0.d0
  end do
  do i = 1,n1_c
     u_c(i,1,n3_c+1,1,1) = 0.d0
     u_c(i,1,n3_c+1,2,1) = 0.d0
     u_c(i,1,n3_c+1,3,1) = 0.d0
     u_c(i,n2_c,n3_c+1,1,1) = 0.d0
     u_c(i,n2_c,n3_c+1,2,1) = 0.d0
     u_c(i,n2_c,n3_c+1,3,1) = 0.d0
  end do
  ...
  do time_index = 1, nt
     ...
     !!!!!
     do j = 1,n2_c
        u_c(1,j,n3_c+1,1,2) = 0.d0
        u_c(1,j,n3_c+1,2,2) = 0.d0
        u_c(1,j,n3_c+1,3,2) = 0.d0
        u_c(n1_c,j,n3_c+1,1,2) = 0.d0
        u_c(n1_c,j,n3_c+1,2,2) = 0.d0
        u_c(n1_c,j,n3_c+1,3,2) = 0.d0
     end do
     do i = 1,n1_c
        u_c(i,1,n3_c+1,1,2) = 0.d0
        u_c(i,1,n3_c+1,2,2) = 0.d0
        u_c(i,1,n3_c+1,3,2) = 0.d0
        u_c(i,n2_c,n3_c+1,1,2) = 0.d0
        u_c(i,n2_c,n3_c+1,2,2) = 0.d0
        u_c(i,n2_c,n3_c+1,3,2) = 0.d0
     end do
     ...
     !!!!!!
     do j = 1,n2_c
        u_c(1,j,n3_c+1,1,3) = 0.d0
        u_c(1,j,n3_c+1,2,3) = 0.d0
        u_c(1,j,n3_c+1,3,3) = 0.d0
        u_c(n1_c,j,n3_c+1,1,3) = 0.d0
        u_c(n1_c,j,n3_c+1,2,3) = 0.d0
        u_c(n1_c,j,n3_c+1,3,3) = 0.d0
     end do
     do i = 1,n1_c
        u_c(i,1,n3_c+1,1,3) = 0.d0
        u_c(i,1,n3_c+1,2,3) = 0.d0
        u_c(i,1,n3_c+1,3,3) = 0.d0
        u_c(i,n2_c,n3_c+1,1,3) = 0.d0
        u_c(i,n2_c,n3_c+1,2,3) = 0.d0
        u_c(i,n2_c,n3_c+1,3,3) = 0.d0
     end do
     ...
     call discrete_energy(u_f(:,:,:,:,1),u_f(:,:,:,:,2),u_f(:,:,:,:,3),u_f(:,:,:,:,4),&
        u_c(:,:,:,:,1),u_c(:,:,:,:,2),u_c(:,:,:,:,3),u_c(:,:,:,:,4),dt,energy_discrete(time_index))
...
contains
    ...
    do i=1-nrg,n3_c+nrg
       do j=1-nrg,n2_c+nrg
          do k=1-nrg,n1_c+nrg
             ...
             rho_c(k,j,i,:) = 1.d0!2.d0 + sin(Xgrid_c(k,j,i,1)+0.3d0)*sin(Xgrid_c(k,j,i,2)+0.3d0)*sin(Xgrid_c(k,j,i,3)-0.2d0)
          end do
       end do
    end do
    do i=1-nrg,n3_f+nrg
       do j=1-nrg,n2_f+nrg
          do k=1-nrg,n1_f+nrg
             ...
             rho_f(k,j,i,:) = 1.d0!2.d0 + sin(Xgrid_f(k,j,i,1)+0.3d0)*sin(Xgrid_f(k,j,i,2)+0.3d0)*sin(Xgrid_f(k,j,i,3)-0.2d0)
          end do
       end do
    end do
  ...
  subroutine discrete_energy(uf_oldold,uf_old,uf_star,uf_new,uc_oldold,uc_old,uc_star,uc_new,dt,energy_num)
  ...
  (uf_star(1:n1_f,1:n2_f,1:n3_f,:) - 2.d0*uf_old(1:n1_f,1:n2_f,1:n3_f,:)+uf_oldold(1:n1_f,1:n2_f,1:n3_f,:))/dt**2
  ...
  energy_num_temp_f = energy_num_temp_f-( &
    ...
    +uf_new(1:n1_f,1:n2_f,1:n3_f,3)*(uf_new(1:n1_f,1:n2_f,1:n3_f,3)-uf_star(1:n1_f,1:n2_f,1:n3_f,3))/dt**2) &
      *rho_f(1:n1_f,1:n2_f,1:n3_f,1)!/Jacobian_f(1:n1_f,1:n2_f,1:n3_f)
    ! add grid points with corresponding weights
    do k = 5,n3_f-4
      do j = 1,n2_f
        do i = 1,n1_f
    ...
    do j = 1,n2_f
      do i = 1,n1_f
        energy_num = energy_num + h1_f*h2_f*h3_f*59.d0/48.d0*energy_num_temp_f(i,j,2) &
          + h1_f*h2_f*h3_f*59.d0/48.d0*energy_num_temp_f(i,j,n3_f-1)
      end do
    end do
    !
    do j = 1,n2_f
