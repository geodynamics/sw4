program energy_2nd_sy
  ...
  dt0 = min(h1_f,h2_f,h3_f)*cfl*0.9*0.5
  nt = ceiling(tn/dt0)+1
  dt = tn/nt
...
contains
  ...
  subroutine discrete_energy(uf_oldold,uf_old,uf_new,uc_oldold,uc_old,uc_new,dt,energy_num,energy_num_bdry,difference_b)
    ...
    do iset = 1,3
      ...
      do i = 1,n1_f
        do j = n2_f+1,n2_f+3
          if((boundary_f(i,j,iset) .ne. 0.d0) .or. (eta(i,j,1,iset) .ne. 0.d0)) then
            stop
          end if
        end do
      end do
      ...
      do l = 1,n2_c
         do i = 1,n1_c
            energy_num_bdry = energy_num_bdry + h1_c*h2_c*uc_new(i,l,n3_c,iset)*boundary_c(i,l,iset)
         end do
      end do
      ...
      do l = 1,n2_f
         do i = 1,n1_f
            energy_num_bdry = energy_num_bdry - h1_f*h2_f*uf_new(i,l,1,iset)*boundary_f(i,l,iset) &
              + h3_f*17.d0/48.d0*h1_f*h2_f*uf_new(i,l,1,iset)*eta(i,l,1,iset)
         end do
      end do
