program energy_2nd_20191218
  ...
  real(dp), dimension (1-nrg:n1_f+nrg,1-nrg:n2_f+nrg,1-nrg:n3_f+nrg,dim) :: force_f,force_tt_f,lh_f,eta,eta2
  ...
  dt0 = min(h1_f,h2_f,h3_f)*cfl*0.9d0*0.5d0
  nt = ceiling(tn/dt0)+1
  dt = tn/nt
  ...
  call Injection(1)
  u_c(1,1:n2_c,n3_c+1,1:3,1) = 0.d0
  u_c(n1_c,1:n2_c,n3_c+1,1:3,1) = 0.d0
  u_c(1:n1_c,1,n3_c+1,1:3,1) = 0.d0
  u_c(1:n1_c,n2_c,n3_c+1,1:3,1) = 0.d0
  ...
  do j = 1,n2_c-2
     do i = 1,n1_c-2
        u_c(i+1,j+1,n3_c+1,1,1) = Vass_1((j-1)*3*n1_c+3*(i-1)+1)
        u_c(i+1,j+1,n3_c+1,2,1) = Vass_1((j-1)*3*n1_c+3*(i-1)+2)
        u_c(i+1,j+1,n3_c+1,3,1) = Vass_1((j-1)*3*n1_c+3*(i-1)+3)
     end do
  end do
  ...
  call Injection(2)
  u_c(1,1:n2_c,n3_c+1,1:3,2) = 0.d0
  u_c(n1_c,1:n2_c,n3_c+1,1:3,2) = 0.d0
  u_c(1:n1_c,1,n3_c+1,1:3,2) = 0.d0
  u_c(1:n1_c,n2_c,n3_c+1,1:3,2) = 0.d0
  ...
  do j = 1,n2_c-2
     do i = 1,n1_c-2
        u_c(i+1,j+1,n3_c+1,1,2) = Vass_1((j-1)*3*n1_c+3*(i-1)+1)
        u_c(i+1,j+1,n3_c+1,2,2) = Vass_1((j-1)*3*n1_c+3*(i-1)+2)
        u_c(i+1,j+1,n3_c+1,3,2) = Vass_1((j-1)*3*n1_c+3*(i-1)+3)
     end do
  end do
  u_c(1,1:n2_c,n3_c+1,1:3,2) = 0.d0
  u_c(n1_c,1:n2_c,n3_c+1,1:3,2) = 0.d0
  ...
  do time_index = 1, nt
     ...
     !!!!!!
     !print *, maxval(abs(rho_c(1:n1_c,1:n2_c,n3_c,1)* &
	    ! (u_c(1:n1_c,1:n2_c,n3_c,1,3) - 2.d0*u_c(1:n1_c,1:n2_c,n3_c,1,2)&
	     ! +u_c(1:n1_c,1:n2_c,n3_c,1,1))/dt**2 -lh_c(1:n1_c,1:n2_c,n3_c,1))),&
       !maxval(abs(rho_c(1:n1_c,1:n2_c,n3_c,2)* &
   	    !(u_c(1:n1_c,1:n2_c,n3_c,2,3) - 2.d0*u_c(1:n1_c,1:n2_c,n3_c,2,2)&
   	     !+u_c(1:n1_c,1:n2_c,n3_c,2,1))/dt**2 -lh_c(1:n1_c,1:n2_c,n3_c,2))),&
        !maxval(abs(rho_c(1:n1_c,1:n2_c,n3_c,3)* &
   	     !(u_c(1:n1_c,1:n2_c,n3_c,3,3) - 2.d0*u_c(1:n1_c,1:n2_c,n3_c,3,2)&
   	      !+u_c(1:n1_c,1:n2_c,n3_c,3,1))/dt**2 -lh_c(1:n1_c,1:n2_c,n3_c,3)))
     !!!!!!!
     ...
     call Injection(3)
     u_c(1,1:n2_c,n3_c+1,1:3,3) = 0.d0
     u_c(n1_c,1:n2_c,n3_c+1,1:3,3) = 0.d0
     u_c(1:n1_c,1,n3_c+1,1:3,3) = 0.d0
     u_c(1:n1_c,n2_c,n3_c+1,1:3,3) = 0.d0
     ...
     do j = 1,n2_c-2
        do i = 1,n1_c-2
           u_c(i+1,j+1,n3_c+1,1,3) = Vass_1((j-1)*3*n1_c+3*(i-1)+1)
           u_c(i+1,j+1,n3_c+1,2,3) = Vass_1((j-1)*3*n1_c+3*(i-1)+2)
           u_c(i+1,j+1,n3_c+1,3,3) = Vass_1((j-1)*3*n1_c+3*(i-1)+3)
        end do
     end do
     u_c(1,1:n2_c,n3_c+1,1:3,3) = 0.d0
     u_c(n1_c,1:n2_c,n3_c+1,1:3,3) = 0.d0
     ...
     !!!!!!
     !call Update_interior(u_c(:,:,:,:,2),u_f(:,:,:,:,2))
     !lh_c(1,1:n2_c,n3_c,:) = 0.d0
     !lh_c(n1_c,1:n2_c,n3_c,:) = 0.d0
     !lh_c(1:n1_c,1,n3_c,:) = 0.d0
     !lh_c(1:n1_c,n2_c,n3_c,:) = 0.d0
     !print *, maxval(abs(rho_c(1:n1_c,1:n2_c,n3_c,1)* &
	   !  (u_c(1:n1_c,1:n2_c,n3_c,1,3) - 2.d0*u_c(1:n1_c,1:n2_c,n3_c,1,2)&
	   !   +u_c(1:n1_c,1:n2_c,n3_c,1,1))/dt**2 -lh_c(1:n1_c,1:n2_c,n3_c,1))),&
      ! maxval(abs(rho_c(1:n1_c,1:n2_c,n3_c,2)* &
     ...
     call discrete_energy(u_f(:,:,:,:,1),u_f(:,:,:,:,2),u_f(:,:,:,:,3),&
        u_c(:,:,:,:,1),u_c(:,:,:,:,2),u_c(:,:,:,:,3),dt,&
...
contains
       ...
       do jj = 1,3
          ...
          do k = -1,n2_c+1
             do i = -1,n1_c+1
               if (i .gt. -1 .and. k .gt. -1) then
                   Mass_p(2*i-1,2*k-1,i,k) = sqrt(int_cof_c(i,k))*N33_c(i,k,n3_c,iset,jj)/rho_c(i,k,n3_c,iset)
                   Mass_p(2*i-1,2*k-1,i,k) = Mass_p(2*i-1,2*k-1,i,k)/sqrt(int_cof_f(2*i-1,2*k-1))
               end if
               if (i .gt. -1 .and. k .ge. -1) then
                  do j = -1,2
                     Mass_p(2*i-1,2*k,i,k+j) = Mass_p(2*i-1,2*k,i,k+j) &
                        + P(j)*sqrt(int_cof_c(i,k+j))*N33_c(i,k+j,n3_c,iset,jj)/rho_c(i,k+j,n3_c,iset)
                  end do
                  Mass_p(2*i-1,2*k,i,k-1:k+2) = Mass_p(2*i-1,2*k,i,k-1:k+2)/sqrt(int_cof_f(2*i-1,2*k))
               end if
               if (i .ge. -1 .and. k .gt. -1) then
                  do j = -1,2
                     Mass_p(2*i,2*k-1,i+j,k) = Mass_p(2*i,2*k-1,i+j,k) &
                        + P(j)*sqrt(int_cof_c(i+j,k))*N33_c(i+j,k,n3_c,iset,jj)/rho_c(i+j,k,n3_c,iset)
                  end do
                  Mass_p(2*i,2*k-1,i-1:i+2,k) = Mass_p(2*i,2*k-1,i-1:i+2,k)/sqrt(int_cof_f(2*i,2*k-1))
               end if
                do l = -1,2
                   do j = -1,2
                      Mass_p(2*i,2*k,i+j,k+l) = Mass_p(2*i,2*k,i+j,k+l) &
                         +P(l)*(P(j)*sqrt(int_cof_c(i+j,k+l))*N33_c(i+j,k+l,n3_c,iset,jj)/rho_c(i+j,k+l,n3_c,iset))
                  end do
              end do
              Mass_p(2*i,2*k,i-1:i+2,k-1:k+2) = Mass_p(2*i,2*k,i-1:i+2,k-1:k+2)/sqrt(int_cof_f(2*i,2*k))
           end do
        end do
        ...
        do k = 2,n2_c-1
           do i = 2,n1_c-1
              do l = -4,2
                 do j = -4,2
                      Mass_r(i,k,2:n1_c-1,2:n2_c-1) = Mass_r(i,k,2:n1_c-1,2:n2_c-1) &
                      + Rop(l)*(Rop(j)*sqrt(int_cof_f(2*i+j,2*k+l))*rho_f(2*i+j,2*k+l,1,iset)*Mass_p(2*i+j,2*k+l,2:n1_c-1,2:n2_c-1)&
                      /int_cof_f(2*i+j,2*k+l))
                 end do
              end do
              Mass_r(i,k,2:n1_c-1,2:n2_c-1) = Mass_r(i,k,2:n1_c-1,2:n2_c-1)/sqrt(int_cof_c(i,k))
           end do
        end do
        do l = 1,n2_c-2
           do k = 1,n1_c-2
              do j = 1,n2_c-2
                 do i = 1,n1_c-2
                    Mass((l-1)*3*(n1_c-2)+(k-1)*3+iset,(j-1)*3*(n1_c-2)+(i-1)*3+jj) &
                      = Mass_r(k+1,l+1,i+1,j+1)*int_cof
                 end do
              end do
           end do
        end do
  ...
  subroutine Interface_RHS(index)
    ...
    do iset = 1,3
      ...
      lh_c(-2:0,:,n3_c,iset) = 0.d0
      lh_c(n1_c+1:n1_c+3,:,n3_c,iset) = 0.d0
      lh_c(:,-2:0,n3_c,iset) = 0.d0
      lh_c(:,n2_c+1:n2_c+3,n3_c,iset) = 0.d0
      ...
      do k = -1,n2_c+1
       ...
       Mass_f1(-2:0,:) = 0.d0
       Mass_f1(n1_f+1:n1_f+3,:) = 0.d0
       Mass_f1(:,-2:0) = 0.d0
       Mass_f1(:,n2_f+1:n2_f+3) = 0.d0
         ...
         do i = 1,n1_c
            do j = -4,2
               do l = -4,2
                  ...
                  -17.d0/48.d0*h3_f*Rop(j)*(Rop(l)*sqrt(int_cof_f(2*i+l,2*k+j))*rho_f(2*i+l,2*k+j,1,1)&
                  *Mass_f1(2*i+l,2*k+j)/int_cof_f(2*i+l,2*k+j))
               end do
            end do
  ...
  subroutine Injection(index)
    ...
    do j = 1, n2_c
       do i = 1, n1_c
          u_f(2*i-1,2*j-1,1,:,index) = sqrt(int_cof_c(i,j))*u_c(i,j,n3_c,:,index)
          u_f(2*i-1,2*j-1,1,:,index) = u_f(2*i-1,2*j-1,1,:,index)/sqrt(int_cof_f(2*i-1,2*j-1))

          u_f(2*i,2*j-1,1,:,index) = P(-1)*sqrt(int_cof_c(i-1,j))*u_c(i-1,j,n3_c,:,index) &
            +P(0)*sqrt(int_cof_c(i,j))*u_c(i,j,n3_c,:,index)+P(1)*sqrt(int_cof_c(i+1,j))*u_c(i+1,j,n3_c,:,index)&
            +P(2)*sqrt(int_cof_c(i+2,j))*u_c(i+2,j,n3_c,:,index)
          u_f(2*i,2*j-1,1,:,index) = u_f(2*i,2*j-1,1,:,index)/sqrt(int_cof_f(2*i,2*j-1))

          u_f(2*i-1,2*j,1,:,index) = P(-1)*sqrt(int_cof_c(i,j-1))*u_c(i,j-1,n3_c,:,index)&
            +P(0)*sqrt(int_cof_c(i,j))*u_c(i,j,n3_c,:,index)+P(1)*sqrt(int_cof_c(i,j+1))*u_c(i,j+1,n3_c,:,index)&
            +P(2)*sqrt(int_cof_c(i,j+2))*u_c(i,j+2,n3_c,:,index)
          u_f(2*i-1,2*j,1,:,index) = u_f(2*i-1,2*j,1,:,index)/sqrt(int_cof_f(2*i-1,2*j))

          u_f(2*i,2*j,1,:,index) = P(-1)*(P(-1)*sqrt(int_cof_c(i-1,j-1))*u_c(i-1,j-1,n3_c,:,index)&
            +P(0)*sqrt(int_cof_c(i,j-1))*u_c(i,j-1,n3_c,:,index)+P(1)*sqrt(int_cof_c(i+1,j-1))*u_c(i+1,j-1,n3_c,:,index)&
            +P(2)*sqrt(int_cof_c(i+2,j-1))*u_c(i+2,j-1,n3_c,:,index))&
            +P(0)*(P(-1)*sqrt(int_cof_c(i-1,j))*u_c(i-1,j,n3_c,:,index)+P(0)*sqrt(int_cof_c(i,j))*u_c(i,j,n3_c,:,index)&
            +P(1)*sqrt(int_cof_c(i+1,j))*u_c(i+1,j,n3_c,:,index)+P(2)*sqrt(int_cof_c(i+2,j))*u_c(i+2,j,n3_c,:,index))&
            +P(1)*(P(-1)*sqrt(int_cof_c(i-1,j+1))*u_c(i-1,j+1,n3_c,:,index)+P(0)*sqrt(int_cof_c(i,j+1))*u_c(i,j+1,n3_c,:,index)&
            +P(1)*sqrt(int_cof_c(i+1,j+1))*u_c(i+1,j+1,n3_c,:,index)+P(2)*sqrt(int_cof_c(i+2,j+1))*u_c(i+2,j+1,n3_c,:,index))&
            +P(2)*(P(-1)*sqrt(int_cof_c(i-1,j+2))*u_c(i-1,j+2,n3_c,:,index)+P(0)*sqrt(int_cof_c(i,j+2))*u_c(i,j+2,n3_c,:,index)&
            +P(1)*sqrt(int_cof_c(i+1,j+2))*u_c(i+1,j+2,n3_c,:,index)+P(2)*sqrt(int_cof_c(i+2,j+2))*u_c(i+2,j+2,n3_c,:,index))
          u_f(2*i,2*j,1,:,index) = u_f(2*i,2*j,1,:,index)/sqrt(int_cof_f(2*i,2*j))
       end do
    end do
  ...
  subroutine compute_eta(index)
    ...
    do iset = 1,3
      ...
      ! enforce the term contain p(lc) = 0 at ghost points
      eta(-2:0,:,1,iset) = 0.d0
      eta(n1_f+1:n1_f+3,:,1,iset) = 0.d0
      eta(:,-2:0,1,iset) = 0.d0
      eta(:,n2_f+1:n2_f+3,1,iset) = 0.d0
  ...
  !
  subroutine compute_eta2(uf_oldold,uf_old,uf_new,uc_oldold,uc_old,uc_new,dt,index)
    !
    real(dp), dimension(1-nrg:n1_c+nrg,1-nrg:n2_c+nrg,1-nrg:n3_c+nrg,1:dim) :: uc_oldold,uc_old,uc_new
    real(dp), dimension(1-nrg:n1_f+nrg,1-nrg:n2_f+nrg,1-nrg:n3_f+nrg,1:dim) :: uf_oldold,uf_old,uf_new
    real(dp) :: dt
    integer :: index

    real(dp), dimension(-2:n1_c+3,-2:n2_c+3,1:3) :: Lh_old_c
    real(dp), dimension(-2:n1_f+3,-2:n2_f+3,1:3) :: Lh_old_f_c
    real(dp), dimension(1:n1_f,1:n2_f,1:3) :: Lh_old_f
    ...
    Lh_old_c = 0.d0
    Lh_old_c(-2:n1_c+3,-2:n2_c+3,:) = &
        (uc_new(-2:n1_c+3,-2:n2_c+3,n3_c,:) - 2.d0*uc_old(-2:n1_c+3,-2:n2_c+3,n3_c,:)&
	      +uc_oldold(-2:n1_c+3,-2:n2_c+3,n3_c,:))/dt**2
    ! project
    Lh_old_f_c = 0.d0
    do iset = 1,3
       do k = -1,n2_c+1
          do i = -1,n1_c+1
             if (k .gt. -1 .and. i .gt. -1) then
               Lh_old_f_c(2*i-1,2*k-1,iset)=sqrt(int_cof_c(i,k))*lh_old_c(i,k,iset)
               Lh_old_f_c(2*i-1,2*k-1,iset) = Lh_old_f_c(2*i-1,2*k-1,iset)/sqrt(int_cof_f(2*i-1,2*k-1))
             end if
             if (k .ge. -1 .and. i .gt. -1) then
                do j = -1,2
                  Lh_old_f_c(2*i-1,2*k,iset)=Lh_old_f_c(2*i-1,2*k,iset)&
                   +P(j)*sqrt(int_cof_c(i,k+j))*lh_old_c(i,k+j,iset)
                end do
                Lh_old_f_c(2*i-1,2*k,iset) = Lh_old_f_c(2*i-1,2*k,iset)/sqrt(int_cof_f(2*i-1,2*k))
             end if
             if (k .gt. -1 .and. i .ge. -1) then
                do j = -1,2
                   Lh_old_f_c(2*i,2*k-1,iset)=Lh_old_f_c(2*i,2*k-1,iset)&
                    +P(j)*sqrt(int_cof_c(i+j,k))*lh_old_c(i+j,k,iset)
                end do
                Lh_old_f_c(2*i,2*k-1,iset)=Lh_old_f_c(2*i,2*k-1,iset)/sqrt(int_cof_f(2*i,2*k-1))
             end if
             do j = -1,2
                do l = -1,2
                   Lh_old_f_c(2*i,2*k,iset)=Lh_old_f_c(2*i,2*k,iset)&
                    +P(j)*(P(l)*sqrt(int_cof_c(i+l,k+j))*lh_old_c(i+l,k+j,iset))
                end do
             end do
             Lh_old_f_c(2*i,2*k,iset) = Lh_old_f_c(2*i,2*k,iset)/sqrt(int_cof_f(2*i,2*k))
           end do
        end do
        Lh_old_f_c(1:n1_f,1:n2_f,iset) = rho_f(1:n1_f,1:n2_f,1,1)*Lh_old_f_c(1:n1_f,1:n2_f,iset)
        !
        ! term 3
        ! second derivatives 11
        lh_f = 0.d0
        ...
        lh_f(:,n2_f+1:n2_f+3,1,iset) = 0.d0
        !
        eta2(-2:n1_f+3,-2:n2_f+3,1,iset) &
          = lh_old_f_c(-2:n1_f+3,-2:n2_f+3,iset)-lh_f(-2:n1_f+3,-2:n2_f+3,1,iset)
      end do
     !
  end subroutine compute_eta2
  !
  ...
  !
  subroutine verify_update_f_interface(uf_oldold,uf_old,uf_new,dt,index)
    !
    real(dp), dimension(1-nrg:n1_f+nrg,1-nrg:n2_f+nrg,1-nrg:n3_f+nrg,1:dim) :: uf_oldold,uf_old,uf_new
    integer :: index
    real(dp) :: dt
    ...
    real(dp), dimension(1:n1_f,1:n2_f,1:3) :: Lh_old_f
     ...
     !
     Lh_old_f(1:n1_f,1:n2_f,:) = rho_f(1:n1_f,1:n2_f,1,:)*&
         (uf_new(1:n1_f,1:n2_f,1,:) - 2.d0*uf_old(1:n1_f,1:n2_f,1,:)&
 	      +uf_oldold(1:n1_f,1:n2_f,1,:))/dt**2
     !
     print *, maxval(abs(eta2(2:n1_f-1,2:n2_f-1,1,:) + lh_f(2:n1_f-1,2:n2_f-1,1,:)-lh_old_f(2:n1_f-1,2:n2_f-1,:)))

  end subroutine verify_update_f_interface
  !
  subroutine discrete_energy(uf_oldold,uf_old,uf_new,uc_oldold,uc_old,uc_new,dt,energy_num,energy_num_bdry,difference_b)
    real(dp), dimension(1-nrg:n1_c+nrg,1-nrg:n2_c+nrg,1-nrg:n3_c+nrg,1:dim) :: uc_oldold,uc_old,uc_new
    real(dp), dimension(1-nrg:n1_f+nrg,1-nrg:n2_f+nrg,1-nrg:n3_f+nrg,1:dim) :: uf_oldold,uf_old,uf_new
    ...
    real(dp) :: dt,energy_num,energy_num_bdry,difference_b
    ...
    do l1 = 1,3
	  ...
	  Lh_old_c(-2:n1_c+3,-2:n2_c+3,:,:) = rho_c(-2:n1_c+3,-2:n2_c+3,1:n3_c,:)* &
	     (uc_new(-2:n1_c+3,-2:n2_c+3,1:n3_c,:) - 2.d0*uc_old(-2:n1_c+3,-2:n2_c+3,1:n3_c,:)&
    ...
    !call Update_interior(uc_old,uf_old)
    !lh_old_f = lh_f(1:n1_f,1:n2_f,1:n3_f,:)
    !lh_old_f(1,1:n2_f,1:n3_f,:) = 0.d0
    !lh_old_f(n1_f,1:n2_f,1:n3_f,:) = 0.d0
    !lh_old_f(1:n1_f,1,1:n3_f,:) = 0.d0
    !lh_old_f(1:n1_f,n2_f,1:n3_f,:) = 0.d0
    !lh_old_f(1:n1_f,1:n2_f,n3_f,:) = 0.d0
    ...
    ! interface integral
    call compute_eta(2)
    call compute_eta2(uf_oldold,uf_old,uf_new,uc_oldold,uc_old,uc_new,dt,2)
    !print *, maxval(abs(eta(1:n1_f,1:n2_f,1,:)-eta2(1:n1_f,1:n2_f,1,:)))
    difference = 0.d0
    !call verify_bdry(2)
    ...
    do iset = 1,3
      ...
      ! enforce the term contain p(lc) = 0 at ghost points
      boundary_f(-2:0,:,iset) = 0.d0
      boundary_f(n1_f+1:n1_f+3,:,iset) = 0.d0
      boundary_f(:,-2:0,iset) = 0.d0
      boundary_f(:,n2_f+1:n2_f+3,iset) = 0.d0
      !
      do l = 1,n2_c
         do i = 1,n1_c
            energy_num_bdry = energy_num_bdry &
             + h1_c*h2_c*(uc_new(i,l,n3_c,iset))*boundary_c(i,l,iset)
         end do
      end do
      ...
      do l = 1,n2_f
         do i = 1,n1_f
            !energy_num_bdry = energy_num_bdry&
              !+ (-h1_f*h2_f*(uf_new(i,l,1,iset))*boundary_f(i,l,iset)) !&
              !+ h3_f*17.d0/48.d0*h1_f*h2_f*(uf_new(i,l,1,iset))*eta2(i,l,1,iset))
            !
            energy_num_bdry = energy_num_bdry&
              + (-h1_f*h2_f*(uf_new(i,l,1,iset))*boundary_f(i,l,iset) &
              + h3_f*17.d0/48.d0*h1_f*h2_f*(uf_new(i,l,1,iset))*eta2(i,l,1,iset))
    ...
    ! verify rho f_tt = l_h f + eta on interface (note that in code, rho, l_h, eta have been multiplied by J_h)
    call verify_update_f_interface(uf_oldold,uf_old,uf_new,dt,2)
