...
contains
  ...
  subroutine Interface_RHS(index)
    ...
    do iset = 1,3
      ...
      lh_c(-2:0,-2:n2_c+3,n3_c,iset) = 0.d0
      lh_c(n1_c+1:n1_c+3,-2:n2_c+3,n3_c,iset) = 0.d0
      lh_c(1:n1_c,-2:0,n3_c,iset) = 0.d0
      lh_c(1:n1_c,n2_c+1:n2_c+3,n3_c,iset) = 0.d0
      ...
      do k = -1,n2_c+1
       ...
       Mass_f1(-2:0,-2:n2_f+3) = 0.d0
       Mass_f1(n1_f+1:n1_f+3,-2:n2_f+3) = 0.d0
       Mass_f1(1:n1_f,-2:0) = 0.d0
       Mass_f1(1:n1_f,n2_f+1:n2_f+3) = 0.d0
      ...
      lh_f(-2:0,-2:n2_f+3,1,iset) = 0.d0
      lh_f(n1_f+1:n1_f+3,-2:n2_f+3,1,iset) = 0.d0
      lh_f(1:n1_f,-2:0,1,iset) = 0.d0
      lh_f(1:n1_f,n2_f+1:n2_f+3,1,iset) = 0.d0
...
end program energy_2nd_20191207
