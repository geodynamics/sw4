...
contains
  ...
  subroutine generate_grid(X1_c,X2_c,X3_c,X1_f,X2_f,X3_f) bind(c)
    integer i,j,k
  ...
  subroutine forcing(x1,x2,x3,t,f1,f2,f3) bind(c)
    implicit none
  ...
  subroutine forcing_tt(x1,x2,x3,t,f1tt,f2tt,f3tt) bind(c)
    implicit none
    real(dp),value,intent(in) :: t
    real(dp) :: x1, x2, x3, f1tt, f2tt, f3tt
    real(dp) :: d1u1, d2u1, d3u1, d1u2, d2u2, d3u2, d1u3, d2u3, d3u3
    real(dp) :: d1d1u1, d2d2u1, d3d3u1, d1d1u2, d2d2u2, d3d3u2, d1d1u3, d2d2u3, d3d3u3
    real(dp) :: d1d2u1, d1d3u1, d2d3u1, d1d2u2, d1d3u2, d2d3u2, d1d2u3, d1d3u3, d2d3u3
    real(dp) :: d2d1u1, d3d1u1, d3d2u1, d2d1u2, d3d1u2, d3d2u2, d2d1u3, d3d1u3, d3d2u3
