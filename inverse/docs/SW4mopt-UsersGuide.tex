...
\begin{figure}
\begin{center}
\includegraphics[width=0.3\linewidth]{\figdir/winfcn.png}
\end{center}
...
but the multiplier will affect the maximum step length, and is currently needed to sometimes 
reduce the allowed step size. This is a temporary measure that should be removed, once the 
line search algorithm has been improved.
