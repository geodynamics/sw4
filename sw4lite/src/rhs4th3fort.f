...
c from inner_loop_4a, 14x3 = 42 ops.
...
*** Mixed derivatives:
*** 27 ops/mixed derivative, 27*4=108 ops
***   (la*v_y)_x
...
*** 9 ops
         ...
         enddo
      enddo
*** Total op count away from boundaries, 
***  42 ops, set up var coeff intermediate vars.
***  3x58 = 174 ops, xx,yy,zz derivatives
***  3*108 = 324 ops, mixed derivatives
***   9 ops update result variable
**** Sum: 42+174+324+9=549 ops
*** Memory access, a 5^3 cube around each grid point,
*** for variables mu,la, u(1,:),u(2,:),u(3,:) and update uacc  
*** Arrays element access : 125 *5 + 3 read
***                           3 write
*** (double precision variables) 628 read variables = 5024 bytes
***                               3  write variables = 24 bytes
*** This means 549 ops/5024 bytes =0.1 at each point.
*** 
