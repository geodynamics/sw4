...
#ifndef MATERIALUCVM_FILE
#define MATERIALUCVM_FILE
...
class MaterialUCVM : public MaterialData
{
  public:
    
    MaterialUCVM( EW * a_ew, const std::string file, const std::string directory);
