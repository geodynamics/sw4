...
using DEFAULT_LOOP2X_ASYNC_OLDE =
    RAJA::KernelPolicy<RAJA::statement::HipKernelAsync<RAJA::statement::For<
        1, RAJA::hip_block_x_loop,
        RAJA::statement::For<0, RAJA::hip_thread_x_loop,
                             RAJA::statement::Lambda<0>>>>>;

using DEFAULT_LOOP2X_ASYNC = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    256, RAJA::statement::Tile<
             0, RAJA::tile_fixed<16>, RAJA::hip_block_y_loop,
             RAJA::statement::Tile<
                 1, RAJA::tile_fixed<16>, RAJA::hip_block_x_loop,
                 RAJA::statement::For<
...
using SARRAY_LOOP_POL2 =
    RAJA::KernelPolicy<RAJA::statement::HipKernel<RAJA::statement::Tile<
        0, RAJA::tile_fixed<1>, RAJA::hip_block_y_loop,
        RAJA::statement::Tile<
            1, RAJA::tile_fixed<1>, RAJA::hip_block_x_loop,
            RAJA::statement::Tile<
                2, RAJA::tile_fixed<1024>, RAJA::hip_block_z_loop,
                RAJA::statement::For<
                    0, RAJA::hip_thread_y_direct,
                    RAJA::statement::For<
...
using ICSTRESS_EXEC_POL = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    256, RAJA::statement::Tile<
             0, RAJA::tile_fixed<16>, RAJA::hip_block_x_loop,
             RAJA::statement::Tile<
...
using RHS4_EXEC_POL = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    ...
    RAJA::statement::Tile<
        ...
        RAJA::statement::Tile<
            ...
            RAJA::statement::Tile<
                2, RAJA::tile_fixed<2>, RAJA::hip_block_z_loop,
                RAJA::statement::For<
                    0, RAJA::hip_thread_y_direct,
                    RAJA::statement::For<
                        1, RAJA::hip_thread_x_direct,
...
using RHS4_EXEC_POL_ASYNC_OLDE =
    RAJA::KernelPolicy<RAJA::statement::HipKernelAsync<RAJA::statement::Tile<
        0, RAJA::tile_fixed<4>, RAJA::hip_block_y_loop,
        RAJA::statement::Tile<
            1, RAJA::tile_fixed<4>, RAJA::hip_block_x_loop,
            RAJA::statement::Tile<
                2, RAJA::tile_fixed<16>, RAJA::hip_block_z_loop,
                RAJA::statement::For<
...
using CONSSW4_TYPEP_EXEC_POL1 = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    256, RAJA::statement::Tile<
             0, RAJA::tile_fixed<16>, RAJA::hip_block_y_loop,
             RAJA::statement::Tile<
                 1, RAJA::tile_fixed<16>, RAJA::hip_block_x_loop,
...
using EBFA_POL = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    256, RAJA::statement::Tile<
             0, RAJA::tile_fixed<16>, RAJA::hip_block_x_loop,
             RAJA::statement::Tile<
                 1, RAJA::tile_fixed<16>, RAJA::hip_block_y_loop,
...
using INJ_POL_ASYNC = RAJA::KernelPolicy<RAJA::statement::HipKernelFixedAsync<
    256,
    RAJA::statement::Tile<
        0, RAJA::tile_fixed<4>, RAJA::hip_block_z_loop,
        RAJA::statement::Tile<
            1, RAJA::tile_fixed<8>, RAJA::hip_block_y_loop,
            RAJA::statement::Tile<
                2, RAJA::tile_fixed<8>, RAJA::hip_block_x_loop,
                RAJA::statement::For<
                    0, RAJA::hip_thread_z_direct,
                    RAJA::statement::For<
                        1, RAJA::hip_thread_y_direct,
...
// TestEcons::get_ubnd(
using TGU_POL_ASYNC = RAJA::KernelPolicy<RAJA::statement::HipKernelFixedAsync<
    1024,
    RAJA::statement::Tile<
        0, RAJA::tile_fixed<4>, RAJA::hip_block_z_loop,
        RAJA::statement::Tile<
...
using AMVPCa_POL = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    256,
    RAJA::statement::Tile<
        0, RAJA::tile_fixed<4>, RAJA::hip_block_y_loop,
        RAJA::statement::Tile<
...
using AMVPCu_POL = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    256,
    RAJA::statement::Tile<
        0, RAJA::tile_fixed<4>, RAJA::hip_block_y_loop,
        RAJA::statement::Tile<
...
using AMVC2Cu_POL = RAJA::KernelPolicy<RAJA::statement::HipKernelFixed<
    256,
    RAJA::statement::Tile<
        0, RAJA::tile_fixed<4>, RAJA::hip_block_y_loop,
        RAJA::statement::Tile<
...
using AFCC_POL_ASYNC = RAJA::KernelPolicy<RAJA::statement::HipKernelFixedAsync<
    256, RAJA::statement::Tile<
             0, RAJA::tile_fixed<16>, RAJA::hip_block_x_loop,
             RAJA::statement::Tile<
                 1, RAJA::tile_fixed<16>, RAJA::hip_block_y_loop,
