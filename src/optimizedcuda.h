...
__launch_bounds__(BX* BY) __global__
  ...
  if (j - 2 <= jlast + 2) {
    if (i - 2 >= 0 && i - 2 < ni) loader = 1;
    if (threadIdx.x < 4 && i + BX - 2 < ni) loadx2 = 1;
    if (threadIdx.y < 4 && j + BY - 2 <= jlast + 2) loady2 = 1;
  }
  ...
  for (int k = kfirst; k <= klast; k++) {
    ...
    if (active) {
      ...
      // X contribution
      {
        ...
        mux2 = mu_im2 * strx_im2 + mu_ip1 * strx_ip1 +
               3 * (mu_ijk * strx_i + mu_im1 * strx_im1);
        mux3 = mu_im1 * strx_im1 + mu_ip2 * strx_ip2 +
               3 * (mu_ip1 * strx_ip1 + mu_ijk * strx_i);
        mux4 = mu_ip1 * strx_ip1 - tf * (mu_ijk * strx_i + mu_ip2 * strx_ip2);

        r1 = strx_i * ((2 * mux1 + la_im1 * strx_im1 -
                        tf * (la_ijk * strx_i + la_im2 * strx_im2)) *
                           (shu[0][kthm2][tj + 0][ti - 2] -
                            shu[0][kthm2][tj + 0][ti + 0]) +
                       (2 * mux2 + la_im2 * strx_im2 + la_ip1 * strx_ip1 +
                        3 * (la_ijk * strx_i + la_im1 * strx_im1)) *
                           (shu[0][kthm2][tj + 0][ti - 1] -
                            shu[0][kthm2][tj + 0][ti + 0]) +
                       (2 * mux3 + la_im1 * strx_im1 + la_ip2 * strx_ip2 +
                        3 * (la_ip1 * strx_ip1 + la_ijk * strx_i)) *
                           (shu[0][kthm2][tj + 0][ti + 1] -
                            shu[0][kthm2][tj + 0][ti + 0]) +
                       (2 * mux4 + la_ip1 * strx_ip1 -
                        tf * (la_ijk * strx_i + la_ip2 * strx_ip2)) *
                           (shu[0][kthm2][tj + 0][ti + 2] -
                            shu[0][kthm2][tj + 0][ti + 0]));
        r2 = strx_i * (mux1 * (shu[1][kthm2][tj + 0][ti - 2] -
                               shu[1][kthm2][tj + 0][ti + 0]) +
                       mux2 * (shu[1][kthm2][tj + 0][ti - 1] -
                               shu[1][kthm2][tj + 0][ti + 0]) +
                       mux3 * (shu[1][kthm2][tj + 0][ti + 1] -
                               shu[1][kthm2][tj + 0][ti + 0]) +
                       mux4 * (shu[1][kthm2][tj + 0][ti + 2] -
                               shu[1][kthm2][tj + 0][ti + 0]));
        r3 = strx_i * (mux1 * (shu[2][kthm2][tj + 0][ti - 2] -
                               shu[2][kthm2][tj + 0][ti + 0]) +
                       mux2 * (shu[2][kthm2][tj + 0][ti - 1] -
                               shu[2][kthm2][tj + 0][ti + 0]) +
                       mux3 * (shu[2][kthm2][tj + 0][ti + 1] -
                               shu[2][kthm2][tj + 0][ti + 0]) +
                       mux4 * (shu[2][kthm2][tj + 0][ti + 2] -
                               shu[2][kthm2][tj + 0][ti + 0]));
      }
      // Y contribution
      {
        ...
        muy2 = mu_jm2 * stry_jm2 + mu_jp1 * stry_jp1 +
               3 * (mu_ijk * stry_j + mu_jm1 * stry_jm1);
        muy3 = mu_jm1 * stry_jm1 + mu_jp2 * stry_jp2 +
               3 * (mu_jp1 * stry_jp1 + mu_ijk * stry_j);
        muy4 = mu_jp1 * stry_jp1 - tf * (mu_ijk * stry_j + mu_jp2 * stry_jp2);

        r1 += stry_j * (muy1 * (shu[0][kthm2][tj - 2][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]) +
                        muy2 * (shu[0][kthm2][tj - 1][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]) +
                        muy3 * (shu[0][kthm2][tj + 1][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]) +
                        muy4 * (shu[0][kthm2][tj + 2][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]));
        r2 += stry_j * ((2 * muy1 + la_jm1 * stry_jm1 -
                         tf * (la_ijk * stry_j + la_jm2 * stry_jm2)) *
                            (shu[1][kthm2][tj - 2][ti + 0] -
                             shu[1][kthm2][tj + 0][ti + 0]) +
                        (2 * muy2 + la_jm2 * stry_jm2 + la_jp1 * stry_jp1 +
                         3 * (la_ijk * stry_j + la_jm1 * stry_jm1)) *
                            (shu[1][kthm2][tj - 1][ti + 0] -
                             shu[1][kthm2][tj + 0][ti + 0]) +
                        (2 * muy3 + la_jm1 * stry_jm1 + la_jp2 * stry_jp2 +
                         3 * (la_jp1 * stry_jp1 + la_ijk * stry_j)) *
                            (shu[1][kthm2][tj + 1][ti + 0] -
                             shu[1][kthm2][tj + 0][ti + 0]) +
                        (2 * muy4 + la_jp1 * stry_jp1 -
                         tf * (la_ijk * stry_j + la_jp2 * stry_jp2)) *
                            (shu[1][kthm2][tj + 2][ti + 0] -
                             shu[1][kthm2][tj + 0][ti + 0]));
        r3 += stry_j * (muy1 * (shu[2][kthm2][tj - 2][ti + 0] -
                                shu[2][kthm2][tj + 0][ti + 0]) +
                        muy2 * (shu[2][kthm2][tj - 1][ti + 0] -
                                shu[2][kthm2][tj + 0][ti + 0]) +
                        muy3 * (shu[2][kthm2][tj + 1][ti + 0] -
                                shu[2][kthm2][tj + 0][ti + 0]) +
                        muy4 * (shu[2][kthm2][tj + 2][ti + 0] -
                                shu[2][kthm2][tj + 0][ti + 0]));
      }
      // Z contribution
      {
        ...
        muz2 = mu_km2 * strz_km2 + mu_kp1 * strz_kp1 +
               3 * (mu_ijk * strz_k + mu_km1 * strz_km1);
        muz3 = mu_km1 * strz_km1 + mu_kp2 * strz_kp2 +
               3 * (mu_kp1 * strz_kp1 + mu_ijk * strz_k);
        muz4 = mu_kp1 * strz_kp1 - tf * (mu_ijk * strz_k + mu_kp2 * strz_kp2);
        r1 += strz_k * (muz1 * (shu[0][kthm4][tj + 0][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]) +
                        muz2 * (shu[0][kthm3][tj + 0][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]) +
                        muz3 * (shu[0][kthm1][tj + 0][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]) +
                        muz4 * (shu[0][kthm0][tj + 0][ti + 0] -
                                shu[0][kthm2][tj + 0][ti + 0]));
        r2 += strz_k * (muz1 * (shu[1][kthm4][tj + 0][ti + 0] -
                                shu[1][kthm2][tj + 0][ti + 0]) +
                        muz2 * (shu[1][kthm3][tj + 0][ti + 0] -
                                shu[1][kthm2][tj + 0][ti + 0]) +
                        muz3 * (shu[1][kthm1][tj + 0][ti + 0] -
                                shu[1][kthm2][tj + 0][ti + 0]) +
                        muz4 * (shu[1][kthm0][tj + 0][ti + 0] -
                                shu[1][kthm2][tj + 0][ti + 0]));
        r3 += strz_k * ((2 * muz1 + la_km1 * strz_km1 -
                         tf * (la_ijk * strz_k + la_km2 * strz_km2)) *
                            (shu[2][kthm4][tj + 0][ti + 0] -
                             shu[2][kthm2][tj + 0][ti + 0]) +
                        (2 * muz2 + la_km2 * strz_km2 + la_kp1 * strz_kp1 +
                         3 * (la_ijk * strz_k + la_km1 * strz_km1)) *
                            (shu[2][kthm3][tj + 0][ti + 0] -
                             shu[2][kthm2][tj + 0][ti + 0]) +
                        (2 * muz3 + la_km1 * strz_km1 + la_kp2 * strz_kp2 +
                         3 * (la_kp1 * strz_kp1 + la_ijk * strz_k)) *
                            (shu[2][kthm1][tj + 0][ti + 0] -
                             shu[2][kthm2][tj + 0][ti + 0]) +
                        (2 * muz4 + la_kp1 * strz_kp1 -
                         tf * (la_ijk * strz_k + la_kp2 * strz_kp2)) *
                            (shu[2][kthm0][tj + 0][ti + 0] -
                             shu[2][kthm2][tj + 0][ti + 0]));
      }
      r1 *= i6;
      r2 *= i6;
      ...
      r1 += strx_i * stry_j * i144 *
                (la_im2 * (shu[1][kthm2][tj - 2][ti - 2] -
                           shu[1][kthm2][tj + 2][ti - 2] +
                           8 * (-shu[1][kthm2][tj - 1][ti - 2] +
                                shu[1][kthm2][tj + 1][ti - 2])) -
                 8 * (la_im1 * (shu[1][kthm2][tj - 2][ti - 1] -
                                shu[1][kthm2][tj + 2][ti - 1] +
                                8 * (-shu[1][kthm2][tj - 1][ti - 1] +
                                     shu[1][kthm2][tj + 1][ti - 1]))) +
                 8 * (la_ip1 * (shu[1][kthm2][tj - 2][ti + 1] -
                                shu[1][kthm2][tj + 2][ti + 1] +
                                8 * (-shu[1][kthm2][tj - 1][ti + 1] +
                                     shu[1][kthm2][tj + 1][ti + 1]))) -
                 (la_ip2 * (shu[1][kthm2][tj - 2][ti + 2] -
                            shu[1][kthm2][tj + 2][ti + 2] +
                            8 * (-shu[1][kthm2][tj - 1][ti + 2] +
                                 shu[1][kthm2][tj + 1][ti + 2]))))
            /*   (la*w_z)_x */
            + strx_i * strz_k * i144 *
                  (la_im2 * (shu[2][kthm4][tj + 0][ti - 2] -
                             shu[2][kthm0][tj + 0][ti - 2] +
                             8 * (-shu[2][kthm3][tj + 0][ti - 2] +
                                  shu[2][kthm1][tj + 0][ti - 2])) -
                   8 * (la_im1 * (shu[2][kthm4][tj + 0][ti - 1] -
                                  shu[2][kthm0][tj + 0][ti - 1] +
                                  8 * (-shu[2][kthm3][tj + 0][ti - 1] +
                                       shu[2][kthm1][tj + 0][ti - 1]))) +
                   8 * (la_ip1 * (shu[2][kthm4][tj + 0][ti + 1] -
                                  shu[2][kthm0][tj + 0][ti + 1] +
                                  8 * (-shu[2][kthm3][tj + 0][ti + 1] +
                                       shu[2][kthm1][tj + 0][ti + 1]))) -
                   (la_ip2 * (shu[2][kthm4][tj + 0][ti + 2] -
                              shu[2][kthm0][tj + 0][ti + 2] +
                              8 * (-shu[2][kthm3][tj + 0][ti + 2] +
                                   shu[2][kthm1][tj + 0][ti + 2]))))
            /*   (mu*v_x)_y */
            + strx_i * stry_j * i144 *
                  (mu_jm2 * (shu[1][kthm2][tj - 2][ti - 2] -
                             shu[1][kthm2][tj - 2][ti + 2] +
                             8 * (-shu[1][kthm2][tj - 2][ti - 1] +
                                  shu[1][kthm2][tj - 2][ti + 1])) -
                   8 * (mu_jm1 * (shu[1][kthm2][tj - 1][ti - 2] -
                                  shu[1][kthm2][tj - 1][ti + 2] +
                                  8 * (-shu[1][kthm2][tj - 1][ti - 1] +
                                       shu[1][kthm2][tj - 1][ti + 1]))) +
                   8 * (mu_jp1 * (shu[1][kthm2][tj + 1][ti - 2] -
                                  shu[1][kthm2][tj + 1][ti + 2] +
                                  8 * (-shu[1][kthm2][tj + 1][ti - 1] +
                                       shu[1][kthm2][tj + 1][ti + 1]))) -
                   (mu_jp2 * (shu[1][kthm2][tj + 2][ti - 2] -
                              shu[1][kthm2][tj + 2][ti + 2] +
                              8 * (-shu[1][kthm2][tj + 2][ti - 1] +
                                   shu[1][kthm2][tj + 2][ti + 1]))))
            /*   (mu*w_x)_z */
            + strx_i * strz_k * i144 *
                  (mu_km2 * (shu[2][kthm4][tj + 0][ti - 2] -
                             shu[2][kthm4][tj + 0][ti + 2] +
                             8 * (-shu[2][kthm4][tj + 0][ti - 1] +
                                  shu[2][kthm4][tj + 0][ti + 1])) -
                   8 * (mu_km1 * (shu[2][kthm3][tj + 0][ti - 2] -
                                  shu[2][kthm3][tj + 0][ti + 2] +
                                  8 * (-shu[2][kthm3][tj + 0][ti - 1] +
                                       shu[2][kthm3][tj + 0][ti + 1]))) +
                   8 * (mu_kp1 * (shu[2][kthm1][tj + 0][ti - 2] -
                                  shu[2][kthm1][tj + 0][ti + 2] +
                                  8 * (-shu[2][kthm1][tj + 0][ti - 1] +
                                       shu[2][kthm1][tj + 0][ti + 1]))) -
                   (mu_kp2 * (shu[2][kthm0][tj + 0][ti - 2] -
                              shu[2][kthm0][tj + 0][ti + 2] +
                              8 * (-shu[2][kthm0][tj + 0][ti - 1] +
                                   shu[2][kthm0][tj + 0][ti + 1]))));

      /*   (mu*u_y)_x */
      r2 += strx_i * stry_j * i144 *
                (mu_im2 * (shu[0][kthm2][tj - 2][ti - 2] -
                           shu[0][kthm2][tj + 2][ti - 2] +
                           8 * (-shu[0][kthm2][tj - 1][ti - 2] +
                                shu[0][kthm2][tj + 1][ti - 2])) -
                 8 * (mu_im1 * (shu[0][kthm2][tj - 2][ti - 1] -
                                shu[0][kthm2][tj + 2][ti - 1] +
                                8 * (-shu[0][kthm2][tj - 1][ti - 1] +
                                     shu[0][kthm2][tj + 1][ti - 1]))) +
                 8 * (mu_ip1 * (shu[0][kthm2][tj - 2][ti + 1] -
                                shu[0][kthm2][tj + 2][ti + 1] +
                                8 * (-shu[0][kthm2][tj - 1][ti + 1] +
                                     shu[0][kthm2][tj + 1][ti + 1]))) -
                 (mu_ip2 * (shu[0][kthm2][tj - 2][ti + 2] -
                            shu[0][kthm2][tj + 2][ti + 2] +
                            8 * (-shu[0][kthm2][tj - 1][ti + 2] +
                                 shu[0][kthm2][tj + 1][ti + 2]))))
            /* (la*u_x)_y */
            + strx_i * stry_j * i144 *
                  (la_jm2 * (shu[0][kthm2][tj - 2][ti - 2] -
                             shu[0][kthm2][tj - 2][ti + 2] +
                             8 * (-shu[0][kthm2][tj - 2][ti - 1] +
                                  shu[0][kthm2][tj - 2][ti + 1])) -
                   8 * (la_jm1 * (shu[0][kthm2][tj - 1][ti - 2] -
                                  shu[0][kthm2][tj - 1][ti + 2] +
                                  8 * (-shu[0][kthm2][tj - 1][ti - 1] +
                                       shu[0][kthm2][tj - 1][ti + 1]))) +
                   8 * (la_jp1 * (shu[0][kthm2][tj + 1][ti - 2] -
                                  shu[0][kthm2][tj + 1][ti + 2] +
                                  8 * (-shu[0][kthm2][tj + 1][ti - 1] +
                                       shu[0][kthm2][tj + 1][ti + 1]))) -
                   (la_jp2 * (shu[0][kthm2][tj + 2][ti - 2] -
                              shu[0][kthm2][tj + 2][ti + 2] +
                              8 * (-shu[0][kthm2][tj + 2][ti - 1] +
                                   shu[0][kthm2][tj + 2][ti + 1]))))
            /* (la*w_z)_y */
            + stry_j * strz_k * i144 *
                  (la_jm2 * (shu[2][kthm4][tj - 2][ti + 0] -
                             shu[2][kthm0][tj - 2][ti + 0] +
                             8 * (-shu[2][kthm3][tj - 2][ti + 0] +
                                  shu[2][kthm1][tj - 2][ti + 0])) -
                   8 * (la_jm1 * (shu[2][kthm4][tj - 1][ti + 0] -
                                  shu[2][kthm0][tj - 1][ti + 0] +
                                  8 * (-shu[2][kthm3][tj - 1][ti + 0] +
                                       shu[2][kthm1][tj - 1][ti + 0]))) +
                   8 * (la_jp1 * (shu[2][kthm4][tj + 1][ti + 0] -
                                  shu[2][kthm0][tj + 1][ti + 0] +
                                  8 * (-shu[2][kthm3][tj + 1][ti + 0] +
                                       shu[2][kthm1][tj + 1][ti + 0]))) -
                   (la_jp2 * (shu[2][kthm4][tj + 2][ti + 0] -
                              shu[2][kthm0][tj + 2][ti + 0] +
                              8 * (-shu[2][kthm3][tj + 2][ti + 0] +
                                   shu[2][kthm1][tj + 2][ti + 0]))))
            /* (mu*w_y)_z */
            + stry_j * strz_k * i144 *
                  (mu_km2 * (shu[2][kthm4][tj - 2][ti + 0] -
                             shu[2][kthm4][tj + 2][ti + 0] +
                             8 * (-shu[2][kthm4][tj - 1][ti + 0] +
                                  shu[2][kthm4][tj + 1][ti + 0])) -
                   8 * (mu_km1 * (shu[2][kthm3][tj - 2][ti + 0] -
                                  shu[2][kthm3][tj + 2][ti + 0] +
                                  8 * (-shu[2][kthm3][tj - 1][ti + 0] +
                                       shu[2][kthm3][tj + 1][ti + 0]))) +
                   8 * (mu_kp1 * (shu[2][kthm1][tj - 2][ti + 0] -
                                  shu[2][kthm1][tj + 2][ti + 0] +
                                  8 * (-shu[2][kthm1][tj - 1][ti + 0] +
                                       shu[2][kthm1][tj + 1][ti + 0]))) -
                   (mu_kp2 * (shu[2][kthm0][tj - 2][ti + 0] -
                              shu[2][kthm0][tj + 2][ti + 0] +
                              8 * (-shu[2][kthm0][tj - 1][ti + 0] +
                                   shu[2][kthm0][tj + 1][ti + 0]))));

      /*  (mu*u_z)_x */
      r3 += strx_i * strz_k * i144 *
                (mu_im2 * (shu[0][kthm4][tj + 0][ti - 2] -
                           shu[0][kthm0][tj + 0][ti - 2] +
                           8 * (-shu[0][kthm3][tj + 0][ti - 2] +
                                shu[0][kthm1][tj + 0][ti - 2])) -
                 8 * (mu_im1 * (shu[0][kthm4][tj + 0][ti - 1] -
                                shu[0][kthm0][tj + 0][ti - 1] +
                                8 * (-shu[0][kthm3][tj + 0][ti - 1] +
                                     shu[0][kthm1][tj + 0][ti - 1]))) +
                 8 * (mu_ip1 * (shu[0][kthm4][tj + 0][ti + 1] -
                                shu[0][kthm0][tj + 0][ti + 1] +
                                8 * (-shu[0][kthm3][tj + 0][ti + 1] +
                                     shu[0][kthm1][tj + 0][ti + 1]))) -
                 (mu_ip2 * (shu[0][kthm4][tj + 0][ti + 2] -
                            shu[0][kthm0][tj + 0][ti + 2] +
                            8 * (-shu[0][kthm3][tj + 0][ti + 2] +
                                 shu[0][kthm1][tj + 0][ti + 2]))))
            /* (mu*v_z)_y */
            + stry_j * strz_k * i144 *
                  (mu_jm2 * (shu[1][kthm4][tj - 2][ti + 0] -
                             shu[1][kthm0][tj - 2][ti + 0] +
                             8 * (-shu[1][kthm3][tj - 2][ti + 0] +
                                  shu[1][kthm1][tj - 2][ti + 0])) -
                   8 * (mu_jm1 * (shu[1][kthm4][tj - 1][ti + 0] -
                                  shu[1][kthm0][tj - 1][ti + 0] +
                                  8 * (-shu[1][kthm3][tj - 1][ti + 0] +
                                       shu[1][kthm1][tj - 1][ti + 0]))) +
                   8 * (mu_jp1 * (shu[1][kthm4][tj + 1][ti + 0] -
                                  shu[1][kthm0][tj + 1][ti + 0] +
                                  8 * (-shu[1][kthm3][tj + 1][ti + 0] +
                                       shu[1][kthm1][tj + 1][ti + 0]))) -
                   (mu_jp2 * (shu[1][kthm4][tj + 2][ti + 0] -
                              shu[1][kthm0][tj + 2][ti + 0] +
                              8 * (-shu[1][kthm3][tj + 2][ti + 0] +
                                   shu[1][kthm1][tj + 2][ti + 0]))))
            /*   (la*u_x)_z */
            + strx_i * strz_k * i144 *
                  (la_km2 * (shu[0][kthm4][tj + 0][ti - 2] -
                             shu[0][kthm4][tj + 0][ti + 2] +
                             8 * (-shu[0][kthm4][tj + 0][ti - 1] +
                                  shu[0][kthm4][tj + 0][ti + 1])) -
                   8 * (la_km1 * (shu[0][kthm3][tj + 0][ti - 2] -
                                  shu[0][kthm3][tj + 0][ti + 2] +
                                  8 * (-shu[0][kthm3][tj + 0][ti - 1] +
                                       shu[0][kthm3][tj + 0][ti + 1]))) +
                   8 * (la_kp1 * (shu[0][kthm1][tj + 0][ti - 2] -
                                  shu[0][kthm1][tj + 0][ti + 2] +
                                  8 * (-shu[0][kthm1][tj + 0][ti - 1] +
                                       shu[0][kthm1][tj + 0][ti + 1]))) -
                   (la_kp2 * (shu[0][kthm0][tj + 0][ti - 2] -
                              shu[0][kthm0][tj + 0][ti + 2] +
                              8 * (-shu[0][kthm0][tj + 0][ti - 1] +
                                   shu[0][kthm0][tj + 0][ti + 1]))))
            /* (la*v_y)_z */
            + stry_j * strz_k * i144 *
                  (la_km2 * (shu[1][kthm4][tj - 2][ti + 0] -
                             shu[1][kthm4][tj + 2][ti + 0] +
                             8 * (-shu[1][kthm4][tj - 1][ti + 0] +
                                  shu[1][kthm4][tj + 1][ti + 0])) -
                   8 * (la_km1 * (shu[1][kthm3][tj - 2][ti + 0] -
                                  shu[1][kthm3][tj + 2][ti + 0] +
                                  8 * (-shu[1][kthm3][tj - 1][ti + 0] +
                                       shu[1][kthm3][tj + 1][ti + 0]))) +
                   8 * (la_kp1 * (shu[1][kthm1][tj - 2][ti + 0] -
                                  shu[1][kthm1][tj + 2][ti + 0] +
                                  8 * (-shu[1][kthm1][tj - 1][ti + 0] +
                                       shu[1][kthm1][tj + 1][ti + 0]))) -
                   (la_kp2 * (shu[1][kthm0][tj - 2][ti + 0] -
                              shu[1][kthm0][tj + 2][ti + 0] +
                              8 * (-shu[1][kthm0][tj - 1][ti + 0] +
                                   shu[1][kthm0][tj + 1][ti + 0]))));
      ...
      if (pred) {
        ...
        // + fo1); up(2,idx) = 2 * shu[2][kthm2][tj][ti] - um2 + fact * (cof *
        // r3 + fo2);
      } else {
