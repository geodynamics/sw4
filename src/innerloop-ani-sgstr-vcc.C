          ...
          for (sw4_type i = ifirst + 2; i <= ilast - 2; i++) {
            ...
            r3 = r3 + i6 * strx(i) *
                          (cm2 * (u(1, i - 2, j, k) - u(1, i, j, k)) +
                           ...
                           cp1 * (u(1, i + 1, j, k) - u(1, i, j, k)) +
                           cp2 * (u(1, i + 2, j, k) - u(1, i, j, k)));
            cm2 = c(7, i - 1, j, k) * strx(i - 1) -
                  0.75 * (c(7, i, j, k) * strx(i) +
                          c(7, i - 2, j, k) * strx(i - 2));
            cm1 =
                c(7, i - 2, j, k) * strx(i - 2) +
                c(7, i + 1, j, k) * strx(i + 1) +
                3 * (c(7, i, j, k) * strx(i) + c(7, i - 1, j, k) * strx(i - 1));
            cp1 =
                c(7, i - 1, j, k) * strx(i - 1) +
                c(7, i + 2, j, k) * strx(i + 2) +
                3 * (c(7, i, j, k) * strx(i) + c(7, i + 1, j, k) * strx(i + 1));
            cp2 = c(7, i + 1, j, k) * strx(i + 1) -
                  0.75 * (c(7, i, j, k) * strx(i) +
                          c(7, i + 2, j, k) * strx(i + 2));
            ...
            r2 = r2 + i6 * strx(i) *
                          (cm2 * (u(2, i - 2, j, k) - u(2, i, j, k)) +
                           ...
                           cp1 * (u(2, i + 1, j, k) - u(2, i, j, k)) +
                           cp2 * (u(2, i + 2, j, k) - u(2, i, j, k)));
            cm2 = c(8, i - 1, j, k) * strx(i - 1) -
                  0.75 * (c(8, i, j, k) * strx(i) +
                          c(8, i - 2, j, k) * strx(i - 2));
            cm1 =
                c(8, i - 2, j, k) * strx(i - 2) +
                c(8, i + 1, j, k) * strx(i + 1) +
                3 * (c(8, i, j, k) * strx(i) + c(8, i - 1, j, k) * strx(i - 1));
            cp1 =
                c(8, i - 1, j, k) * strx(i - 1) +
                c(8, i + 2, j, k) * strx(i + 2) +
                3 * (c(8, i, j, k) * strx(i) + c(8, i + 1, j, k) * strx(i + 1));
            cp2 = c(8, i + 1, j, k) * strx(i + 1) -
                  0.75 * (c(8, i, j, k) * strx(i) +
                          c(8, i + 2, j, k) * strx(i + 2));
            ...
            r3 = r3 + i6 * strx(i) *
                          (cm2 * (u(2, i - 2, j, k) - u(2, i, j, k)) +
                           ...
                           cp1 * (u(2, i + 1, j, k) - u(2, i, j, k)) +
                           cp2 * (u(2, i + 2, j, k) - u(2, i, j, k)));
            cm2 = c(12, i - 1, j, k) * strx(i - 1) -
                  0.75 * (c(12, i, j, k) * strx(i) +
                          c(12, i - 2, j, k) * strx(i - 2));
            cm1 = c(12, i - 2, j, k) * strx(i - 2) +
                  c(12, i + 1, j, k) * strx(i + 1) +
                  3 * (c(12, i, j, k) * strx(i) +
                       c(12, i - 1, j, k) * strx(i - 1));
            cp1 = c(12, i - 1, j, k) * strx(i - 1) +
                  c(12, i + 2, j, k) * strx(i + 2) +
                  3 * (c(12, i, j, k) * strx(i) +
                       c(12, i + 1, j, k) * strx(i + 1));
            cp2 = c(12, i + 1, j, k) * strx(i + 1) -
                  0.75 * (c(12, i, j, k) * strx(i) +
                          c(12, i + 2, j, k) * strx(i + 2));
            ...
            r3 = r3 + i6 * stry(j) *
                          (cm2 * (u(1, i, j - 2, k) - u(1, i, j, k)) +
                           ...
                           cp1 * (u(1, i, j + 1, k) - u(1, i, j, k)) +
                           cp2 * (u(1, i, j + 2, k) - u(1, i, j, k)));
            cm2 = c(16, i, j - 1, k) * stry(j - 1) -
                  0.75 * (c(16, i, j, k) * stry(j) +
                          c(16, i, j - 2, k) * stry(j - 2));
            cm1 = c(16, i, j - 2, k) * stry(j - 2) +
                  c(16, i, j + 1, k) * stry(j + 1) +
                  3 * (c(16, i, j, k) * stry(j) +
                       c(16, i, j - 1, k) * stry(j - 1));
            cp1 = c(16, i, j - 1, k) * stry(j - 1) +
                  c(16, i, j + 2, k) * stry(j + 2) +
                  3 * (c(16, i, j, k) * stry(j) +
                       c(16, i, j + 1, k) * stry(j + 1));
            cp2 = c(16, i, j + 1, k) * stry(j + 1) -
                  0.75 * (c(16, i, j, k) * stry(j) +
                          c(16, i, j + 2, k) * stry(j + 2));
            ...
            r2 = r2 + i6 * stry(j) *
                          (cm2 * (u(2, i, j - 2, k) - u(2, i, j, k)) +
                           ...
                           cp1 * (u(2, i, j + 1, k) - u(2, i, j, k)) +
                           cp2 * (u(2, i, j + 2, k) - u(2, i, j, k)));
            cm2 = c(17, i, j - 1, k) * stry(j - 1) -
                  0.75 * (c(17, i, j, k) * stry(j) +
                          c(17, i, j - 2, k) * stry(j - 2));
            cm1 = c(17, i, j - 2, k) * stry(j - 2) +
                  c(17, i, j + 1, k) * stry(j + 1) +
                  3 * (c(17, i, j, k) * stry(j) +
                       c(17, i, j - 1, k) * stry(j - 1));
            cp1 = c(17, i, j - 1, k) * stry(j - 1) +
                  c(17, i, j + 2, k) * stry(j + 2) +
                  3 * (c(17, i, j, k) * stry(j) +
                       c(17, i, j + 1, k) * stry(j + 1));
            cp2 = c(17, i, j + 1, k) * stry(j + 1) -
                  0.75 * (c(17, i, j, k) * stry(j) +
                          c(17, i, j + 2, k) * stry(j + 2));
            ...
            r3 = r3 + i6 * stry(j) *
                          (cm2 * (u(2, i, j - 2, k) - u(2, i, j, k)) +
                           ...
                           cp1 * (u(2, i, j + 1, k) - u(2, i, j, k)) +
                           cp2 * (u(2, i, j + 2, k) - u(2, i, j, k)));
            cm2 = c(19, i, j - 1, k) * stry(j - 1) -
                  0.75 * (c(19, i, j, k) * stry(j) +
                          c(19, i, j - 2, k) * stry(j - 2));
            cm1 = c(19, i, j - 2, k) * stry(j - 2) +
                  c(19, i, j + 1, k) * stry(j + 1) +
                  3 * (c(19, i, j, k) * stry(j) +
                       c(19, i, j - 1, k) * stry(j - 1));
            cp1 = c(19, i, j - 1, k) * stry(j - 1) +
                  c(19, i, j + 2, k) * stry(j + 2) +
                  3 * (c(19, i, j, k) * stry(j) +
                       c(19, i, j + 1, k) * stry(j + 1));
            cp2 = c(19, i, j + 1, k) * stry(j + 1) -
                  0.75 * (c(19, i, j, k) * stry(j) +
                          c(19, i, j + 2, k) * stry(j + 2));
            ...
            r2 = r2 + stry(j) * strx(i) *
                          (a1 * (c(9, i + 1, j, k) * dup1 -
                           ...
                           a2 * (c(9, i + 2, j, k) * dup2 -
                                 c(9, i - 2, j, k) * dum2));
            r3 = r3 + stry(j) * strx(i) *
                          (a1 * (c(10, i + 1, j, k) * dup1 -
                                 c(10, i - 1, j, k) * dum1) +
                           a2 * (c(10, i + 2, j, k) * dup2 -
                                 c(10, i - 2, j, k) * dum2));
            ...
            r1 = r1 + stry(j) * strx(i) *
                          (a1 * (c(8, i + 1, j, k) * dup1 -
                           ...
                           a2 * (c(8, i + 2, j, k) * dup2 -
                                 c(8, i - 2, j, k) * dum2));
            r2 = r2 + stry(j) * strx(i) *
                          (a1 * (c(13, i + 1, j, k) * dup1 -
                                 c(13, i - 1, j, k) * dum1) +
                           a2 * (c(13, i + 2, j, k) * dup2 -
                                 c(13, i - 2, j, k) * dum2));
            r3 = r3 + stry(j) * strx(i) *
                          (a1 * (c(14, i + 1, j, k) * dup1 -
                                 c(14, i - 1, j, k) * dum1) +
                           a2 * (c(14, i + 2, j, k) * dup2 -
                                 c(14, i - 2, j, k) * dum2));
            ...
            r2 = r2 + strx(i) * stry(j) *
                          (a1 * (c(9, i, j + 1, k) * dup1 -
                           ...
                           a2 * (c(9, i, j + 2, k) * dup2 -
                                 c(9, i, j - 2, k) * dum2));
            r3 = r3 + strx(i) * stry(j) *
                          (a1 * (c(13, i, j + 1, k) * dup1 -
                                 c(13, i, j - 1, k) * dum1) +
                           a2 * (c(13, i, j + 2, k) * dup2 -
                                 c(13, i, j - 2, k) * dum2));
            ...
            r1 = r1 + strx(i) * stry(j) *
                          (a1 * (c(5, i, j + 1, k) * dup1 -
                           ...
                           a2 * (c(5, i, j + 2, k) * dup2 -
                                 c(5, i, j - 2, k) * dum2));
            r2 = r2 + strx(i) * stry(j) *
                          (a1 * (c(10, i, j + 1, k) * dup1 -
                                 c(10, i, j - 1, k) * dum1) +
                           a2 * (c(10, i, j + 2, k) * dup2 -
                                 c(10, i, j - 2, k) * dum2));
            r3 = r3 + strx(i) * stry(j) *
                          (a1 * (c(14, i, j + 1, k) * dup1 -
                                 c(14, i, j - 1, k) * dum1) +
                           a2 * (c(14, i, j + 2, k) * dup2 -
                                 c(14, i, j - 2, k) * dum2));
            ...
            r1 = r1 + strx(i) * (a1 * (c(3, i + 1, j, k) * dup1 -
                                       c(3, i - 1, j, k) * dum1) +
                                 a2 * (c(3, i + 2, j, k) * dup2 -
                                       c(3, i - 2, j, k) * dum2));
            r2 = r2 + strx(i) * (a1 * (c(5, i + 1, j, k) * dup1 -
                                       c(5, i - 1, j, k) * dum1) +
                                 a2 * (c(5, i + 2, j, k) * dup2 -
                                       c(5, i - 2, j, k) * dum2));
            r3 = r3 + strx(i) * (a1 * (c(6, i + 1, j, k) * dup1 -
                                       c(6, i - 1, j, k) * dum1) +
                                 a2 * (c(6, i + 2, j, k) * dup2 -
                                       c(6, i - 2, j, k) * dum2));
            ...
            r1 = r1 + strx(i) * (a1 * (c(8, i + 1, j, k) * dup1 -
                                       c(8, i - 1, j, k) * dum1) +
                                 a2 * (c(8, i + 2, j, k) * dup2 -
                                       c(8, i - 2, j, k) * dum2));
            r2 = r2 + strx(i) * (a1 * (c(10, i + 1, j, k) * dup1 -
                                       c(10, i - 1, j, k) * dum1) +
                                 a2 * (c(10, i + 2, j, k) * dup2 -
                                       c(10, i - 2, j, k) * dum2));
            r3 = r3 + strx(i) * (a1 * (c(11, i + 1, j, k) * dup1 -
                                       c(11, i - 1, j, k) * dum1) +
                                 a2 * (c(11, i + 2, j, k) * dup2 -
                                       c(11, i - 2, j, k) * dum2));
            ...
            r1 = r1 + strx(i) * (a1 * (c(12, i + 1, j, k) * dup1 -
                                       c(12, i - 1, j, k) * dum1) +
                                 a2 * (c(12, i + 2, j, k) * dup2 -
                                       c(12, i - 2, j, k) * dum2));
            r2 = r2 + strx(i) * (a1 * (c(14, i + 1, j, k) * dup1 -
                                       c(14, i - 1, j, k) * dum1) +
                                 a2 * (c(14, i + 2, j, k) * dup2 -
                                       c(14, i - 2, j, k) * dum2));
            r3 = r3 + strx(i) * (a1 * (c(15, i + 1, j, k) * dup1 -
                                       c(15, i - 1, j, k) * dum1) +
                                 a2 * (c(15, i + 2, j, k) * dup2 -
                                       c(15, i - 2, j, k) * dum2));
            ...
            r1 = r1 + stry(j) * (a1 * (c(8, i, j + 1, k) * dup1 -
                                       c(8, i, j - 1, k) * dum1) +
                                 a2 * (c(8, i, j + 2, k) * dup2 -
                                       c(8, i, j - 2, k) * dum2));
            r2 = r2 + stry(j) * (a1 * (c(10, i, j + 1, k) * dup1 -
                                       c(10, i, j - 1, k) * dum1) +
                                 a2 * (c(10, i, j + 2, k) * dup2 -
                                       c(10, i, j - 2, k) * dum2));
            r3 = r3 + stry(j) * (a1 * (c(11, i, j + 1, k) * dup1 -
                                       c(11, i, j - 1, k) * dum1) +
                                 a2 * (c(11, i, j + 2, k) * dup2 -
                                       c(11, i, j - 2, k) * dum2));
            ...
            r1 = r1 + stry(j) * (a1 * (c(13, i, j + 1, k) * dup1 -
                                       c(13, i, j - 1, k) * dum1) +
                                 a2 * (c(13, i, j + 2, k) * dup2 -
                                       c(13, i, j - 2, k) * dum2));
            r2 = r2 + stry(j) * (a1 * (c(17, i, j + 1, k) * dup1 -
                                       c(17, i, j - 1, k) * dum1) +
                                 a2 * (c(17, i, j + 2, k) * dup2 -
                                       c(17, i, j - 2, k) * dum2));
            r3 = r3 + stry(j) * (a1 * (c(18, i, j + 1, k) * dup1 -
                                       c(18, i, j - 1, k) * dum1) +
                                 a2 * (c(18, i, j + 2, k) * dup2 -
                                       c(18, i, j - 2, k) * dum2));
            ...
            r1 = r1 + stry(j) * (a1 * (c(14, i, j + 1, k) * dup1 -
                                       c(14, i, j - 1, k) * dum1) +
                                 a2 * (c(14, i, j + 2, k) * dup2 -
                                       c(14, i, j - 2, k) * dum2));
            r2 = r2 + stry(j) * (a1 * (c(19, i, j + 1, k) * dup1 -
                                       c(19, i, j - 1, k) * dum1) +
                                 a2 * (c(19, i, j + 2, k) * dup2 -
                                       c(19, i, j - 2, k) * dum2));
            r3 = r3 + stry(j) * (a1 * (c(20, i, j + 1, k) * dup1 -
                                       c(20, i, j - 1, k) * dum1) +
          ...
          for (sw4_type i = ifirst + 2; i <= ilast - 2; i++) {
            ...
            for (sw4_type q = nk - 7; q <= nk; q++) {
              ...
              for (sw4_type m = nk - 7; m <= nk; m++) {
                ...
                ac4 = ac4 +
                      acof(nk - k + 1, nk - q + 1, nk - m + 1) * c(19, i, j, m);
                ac5 = ac5 +
                      acof(nk - k + 1, nk - q + 1, nk - m + 1) * c(20, i, j, m);
                ac6 = ac6 +
                      acof(nk - k + 1, nk - q + 1, nk - m + 1) * c(21, i, j, m);
              }
              r1 = r1 + ac1 * u(1, i, j, q) + ac2 * u(2, i, j, q) +
                   ac3 * u(3, i, j, q);
              r2 = r2 + ac2 * u(1, i, j, q) + ac4 * u(2, i, j, q) +
...
#pragma ivdep
        for (sw4_type i = ifirst + 2; i <= ilast - 2; i++) {
          ...
          cm2 = c(7, i - 1, j, k) * strx(i - 1) -
                0.75 *
                    (c(7, i, j, k) * strx(i) + c(7, i - 2, j, k) * strx(i - 2));
          cm1 = c(7, i - 2, j, k) * strx(i - 2) +
                c(7, i + 1, j, k) * strx(i + 1) +
                3 * (c(7, i, j, k) * strx(i) + c(7, i - 1, j, k) * strx(i - 1));
          cp1 = c(7, i - 1, j, k) * strx(i - 1) +
                c(7, i + 2, j, k) * strx(i + 2) +
                3 * (c(7, i, j, k) * strx(i) + c(7, i + 1, j, k) * strx(i + 1));
          cp2 = c(7, i + 1, j, k) * strx(i + 1) -
                0.75 *
          ...
          cm2 = c(8, i - 1, j, k) * strx(i - 1) -
                0.75 *
                    (c(8, i, j, k) * strx(i) + c(8, i - 2, j, k) * strx(i - 2));
          cm1 = c(8, i - 2, j, k) * strx(i - 2) +
                c(8, i + 1, j, k) * strx(i + 1) +
                3 * (c(8, i, j, k) * strx(i) + c(8, i - 1, j, k) * strx(i - 1));
          cp1 = c(8, i - 1, j, k) * strx(i - 1) +
                c(8, i + 2, j, k) * strx(i + 2) +
                3 * (c(8, i, j, k) * strx(i) + c(8, i + 1, j, k) * strx(i + 1));
          cp2 = c(8, i + 1, j, k) * strx(i + 1) -
                0.75 *
          ...
          cm1 =
              c(12, i - 2, j, k) * strx(i - 2) +
              c(12, i + 1, j, k) * strx(i + 1) +
              3 * (c(12, i, j, k) * strx(i) + c(12, i - 1, j, k) * strx(i - 1));
          cp1 =
              c(12, i - 1, j, k) * strx(i - 1) +
              c(12, i + 2, j, k) * strx(i + 2) +
              3 * (c(12, i, j, k) * strx(i) + c(12, i + 1, j, k) * strx(i + 1));
          ...
          cm1 =
              c(16, i, j - 2, k) * stry(j - 2) +
              c(16, i, j + 1, k) * stry(j + 1) +
              3 * (c(16, i, j, k) * stry(j) + c(16, i, j - 1, k) * stry(j - 1));
          cp1 =
              c(16, i, j - 1, k) * stry(j - 1) +
              c(16, i, j + 2, k) * stry(j + 2) +
              3 * (c(16, i, j, k) * stry(j) + c(16, i, j + 1, k) * stry(j + 1));
          ...
          cm1 =
              c(17, i, j - 2, k) * stry(j - 2) +
              c(17, i, j + 1, k) * stry(j + 1) +
              3 * (c(17, i, j, k) * stry(j) + c(17, i, j - 1, k) * stry(j - 1));
          cp1 =
              c(17, i, j - 1, k) * stry(j - 1) +
              c(17, i, j + 2, k) * stry(j + 2) +
              3 * (c(17, i, j, k) * stry(j) + c(17, i, j + 1, k) * stry(j + 1));
          ...
          cm1 =
              c(19, i, j - 2, k) * stry(j - 2) +
              c(19, i, j + 1, k) * stry(j + 1) +
              3 * (c(19, i, j, k) * stry(j) + c(19, i, j - 1, k) * stry(j - 1));
          cp1 =
              c(19, i, j - 1, k) * stry(j - 1) +
              c(19, i, j + 2, k) * stry(j + 2) +
              3 * (c(19, i, j, k) * stry(j) + c(19, i, j + 1, k) * stry(j + 1));
          ...
          r3 = r3 + i6 * stry(j) *
                        (cm2 * (u(3, i, j - 2, k) - u(3, i, j, k)) +
                         ...
                         cp1 * (u(3, i, j + 1, k) - u(3, i, j, k)) +
                         cp2 * (u(3, i, j + 2, k) - u(3, i, j, k)));
          cm2 = c(12, i, j, k - 1) * strz(k - 1) -
                0.75 * (c(12, i, j, k) * strz(k) +
                        c(12, i, j, k - 2) * strz(k - 2));
          cm1 =
              c(12, i, j, k - 2) * strz(k - 2) +
              c(12, i, j, k + 1) * strz(k + 1) +
              3 * (c(12, i, j, k) * strz(k) + c(12, i, j, k - 1) * strz(k - 1));
          cp1 =
              c(12, i, j, k - 1) * strz(k - 1) +
              c(12, i, j, k + 2) * strz(k + 2) +
              3 * (c(12, i, j, k) * strz(k) + c(12, i, j, k + 1) * strz(k + 1));
          cp2 = c(12, i, j, k + 1) * strz(k + 1) -
                0.75 * (c(12, i, j, k) * strz(k) +
                        c(12, i, j, k + 2) * strz(k + 2));
          ...
          r3 = r3 + i6 * strz(k) *
                        (cm2 * (u(1, i, j, k - 2) - u(1, i, j, k)) +
                         ...
                         cp1 * (u(1, i, j, k + 1) - u(1, i, j, k)) +
                         cp2 * (u(1, i, j, k + 2) - u(1, i, j, k)));
          cm2 = c(19, i, j, k - 1) * strz(k - 1) -
                0.75 * (c(19, i, j, k) * strz(k) +
                        c(19, i, j, k - 2) * strz(k - 2));
          cm1 =
              c(19, i, j, k - 2) * strz(k - 2) +
              c(19, i, j, k + 1) * strz(k + 1) +
              3 * (c(19, i, j, k) * strz(k) + c(19, i, j, k - 1) * strz(k - 1));
          cp1 =
              c(19, i, j, k - 1) * strz(k - 1) +
              c(19, i, j, k + 2) * strz(k + 2) +
              3 * (c(19, i, j, k) * strz(k) + c(19, i, j, k + 1) * strz(k + 1));
          cp2 = c(19, i, j, k + 1) * strz(k + 1) -
                0.75 * (c(19, i, j, k) * strz(k) +
                        c(19, i, j, k + 2) * strz(k + 2));
          ...
          r2 = r2 + i6 * strz(k) *
                        (cm2 * (u(2, i, j, k - 2) - u(2, i, j, k)) +
                         ...
                         cp1 * (u(2, i, j, k + 1) - u(2, i, j, k)) +
                         cp2 * (u(2, i, j, k + 2) - u(2, i, j, k)));
          cm2 = c(20, i, j, k - 1) * strz(k - 1) -
                0.75 * (c(20, i, j, k) * strz(k) +
                        c(20, i, j, k - 2) * strz(k - 2));
          cm1 =
              c(20, i, j, k - 2) * strz(k - 2) +
              c(20, i, j, k + 1) * strz(k + 1) +
              3 * (c(20, i, j, k) * strz(k) + c(20, i, j, k - 1) * strz(k - 1));
          cp1 =
              c(20, i, j, k - 1) * strz(k - 1) +
              c(20, i, j, k + 2) * strz(k + 2) +
              3 * (c(20, i, j, k) * strz(k) + c(20, i, j, k + 1) * strz(k + 1));
          cp2 = c(20, i, j, k + 1) * strz(k + 1) -
                0.75 * (c(20, i, j, k) * strz(k) +
                        c(20, i, j, k + 2) * strz(k + 2));
          ...
          r3 = r3 + i6 * strz(k) *
                        (cm2 * (u(2, i, j, k - 2) - u(2, i, j, k)) +
                         ...
                         cp1 * (u(2, i, j, k + 1) - u(2, i, j, k)) +
                         cp2 * (u(2, i, j, k + 2) - u(2, i, j, k)));
          cm2 = c(21, i, j, k - 1) * strz(k - 1) -
                0.75 * (c(21, i, j, k) * strz(k) +
                        c(21, i, j, k - 2) * strz(k - 2));
          cm1 =
              c(21, i, j, k - 2) * strz(k - 2) +
              c(21, i, j, k + 1) * strz(k + 1) +
              3 * (c(21, i, j, k) * strz(k) + c(21, i, j, k - 1) * strz(k - 1));
          cp1 =
              c(21, i, j, k - 1) * strz(k - 1) +
              c(21, i, j, k + 2) * strz(k + 2) +
              3 * (c(21, i, j, k) * strz(k) + c(21, i, j, k + 1) * strz(k + 1));
          cp2 = c(21, i, j, k + 1) * strz(k + 1) -
                0.75 * (c(21, i, j, k) * strz(k) +
                        c(21, i, j, k + 2) * strz(k + 2));
          ...
          r1 = r1 +
               stry(j) * strx(i) *
                   (a1 * (c(2, i + 1, j, k) * dup1 - c(2, i - 1, j, k) * dum1) +
                    a2 * (c(2, i + 2, j, k) * dup2 - c(2, i - 2, j, k) * dum2));
          r2 = r2 +
               stry(j) * strx(i) *
                   (a1 * (c(4, i + 1, j, k) * dup1 - c(4, i - 1, j, k) * dum1) +
                    a2 * (c(4, i + 2, j, k) * dup2 - c(4, i - 2, j, k) * dum2));
          r3 = r3 +
               stry(j) * strx(i) *
                   (a1 * (c(5, i + 1, j, k) * dup1 - c(5, i - 1, j, k) * dum1) +
          ...
          r1 = r1 +
               stry(j) * strx(i) *
                   (a1 * (c(7, i + 1, j, k) * dup1 - c(7, i - 1, j, k) * dum1) +
                    a2 * (c(7, i + 2, j, k) * dup2 - c(7, i - 2, j, k) * dum2));
          r2 = r2 +
               stry(j) * strx(i) *
                   (a1 * (c(9, i + 1, j, k) * dup1 - c(9, i - 1, j, k) * dum1) +
          ...
          r1 = r1 +
               stry(j) * strx(i) *
                   (a1 * (c(8, i + 1, j, k) * dup1 - c(8, i - 1, j, k) * dum1) +
          ...
          r1 = r1 +
               strx(i) * stry(j) *
                   (a1 * (c(2, i, j + 1, k) * dup1 - c(2, i, j - 1, k) * dum1) +
                    a2 * (c(2, i, j + 2, k) * dup2 - c(2, i, j - 2, k) * dum2));
          r2 = r2 +
               strx(i) * stry(j) *
                   (a1 * (c(7, i, j + 1, k) * dup1 - c(7, i, j - 1, k) * dum1) +
                    a2 * (c(7, i, j + 2, k) * dup2 - c(7, i, j - 2, k) * dum2));
          r3 = r3 +
               strx(i) * stry(j) *
                   (a1 * (c(8, i, j + 1, k) * dup1 - c(8, i, j - 1, k) * dum1) +
          ...
          r1 = r1 +
               strx(i) * stry(j) *
                   (a1 * (c(4, i, j + 1, k) * dup1 - c(4, i, j - 1, k) * dum1) +
                    a2 * (c(4, i, j + 2, k) * dup2 - c(4, i, j - 2, k) * dum2));
          r2 = r2 +
               strx(i) * stry(j) *
                   (a1 * (c(9, i, j + 1, k) * dup1 - c(9, i, j - 1, k) * dum1) +
          ...
          r1 = r1 +
               strx(i) * stry(j) *
                   (a1 * (c(5, i, j + 1, k) * dup1 - c(5, i, j - 1, k) * dum1) +
          ...
          r1 = r1 +
               strz(k) * strx(i) *
                   (a1 * (c(3, i + 1, j, k) * dup1 - c(3, i - 1, j, k) * dum1) +
          ...
          r3 = r3 +
               strz(k) * strx(i) *
                   (a1 * (c(6, i + 1, j, k) * dup1 - c(6, i - 1, j, k) * dum1) +
          ...
          r1 = r1 +
               strx(i) * strz(k) *
                   (a1 * (c(3, i, j, k + 1) * dup1 - c(3, i, j, k - 1) * dum1) +
                    a2 * (c(3, i, j, k + 2) * dup2 - c(3, i, j, k - 2) * dum2));
          r2 = r2 +
               strx(i) * strz(k) *
                   (a1 * (c(8, i, j, k + 1) * dup1 - c(8, i, j, k - 1) * dum1) +
                    a2 * (c(8, i, j, k + 2) * dup2 - c(8, i, j, k - 2) * dum2));
          r3 = r3 + strx(i) * strz(k) *
                        (a1 * (c(12, i, j, k + 1) * dup1 -
                               c(12, i, j, k - 1) * dum1) +
                         a2 * (c(12, i, j, k + 2) * dup2 -
                               c(12, i, j, k - 2) * dum2));
          ...
          r1 = r1 +
               strx(i) * strz(k) *
                   (a1 * (c(5, i, j, k + 1) * dup1 - c(5, i, j, k - 1) * dum1) +
                    a2 * (c(5, i, j, k + 2) * dup2 - c(5, i, j, k - 2) * dum2));
          r2 = r2 + strx(i) * strz(k) *
                        (a1 * (c(10, i, j, k + 1) * dup1 -
                               c(10, i, j, k - 1) * dum1) +
                         a2 * (c(10, i, j, k + 2) * dup2 -
                               c(10, i, j, k - 2) * dum2));
          r3 = r3 + strx(i) * strz(k) *
                        (a1 * (c(14, i, j, k + 1) * dup1 -
                               c(14, i, j, k - 1) * dum1) +
                         a2 * (c(14, i, j, k + 2) * dup2 -
                               c(14, i, j, k - 2) * dum2));
          ...
          r1 = r1 +
               strx(i) * strz(k) *
                   (a1 * (c(6, i, j, k + 1) * dup1 - c(6, i, j, k - 1) * dum1) +
                    a2 * (c(6, i, j, k + 2) * dup2 - c(6, i, j, k - 2) * dum2));
          r2 = r2 + strx(i) * strz(k) *
                        (a1 * (c(11, i, j, k + 1) * dup1 -
                               c(11, i, j, k - 1) * dum1) +
                         a2 * (c(11, i, j, k + 2) * dup2 -
                               c(11, i, j, k - 2) * dum2));
          r3 = r3 + strx(i) * strz(k) *
                        (a1 * (c(15, i, j, k + 1) * dup1 -
                               c(15, i, j, k - 1) * dum1) +
                         a2 * (c(15, i, j, k + 2) * dup2 -
                               c(15, i, j, k - 2) * dum2));
          ...
          r1 = r1 + strz(k) * stry(j) *
                        (a1 * (c(13, i, j + 1, k) * dup1 -
                         ...
                         a2 * (c(13, i, j + 2, k) * dup2 -
                               c(13, i, j - 2, k) * dum2));
          r2 = r2 + strz(k) * stry(j) *
                        (a1 * (c(17, i, j + 1, k) * dup1 -
                               c(17, i, j - 1, k) * dum1) +
                         a2 * (c(17, i, j + 2, k) * dup2 -
                               c(17, i, j - 2, k) * dum2));
          r3 = r3 + strz(k) * stry(j) *
                        (a1 * (c(18, i, j + 1, k) * dup1 -
                               c(18, i, j - 1, k) * dum1) +
                         a2 * (c(18, i, j + 2, k) * dup2 -
                               c(18, i, j - 2, k) * dum2));
          ...
          r1 = r1 +
               stry(j) * strz(k) *
                   (a1 * (c(8, i, j, k + 1) * dup1 - c(8, i, j, k - 1) * dum1) +
                    a2 * (c(8, i, j, k + 2) * dup2 - c(8, i, j, k - 2) * dum2));
          r2 = r2 + stry(j) * strz(k) *
                        (a1 * (c(13, i, j, k + 1) * dup1 -
                               c(13, i, j, k - 1) * dum1) +
                         a2 * (c(13, i, j, k + 2) * dup2 -
                               c(13, i, j, k - 2) * dum2));
          r3 = r3 + stry(j) * strz(k) *
                        (a1 * (c(14, i, j, k + 1) * dup1 -
                               c(14, i, j, k - 1) * dum1) +
          ...
          r1 = r1 + stry(j) * strz(k) *
                        (a1 * (c(10, i, j, k + 1) * dup1 -
                         ...
                         a2 * (c(10, i, j, k + 2) * dup2 -
                               c(10, i, j, k - 2) * dum2));
          r2 = r2 + stry(j) * strz(k) *
                        (a1 * (c(17, i, j, k + 1) * dup1 -
                               c(17, i, j, k - 1) * dum1) +
                         a2 * (c(17, i, j, k + 2) * dup2 -
                               c(17, i, j, k - 2) * dum2));
          r3 = r3 + stry(j) * strz(k) *
                        (a1 * (c(19, i, j, k + 1) * dup1 -
                               c(19, i, j, k - 1) * dum1) +
                         a2 * (c(19, i, j, k + 2) * dup2 -
                               c(19, i, j, k - 2) * dum2));
          ...
          r1 = r1 + stry(j) * strz(k) *
                        (a1 * (c(11, i, j, k + 1) * dup1 -
                         ...
                         a2 * (c(11, i, j, k + 2) * dup2 -
                               c(11, i, j, k - 2) * dum2));
          r2 = r2 + stry(j) * strz(k) *
                        (a1 * (c(18, i, j, k + 1) * dup1 -
                               c(18, i, j, k - 1) * dum1) +
                         a2 * (c(18, i, j, k + 2) * dup2 -
                               c(18, i, j, k - 2) * dum2));
          r3 = r3 + stry(j) * strz(k) *
                        (a1 * (c(20, i, j, k + 1) * dup1 -
                               c(20, i, j, k - 1) * dum1) +
                         a2 * (c(20, i, j, k + 2) * dup2 -
                               c(20, i, j, k - 2) * dum2));
        }
  }
}
