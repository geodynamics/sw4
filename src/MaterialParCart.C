...
//-----------------------------------------------------------------------
void MaterialParCart::smooth_gradient(double* dfs, std::vector<Sarray>& a_Rho, std::vector<Sarray>& a_Mu, std::vector<Sarray>& a_Lambda, float_sw4 freq, float_sw4 sz)
{
			 ...
			 std::vector<Sarray>& a_mu, std::vector<Sarray>& a_lambda )
{
   ...
   Sarray m_rho(0,m_nx+1,0,m_ny+1,0,m_nz+1);
   Sarray m_cs(0,m_nx+1,0,m_ny+1,0,m_nz+1);
   Sarray m_cp(0,m_nx+1,0,m_ny+1,0,m_nz+1);
