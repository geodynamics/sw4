...
public:   
   ...
   int m_ibg, m_ieg, m_jbg, m_jeg, m_kbg, m_keg; //Global dims, includes ghost points

   std::vector<int> m_ib, m_ie, m_jb, m_je, m_kb, m_ke; //Local for each processor, includes padding and ghost points
   int m_npad, m_nghost;
   bool m_indrev;
