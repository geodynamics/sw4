...
class MaterialBlock : public MaterialData {
 public:
  MaterialBlock(EW *a_ew, float_sw4 rho, float_sw4 vs, float_sw4 vp,
                float_sw4 xmin, float_sw4 xmax, float_sw4 ymin, float_sw4 ymax,
                float_sw4 zmin, float_sw4 zmax, float_sw4 qs = -1,
                float_sw4 qp = -1, float_sw4 freq = 1);
