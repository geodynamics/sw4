...
void linesearch(EW& simulation, vector<vector<Source*> >& GlobalSources,
                ...
                int nmpars, double* xs, int nm_global, int nm, double* xm,
                double f, double* dfs, double* dfm, double* ps, double* pm,
                double cgstep, double maxstep, double steptol, double* xsnew,
                double* xmnew, double& fnew, double* sfs, double* sfm,
                int myRank, int& retcode, int& nstep_reductions, bool testing,
                double* dfsnew, double* dfmnew, Mopt* mopt);
