...
#define uacc(c, i, j, k) a_uacc[base3 + (i) + ni * (j) + nij * (k) + nijk * (c)]
  ...
  bool o4 = (onesided[4] == 1);
  bool o5 = ( onesided[5] == 1);
  ...
  RAJA::kernel<CURV_POL>(
        ...
        if (k <= 4 && o4) normfact *= normwgh[k - 1];
        if (k >= nk - 3 && o5) normfact *= normwgh[nk - k];
        grho(i, j, k) +=
            (kap(1, i, j, k) *
             ...
             kap(2, i, j, k) *
                 (up(2, i, j, k) - 2 * u(2, i, j, k) + um(2, i, j, k)) * idt *
                 idt +
             dt2o12 * kapacc(2, i, j, k) * uacc(2, i, j, k) +
             kap(3, i, j, k) *
                 (up(3, i, j, k) - 2 * u(3, i, j, k) + um(3, i, j, k)) * idt *
                 idt +
    ...
    if (kfirstact <= 4 && onesided[4] == 1) {
      ...
      RAJA::kernel<CURV_POL>(
	    ...
	    const float_sw4 w6p[4] = {0, al1, al1 + al2, al1 + al2 + al3};
            ...
            float_sw4 duax =
                d4b * (uacc(1, i + 2, j, k) - uacc(1, i - 2, j, k)) +
                d4a * (uacc(1, i + 1, j, k) - uacc(1, i - 1, j, k));
            float_sw4 dvay =
                d4b * (uacc(2, i, j + 2, k) - uacc(2, i, j - 2, k)) +
                d4a * (uacc(2, i, j + 1, k) - uacc(2, i, j - 1, k));
            float_sw4 dkax =
                d4b * (kapacc(1, i + 2, j, k) - kapacc(1, i - 2, j, k)) +
            ...
            gmu(i, j, k) =
                gmu(i, j, k) +
                (stuxz * stkxz + dt2o12 * (stuxz * stkaxz + stuaxz * stkxz)) *
                    normfact * ih2;
            //  yz
            ...
            gmu(i, j, k) =
                gmu(i, j, k) +
                (stuyz * stkyz + dt2o12 * (stuyz * stkayz + stuayz * stkyz)) *
                    normfact * ih2;
            ...
            float_sw4 d3kap = kapacc(1, i + 2, j, k) -
                              3 * kapacc(1, i + 1, j, k) +
            ...
            // z-direction
            if (k >= 2) {
              d3up = u(1, i, j, k + 2) - 3 * u(1, i, j, k + 1) +
                     3 * u(1, i, j, k) - u(1, i, j, k - 1);
              d3um = u(1, i, j, k + 1) - 3 * u(1, i, j, k) +
                     3 * u(1, i, j, k - 1) - u(1, i, j, k - 2);
              ...
              pd =
                  ((0.5 * (w6p[k - 1] * d3up * d3kp + w6m[k - 1] * d3um * d3km +
                           dt2o12 * (w6p[k - 1] * d3up * d3kap +
                                     w6m[k - 1] * d3um * d3kam +
                                     w6p[k - 1] * d3uap * d3kp +
                                     w6m[k - 1] * d3uam * d3km))) +
                   w8[k - 1] * c8 *
    ...
    RAJA::RangeSegment k_range(kstart, kend + 1);
      ...
      RAJA::kernel<CURV_POL>(
          ...
          float_sw4 dlay =
              ...
              d4a * (kapacc(2, i, j + 1, k) - kapacc(2, i, j - 1, k));
          float_sw4 dmaz =
              d4b * (kapacc(3, i, j, k + 2) - kapacc(3, i, j, k - 2)) +
          ...
          pd = (c6 * 0.5 *
                    (d3up * d3kp + d3um * d3km +
                     dt2o12 * (d3up * d3kap + d3um * d3kam + d3uap * d3kp +
                               d3uam * d3km)) +
                c8 * ((d3up - d3um) * (d3kp - d3km) +
                      dt2o12 * ((d3uap - d3uam) * (d3kp - d3km) +
                                (d3up - d3um) * (d3kap - d3kam)))) *
          ...
          d3up = u(2, i, j, k + 2) - 3 * u(2, i, j, k + 1) + 3 * u(2, i, j, k) -
                 u(2, i, j, k - 1);
          d3um = u(2, i, j, k + 1) - 3 * u(2, i, j, k) + 3 * u(2, i, j, k - 1) -
                 u(2, i, j, k - 2);
          d3kp = kap(2, i, j, k + 2) - 3 * kap(2, i, j, k + 1) +
                 3 * kap(2, i, j, k) - kap(2, i, j, k - 1);
          d3km = kap(2, i, j, k + 1) - 3 * kap(2, i, j, k) +
    ...
    const float_sw4 w6m[4] = {0, al1, al1 + al2, al1 + al2 + al3};
          ...
          if (k <= nk - 1) {
            ...
            d3kam = kapacc(1, i, j, k + 1) - 3 * kapacc(1, i, j, k) +
                    3 * kapacc(1, i, j, k - 1) - kapacc(1, i, j, k - 2);
            pd =
                ((0.5 * (w6p[kk - 1] * d3up * d3kp + w6m[kk - 1] * d3um * d3km +
                         dt2o12 * (w6p[kk - 1] * d3up * d3kap +
                                   w6m[kk - 1] * d3um * d3kam +
                                   w6p[kk - 1] * d3uap * d3kp +
                                   w6m[kk - 1] * d3uam * d3km))) +
                 w8[kk - 1] * c8 *
  ...
  // #pragma omp parallel
  {
    if (kfirstact <= 4 && onesided[4] == 1) {
      ...
      //         for (int i = ifirstact; i <= ilastact; i++) {
            ...
            // Pos. def extra terms
            // x-direction
            //   metric is constant for the x and y directions, just use as a
            //   norm weight
            ...
            if (k >= 2) {
              ...
              float_sw4 d3vp = u(2, i, j, k + 2) - 3 * u(2, i, j, k + 1) +
                               3 * u(2, i, j, k) - u(2, i, j, k - 1);
              float_sw4 d3vm = u(2, i, j, k + 1) - 3 * u(2, i, j, k) +
                               3 * u(2, i, j, k - 1) - u(2, i, j, k - 2);
              float_sw4 d3lp = kap(2, i, j, k + 2) - 3 * kap(2, i, j, k + 1) +
                               3 * kap(2, i, j, k) - kap(2, i, j, k - 1);
              float_sw4 d3lm = kap(2, i, j, k + 1) - 3 * kap(2, i, j, k) +
                               3 * kap(2, i, j, k - 1) - kap(2, i, j, k - 2);
              float_sw4 d3vap = uacc(2, i, j, k + 2) -
                                3 * uacc(2, i, j, k + 1) +
                                3 * uacc(2, i, j, k) - uacc(2, i, j, k - 1);
              float_sw4 d3vam = uacc(2, i, j, k + 1) - 3 * uacc(2, i, j, k) +
                                3 * uacc(2, i, j, k - 1) - uacc(2, i, j, k - 2);
              float_sw4 d3lap = kapacc(2, i, j, k + 2) -
                                3 * kapacc(2, i, j, k + 1) +
                                3 * kapacc(2, i, j, k) - kapacc(2, i, j, k - 1);
              float_sw4 d3lam =
                  kapacc(2, i, j, k + 1) - 3 * kapacc(2, i, j, k) +
                  3 * kapacc(2, i, j, k - 1) - kapacc(2, i, j, k - 2);

              float_sw4 d3wp = u(3, i, j, k + 2) - 3 * u(3, i, j, k + 1) +
                               3 * u(3, i, j, k) - u(3, i, j, k - 1);
              float_sw4 d3wm = u(3, i, j, k + 1) - 3 * u(3, i, j, k) +
                               3 * u(3, i, j, k - 1) - u(3, i, j, k - 2);
              float_sw4 d3mp = kap(3, i, j, k + 2) - 3 * kap(3, i, j, k + 1) +
                               3 * kap(3, i, j, k) - kap(3, i, j, k - 1);
              float_sw4 d3mm = kap(3, i, j, k + 1) - 3 * kap(3, i, j, k) +
                               3 * kap(3, i, j, k - 1) - kap(3, i, j, k - 2);
              float_sw4 d3wap = uacc(3, i, j, k + 2) -
                                3 * uacc(3, i, j, k + 1) +
                                3 * uacc(3, i, j, k) - uacc(3, i, j, k - 1);
              float_sw4 d3wam = uacc(3, i, j, k + 1) - 3 * uacc(3, i, j, k) +
                                3 * uacc(3, i, j, k - 1) - uacc(3, i, j, k - 2);
              float_sw4 d3map = kapacc(3, i, j, k + 2) -
                                3 * kapacc(3, i, j, k + 1) +
                                3 * kapacc(3, i, j, k) - kapacc(3, i, j, k - 1);
              float_sw4 d3mam =
                  kapacc(3, i, j, k + 1) - 3 * kapacc(3, i, j, k) +
                  3 * kapacc(3, i, j, k - 1) - kapacc(3, i, j, k - 2);

#define SQR(x) (x) * (x)
              float_sw4 mucof = SQR(met(2, i, j, k)) + SQR(met(3, i, j, k)) +
                                SQR(met(4, i, j, k));
              float_sw4 mucofp = SQR(met(2, i, j, k + 1)) +
                                 SQR(met(3, i, j, k + 1)) +
                                 SQR(met(4, i, j, k + 1));
              // u-u
              pd =
              ...
              if (k == 4) {
                pd = 0.5 * (-al4 * d3up * d3kp + dt2o12 * (-al4 * d3up * d3kap -
                                                           al4 * d3uap * d3kp));
                gmu(i, j, k + 1) =
                    gmu(i, j, k + 1) + pd * (mucofp + SQR(met(2, i, j, k + 1)));
                glambda(i, j, k + 1) =
                    glambda(i, j, k + 1) + pd * SQR(met(2, i, j, k + 1));
              }
              // u-v
              pd =
                  ((0.5 * (w6p[k - 1] * d3vp * d3kp + w6m[k - 1] * d3vm * d3km +
                           dt2o12 * (w6p[k - 1] * d3vp * d3kap +
                                     w6m[k - 1] * d3vm * d3kam +
                                     w6p[k - 1] * d3vap * d3kp +
                                     w6m[k - 1] * d3vam * d3km))) +
                   w8[k - 1] * c8 *
              ...
              // u-w
              pd =
                  ((0.5 * (w6p[k - 1] * d3wp * d3kp + w6m[k - 1] * d3wm * d3km +
                           dt2o12 * (w6p[k - 1] * d3wp * d3kap +
                                     w6m[k - 1] * d3wm * d3kam +
                                     w6p[k - 1] * d3wap * d3kp +
                                     w6m[k - 1] * d3wam * d3km))) +
                   w8[k - 1] * c8 *
              ...
              // v-u
              pd =
                  ((0.5 * (w6p[k - 1] * d3up * d3lp + w6m[k - 1] * d3um * d3lm +
                           dt2o12 * (w6p[k - 1] * d3up * d3lap +
                                     w6m[k - 1] * d3um * d3lam +
                                     w6p[k - 1] * d3uap * d3lp +
                                     w6m[k - 1] * d3uam * d3lm))) +
                   w8[k - 1] * c8 *
              ...
              // v-v
              pd =
                  ((0.5 * (w6p[k - 1] * d3vp * d3lp + w6m[k - 1] * d3vm * d3lm +
                           dt2o12 * (w6p[k - 1] * d3vp * d3lap +
                                     w6m[k - 1] * d3vm * d3lam +
                                     w6p[k - 1] * d3vap * d3lp +
                                     w6m[k - 1] * d3vam * d3lm))) +
                   w8[k - 1] * c8 *
              ...
              if (k == 4) {
                pd = 0.5 * (-al4 * d3vp * d3lp + dt2o12 * (-al4 * d3vp * d3lap -
                                                           al4 * d3vap * d3lp));
                glambda(i, j, k + 1) =
                    glambda(i, j, k + 1) + pd * SQR(met(3, i, j, k + 1));
                gmu(i, j, k + 1) =
                    gmu(i, j, k + 1) + pd * (mucofp + SQR(met(3, i, j, k + 1)));
              }

              // v-w
              pd =
                  ((0.5 * (w6p[k - 1] * d3wp * d3lp + w6m[k - 1] * d3wm * d3lm +
                           dt2o12 * (w6p[k - 1] * d3wp * d3lap +
                                     w6m[k - 1] * d3wm * d3lam +
                                     w6p[k - 1] * d3wap * d3lp +
                                     w6m[k - 1] * d3wam * d3lm))) +
                   w8[k - 1] * c8 *
              ...
              // w-u
              pd =
                  ((0.5 * (w6p[k - 1] * d3up * d3mp + w6m[k - 1] * d3um * d3mm +
                           dt2o12 * (w6p[k - 1] * d3up * d3map +
                                     w6m[k - 1] * d3um * d3mam +
                                     w6p[k - 1] * d3uap * d3mp +
                                     w6m[k - 1] * d3uam * d3mm))) +
                   w8[k - 1] * c8 *
              ...
              // w-v
              pd =
                  ((0.5 * (w6p[k - 1] * d3vp * d3mp + w6m[k - 1] * d3vm * d3mm +
                           dt2o12 * (w6p[k - 1] * d3vp * d3map +
                                     w6m[k - 1] * d3vm * d3mam +
                                     w6p[k - 1] * d3vap * d3mp +
                                     w6m[k - 1] * d3vam * d3mm))) +
                   w8[k - 1] * c8 *
              ...
              // w-w
              pd =
                  ((0.5 * (w6p[k - 1] * d3wp * d3mp + w6m[k - 1] * d3wm * d3mm +
                           dt2o12 * (w6p[k - 1] * d3wp * d3map +
                                     w6m[k - 1] * d3wm * d3mam +
                                     w6p[k - 1] * d3wap * d3mp +
                                     w6m[k - 1] * d3wam * d3mm))) +
                   w8[k - 1] * c8 *
              ...
              if (k == 4) {
                pd = 0.5 * (-al4 * d3wp * d3mp + dt2o12 * (-al4 * d3wp * d3map -
                                                           al4 * d3wap * d3mp));
                glambda(i, j, k + 1) =
                    glambda(i, j, k + 1) + pd * SQR(met(4, i, j, k + 1));
                gmu(i, j, k + 1) =
                    gmu(i, j, k + 1) + pd * (mucofp + SQR(met(4, i, j, k + 1)));
              }
            }
			 });
    }
  ...
  RAJA::kernel<CURV_POL>(
    ...
    //     for (int i = ifirstact; i <= ilastact; i++) {
          ...
          //  xz
          float_sw4 stuxz =
              met(1, i, j, k) * (d4b * (u(3, i + 2, j, k) - u(3, i - 2, j, k)) +
                                 d4a * (u(3, i + 1, j, k) - u(3, i - 1, j, k)));
          ...
          //  yz
          float_sw4 stuyz =
              met(1, i, j, k) * (d4b * (u(3, i, j + 2, k) - u(3, i, j - 2, k)) +
                                 d4a * (u(3, i, j + 1, k) - u(3, i, j - 1, k)));
          ...
          // Pos. def extra terms
          // x-direction
          //   metric is constant for the x and y directions, just use as a norm
          //   weight
          float_sw4 m1sq = met(1, i, j, k) * met(1, i, j, k);
...
#define SQR(x) (x) * (x)
            float_sw4 mucof = SQR(met(2, i, j, k)) + SQR(met(3, i, j, k)) +
                              SQR(met(4, i, j, k));
            float_sw4 mucofm = SQR(met(2, i, j, k - 1)) +
                               SQR(met(3, i, j, k - 1)) +
                               SQR(met(4, i, j, k - 1));
            // u-u
            pd =
            ...
            if (k == nk - 3) {
              pd = 0.5 * (-al4 * d3um * d3km +
                          dt2o12 * (-al4 * d3um * d3kam - al4 * d3uam * d3km));
              gmu(i, j, k - 1) =
                  gmu(i, j, k - 1) + pd * (mucofm + SQR(met(2, i, j, k - 1)));
              glambda(i, j, k - 1) =
                  glambda(i, j, k - 1) + pd * SQR(met(2, i, j, k - 1));
            }
            // u-v
            pd =
                ((0.5 * (w6p[kk - 1] * d3vp * d3kp + w6m[kk - 1] * d3vm * d3km +
                         dt2o12 * (w6p[kk - 1] * d3vp * d3kap +
                                   w6m[kk - 1] * d3vm * d3kam +
                                   w6p[kk - 1] * d3vap * d3kp +
                                   w6m[kk - 1] * d3vam * d3km))) +
                 w8[kk - 1] * c8 *
            ...
            // u-w
            pd =
                ((0.5 * (w6p[kk - 1] * d3wp * d3kp + w6m[kk - 1] * d3wm * d3km +
                         dt2o12 * (w6p[kk - 1] * d3wp * d3kap +
                                   w6m[kk - 1] * d3wm * d3kam +
                                   w6p[kk - 1] * d3wap * d3kp +
                                   w6m[kk - 1] * d3wam * d3km))) +
                 w8[kk - 1] * c8 *
            ...
            // v-u
            pd =
                ((0.5 * (w6p[kk - 1] * d3up * d3lp + w6m[kk - 1] * d3um * d3lm +
                         dt2o12 * (w6p[kk - 1] * d3up * d3lap +
                                   w6m[kk - 1] * d3um * d3lam +
                                   w6p[kk - 1] * d3uap * d3lp +
                                   w6m[kk - 1] * d3uam * d3lm))) +
                 w8[kk - 1] * c8 *
            ...
            // v-v
            pd =
                ((0.5 * (w6p[kk - 1] * d3vp * d3lp + w6m[kk - 1] * d3vm * d3lm +
                         dt2o12 * (w6p[kk - 1] * d3vp * d3lap +
                                   w6m[kk - 1] * d3vm * d3lam +
                                   w6p[kk - 1] * d3vap * d3lp +
                                   w6m[kk - 1] * d3vam * d3lm))) +
                 w8[kk - 1] * c8 *
            ...
            if (k == nk - 3) {
              ...
              glambda(i, j, k - 1) =
                  glambda(i, j, k - 1) + pd * SQR(met(3, i, j, k - 1));
              gmu(i, j, k - 1) =
                  gmu(i, j, k - 1) + pd * (mucofm + SQR(met(3, i, j, k - 1)));
            }

            // v-w
            pd =
                ((0.5 * (w6p[kk - 1] * d3wp * d3lp + w6m[kk - 1] * d3wm * d3lm +
                         dt2o12 * (w6p[kk - 1] * d3wp * d3lap +
                                   w6m[kk - 1] * d3wm * d3lam +
                                   w6p[kk - 1] * d3wap * d3lp +
                                   w6m[kk - 1] * d3wam * d3lm))) +
                 w8[kk - 1] * c8 *
            ...
            // w-u
            pd =
                ((0.5 * (w6p[kk - 1] * d3up * d3mp + w6m[kk - 1] * d3um * d3mm +
                         dt2o12 * (w6p[kk - 1] * d3up * d3map +
                                   w6m[kk - 1] * d3um * d3mam +
                                   w6p[kk - 1] * d3uap * d3mp +
                                   w6m[kk - 1] * d3uam * d3mm))) +
                 w8[kk - 1] * c8 *
            ...
            // w-v
            pd =
                ((0.5 * (w6p[kk - 1] * d3vp * d3mp + w6m[kk - 1] * d3vm * d3mm +
                         dt2o12 * (w6p[kk - 1] * d3vp * d3map +
                                   w6m[kk - 1] * d3vm * d3mam +
                                   w6p[kk - 1] * d3vap * d3mp +
                                   w6m[kk - 1] * d3vam * d3mm))) +
                 w8[kk - 1] * c8 *
            ...
            // w-w
            pd =
                ((0.5 * (w6p[kk - 1] * d3wp * d3mp + w6m[kk - 1] * d3wm * d3mm +
                         dt2o12 * (w6p[kk - 1] * d3wp * d3map +
                                   w6m[kk - 1] * d3wm * d3mam +
                                   w6p[kk - 1] * d3wap * d3mp +
                                   w6m[kk - 1] * d3wam * d3mm))) +
                 w8[kk - 1] * c8 *
