...
class GridGeneratorGeneral : public GridGenerator {
  ...
  void generate_grid_and_met_old(EW* a_ew, Sarray& a_x, Sarray& a_y,
                                 Sarray& a_z, Sarray& a_jac, Sarray& a_met);
  bool grid_mapping_old(float_sw4 p, float_sw4 q, float_sw4 r, sw4_type g,
                        float_sw4& x, float_sw4& y, float_sw4& z,
                        Sarray& TopoGridExt, float_sw4 h, sw4_type Nz);
  bool inverse_grid_mapping_old(EW* a_ew, float_sw4 p, float_sw4 q, float_sw4 r,
                                sw4_type g, float_sw4& x, float_sw4& y, float_sw4& z,
                                Sarray& TopoGridExt, float_sw4 h, sw4_type Nz);

  void grid_mapping_diff_old(EW* a_EW, float_sw4 q, float_sw4 r, float_sw4 s,
                             sw4_type g, sw4_type ic, sw4_type jc, sw4_type kc, float_sw4& zq,
                             float_sw4& zr, float_sw4& zs, float_sw4& zqq,
                             float_sw4& zqr, float_sw4& zqs, float_sw4& zrr,
                             float_sw4& zrs, float_sw4& zss,
                             Sarray& TopoGridExt, float_sw4 h, sw4_type Nz);

  bool grid_mapping_new(EW* a_ew, float_sw4 q, float_sw4 r, float_sw4 s, sw4_type g,
                        float_sw4& x, float_sw4& y, float_sw4& z, float_sw4 h,
                        sw4_type Nz);

  bool inverse_grid_mapping_new(EW* a_ew, float_sw4 x, float_sw4 y, float_sw4 z,
                                sw4_type g, float_sw4& q, float_sw4& r, float_sw4& s,
                                float_sw4 h, sw4_type Nz);
  void grid_mapping_diff_new(EW* a_ew, float_sw4 q, float_sw4 r, float_sw4 s,
                             sw4_type g, sw4_type ic, sw4_type jc, sw4_type kc, float_sw4& zq,
                             float_sw4& zr, float_sw4& zs, float_sw4& zqq,
                             float_sw4& zqr, float_sw4& zqs, float_sw4& zrr,
                             float_sw4& zrs, float_sw4& zss, float_sw4 h,
                             sw4_type Nz);
 ...
 public:
  ...
  virtual void grid_mapping_diff(EW* a_ew, float_sw4 q, float_sw4 r,
                                 ...
                                 float_sw4& zss);
  virtual void generate_z_and_j(EW* a_ew, sw4_type g, Sarray& z, Sarray& J);
};
#endif
