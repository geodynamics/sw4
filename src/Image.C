...
Image::Image(EW* a_ew, float_sw4 time, float_sw4 timeInterval, int cycle,
             ...
             bool doubleMode, bool userCreated)
    : mTime(time),
      mEW(a_ew),
      m_time_done(false),
...
void Image::associate_gridfiles(vector<Image*>& imgs) {
  ...
  if (mEW->topographyExists() &&
    ...
    if (m_gridimage == Image::nil) {
      m_gridimage = new Image(mEW, 0.0, 0.0, 0, 0, mFilePrefix, Image::GRIDZ,
                              mLocationType, mCoordValue, m_double, false);
...
void Image::writeImagePlane_2(int cycle, std::string& path, float_sw4 t) {
  ...
  if (ihavearray) {
    for (int g = glow; g < ghigh; g++) {
      ...
      if (!mEW->usingParallelFS() || g == glow) MPI_Barrier(m_mpiComm_writers);
        ...
        for (int j = mWindow[g][2]; j <= mWindow[g][3]; j++)
          for (int i = mWindow[g][0]; i <= mWindow[g][1]; i++) {
            ...
            if (i == 1) {
              ...
              //  3*a_U[g](1,i+3,j,k)-(1+ot)*a_U[g](1,i+4,j,k)
              //  +os*a_U[g](1,i+5,j,k);
            ...
            if (i == 2) {
              // duxdq  = -os*a_U[g](1,i-1,j,k)
              // -1.25*a_U[g](1,i,j,k)+(1+ft)*a_U[g](1,i+1,j,k)
              //  - ft*a_U[g](1,i+2,j,k) + 0.5*a_U[g](1,i+3,j,k) -
              //  ot*a_U[g](1,i+4,j,k);
              ...
              // duxdq = c1*(a_U[g](1,i+1,j,k) -
              // a_U[g](1,i-1,j,k))+c2*(a_U[g](1,i+2,j,k) - a_U[g](1,i-2,j,k));
            ...
            if (j == 1) {
              duxdr = -2.25 * a_U[g](1, i, j, k) +
                      ...
                      os * a_U[g](1, i, j + 5, k);
              // duydr
              // =-2.25*a_U[g](2,i,j,k)+(4+fs)*a_U[g](2,i,j+1,k)-d3*a_U[g](2,i,j+2,k)+
              //  3*a_U[g](2,i,j+3,k)-(1+ot)*a_U[g](2,i,j+4,k)
              //  +os*a_U[g](2,i,j+5,k);
            ...
            if (j == 2) {
              duxdr = -os * a_U[g](1, i, j - 1, k) - 1.25 * a_U[g](1, i, j, k) +
                      ...
                      0.5 * a_U[g](1, i, j + 3, k) -
                      ot * a_U[g](1, i, j + 4, k);
              // duydr = -os*a_U[g](2,i,j-1,k)
              // -1.25*a_U[g](2,i,j,k)+(1+ft)*a_U[g](2,i,j+1,k)
              //  - ft*a_U[g](2,i,j+2,k) + 0.5*a_U[g](2,i,j+3,k) -
              //  ot*a_U[g](2,i,j+4,k);
              ...
              duxdr = c1 * (a_U[g](1, i, j + 1, k) - a_U[g](1, i, j - 1, k)) +
                      c2 * (a_U[g](1, i, j + 2, k) - a_U[g](1, i, j - 2, k));
              // duydr = c1*(a_U[g](2,i,j+1,k) -
              // a_U[g](2,i,j-1,k))+c2*(a_U[g](2,i,j+2,k) - a_U[g](2,i,j-2,k));
