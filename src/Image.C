...
void Image::writeImagePlane_2(int cycle, std::string& path, float_sw4 t) {
  ...
  if (m_usehdf5 == false && m_pio[0]->proc_zero()) {
    ...
    if (h5_fid < 0)
      VERIFY2(0, "ERROR: Image::writeImagePlane_2, error opening HDF5 file "
                     << s.str() << " for writing header");
  ...
  if (m_usehdf5 == false) {
    ...
    if (mGridinfo == 1) add_grid_to_file(s.str().c_str(), iwrite, offset);
      ...
      for (int g = glow; g < ghigh; g++) {
        ...
        if (m_double) {
          ...
          m_pio[g - glow]->write_array_hdf5((const char*)(s.str().c_str()),
                                            "patches", 1, m_doubleField[g],
                                            offset, dblStr);
          /* m_pio[g-glow]->write_array_hdf5( dset, 1, m_doubleField[g], offset,
           * dblStr ); */
          offset += (globalSizes[0] * globalSizes[1] * globalSizes[2]);
        } else {
          char fltStr[] = "float";
          m_pio[g - glow]->write_array_hdf5((const char*)(s.str().c_str()),
                                            "patches", 1, m_floatField[g],
                                            offset, fltStr);
          offset += (globalSizes[0] * globalSizes[1] * globalSizes[2]);
        }
      }
...
void Image::add_grid_to_file_hdf5(const char* fname, bool iwrite,
  ...
  if (ihavearray) {
    ...
    if (m_double) {
      char dblStr[] = "double";
      m_pio[g]->write_array_hdf5(fname, "grid", 1,
                                 m_gridimage->m_doubleField[g], offset, dblStr);
      /* m_pio[g]->write_array_hdf5(dset, 1, m_gridimage->m_doubleField[g],
       * offset, dblStr ); */
      offset +=
          (globalSizes[0] * globalSizes[1] * globalSizes[2] * sizeof(double));
    } else {
      char fltStr[] = "float";
      m_pio[g]->write_array_hdf5(fname, "grid", 1, m_gridimage->m_floatField[g],
                                 offset, fltStr);
      /* m_pio[g]->write_array_hdf5(dset, 1, m_gridimage->m_floatField[g],
       * offset, fltStr ); */
      offset +=
...
//   // plane_in_proc returns true for z=const lpanes, because all processors
//   have
//   // a part in these planes
//   bool iwrite = plane_in_proc(m_gridPtIndex[0]);
//   if (iwrite) {
...
//                     - (1 + ot) * a_U[g](1, i + 4, j, k) + os * a_U[g](1, i +
//                     5, j, k);
//             } else if (i == 2) {
//               val = -os * a_U[g](1, i - 1, j, k) - 1.25 * a_U[g](1, i, j, k)
//               +
//                     (1 + ft) * a_U[g](1, i + 1, j, k) -
//                     ft * a_U[g](1, i + 2, j, k) + 0.5 * a_U[g](1, i + 3, j,
//                     k) - ot * a_U[g](1, i + 4, j, k);
...
//                      - (1 + ot) * a_U[g](2, i, j + 4, k) + os * a_U[g](2, i,
//                      j + 5, k);
//             } else if (j == 2) {
...
//                      ft * a_U[g](2, i, j + 2, k) +
//                      0.5 * a_U[g](2, i, j + 3, k) - ot * a_U[g](2, i, j + 4,
//                      k);
...
//                      - (1 + ot) * a_U[g](3, i, j, k + 4) + os * a_U[g](3, i,
//                      j, k + 5);
...
//                      ft * a_U[g](3, i, j, k + 2) +
//                      0.5 * a_U[g](3, i, j, k + 3) - ot * a_U[g](3, i, j, k +
//                      4);
...
//                      (-2.25 * a_U[g](2, i, j, k) +
//                       (4 + fs) * a_U[g](2, i, j + 1, k) -
//                       d3 * a_U[g](2, i, j + 2, k) + 3 * a_U[g](2, i, j + 3,
//                       k) - (1 + ot) * a_U[g](2, i, j + 4, k) + os * a_U[g](2,
//                       i, j + 5, k));
//             } else if (j == 2) {
//               val +=
//                   mEW->mMetric(1, i, j, k) *
...
//                      +
//                       c2 * (a_U[g](2, i, j + 2, k) - a_U[g](2, i, j - 2,
//                       k)));
//             }
...
//                       +
//                        c2 * (a_U[g](1, i, j, k + 2) - a_U[g](1, i, j, k -
//                        2))) +
//                   mEW->mMetric(3, i, j, k) *
//                       (c1 * (a_U[g](2, i, j, k + 1) - a_U[g](2, i, j, k - 1))
//                       +
//                        c2 * (a_U[g](2, i, j, k + 2) - a_U[g](2, i, j, k -
//                        2))) +
//                   mEW->mMetric(4, i, j, k) *
//                       (c1 * (a_U[g](3, i, j, k + 1) - a_U[g](3, i, j, k - 1))
//                       +
//                        c2 * (a_U[g](3, i, j, k + 2) - a_U[g](3, i, j, k -
//                        2)));
//             }
...
//                       d3 * a_U[g](2, i + 2, j, k) + 3 * a_U[g](2, i + 3, j,
//                       k) - (1 + ot) * a_U[g](2, i + 4, j, k) + os * a_U[g](2,
//                       i + 5, j, k);
//               duzdx = -2.25 * a_U[g](3, i, j, k) +
//                       (4 + fs) * a_U[g](3, i + 1, j, k) -
//                       d3 * a_U[g](3, i + 2, j, k) + 3 * a_U[g](3, i + 3, j,
//                       k) - (1 + ot) * a_U[g](3, i + 4, j, k) + os * a_U[g](3,
//                       i + 5, j, k);
//             } else if (i == 2) {
//               duydx = -os * a_U[g](2, i - 1, j, k) - 1.25 * a_U[g](2, i, j,
//               k) +
//                       (1 + ft) * a_U[g](2, i + 1, j, k) -
//                       ft * a_U[g](2, i + 2, j, k) +
//                       0.5 * a_U[g](2, i + 3, j, k) -
//                       ot * a_U[g](2, i + 4, j, k);
//               duzdx = -os * a_U[g](3, i - 1, j, k) - 1.25 * a_U[g](3, i, j,
//               k) +
...
//                       d3 * a_U[g](1, i, j + 2, k) + 3 * a_U[g](1, i, j + 3,
//                       k) - (1 + ot) * a_U[g](1, i, j + 4, k) + os * a_U[g](1,
//                       i, j + 5, k);
//               duzdy = -2.25 * a_U[g](3, i, j, k) +
//                       (4 + fs) * a_U[g](3, i, j + 1, k) -
//                       d3 * a_U[g](3, i, j + 2, k) + 3 * a_U[g](3, i, j + 3,
//                       k) - (1 + ot) * a_U[g](3, i, j + 4, k) + os * a_U[g](3,
//                       i, j + 5, k);
//             } else if (j == 2) {
//               duxdy = -os * a_U[g](1, i, j - 1, k) - 1.25 * a_U[g](1, i, j,
//               k) +
//                       (1 + ft) * a_U[g](1, i, j + 1, k) -
//                       ft * a_U[g](1, i, j + 2, k) +
//                       0.5 * a_U[g](1, i, j + 3, k) -
//                       ot * a_U[g](1, i, j + 4, k);
//               duzdy = -os * a_U[g](3, i, j - 1, k) - 1.25 * a_U[g](3, i, j,
//               k) +
...
//                       (4 + fs) * a_U[g](1, i, j, k + 1) -
//                       d3 * a_U[g](1, i, j, k + 2) + 3 * a_U[g](1, i, j, k +
//                       3) - (1 + ot) * a_U[g](1, i, j, k + 4) + os * a_U[g](1,
//                       i, j, k + 5);
//               duydz = -2.25 * a_U[g](2, i, j, k) +
//                       (4 + fs) * a_U[g](2, i, j, k + 1) -
//                       d3 * a_U[g](2, i, j, k + 2) + 3 * a_U[g](2, i, j, k +
//                       3) - (1 + ot) * a_U[g](2, i, j, k + 4) + os * a_U[g](2,
//                       i, j, k + 5);
//             } else if (k == 2 && g == mEW->mNumberOfGrids - 1) {
//               duxdz = -os * a_U[g](1, i, j, k - 1) - 1.25 * a_U[g](1, i, j,
//               k) +
//                       (1 + ft) * a_U[g](1, i, j, k + 1) -
//                       ft * a_U[g](1, i, j, k + 2) +
//                       0.5 * a_U[g](1, i, j, k + 3) -
//                       ot * a_U[g](1, i, j, k + 4);
//               duydz = -os * a_U[g](2, i, j, k - 1) - 1.25 * a_U[g](2, i, j,
//               k) +
//                       (1 + ft) * a_U[g](2, i, j, k + 1) -
//                       ft * a_U[g](2, i, j, k + 2) +
//                       0.5 * a_U[g](2, i, j, k + 3) -
...
//                       (4 + fs) * a_U[g](1, i + 1, j, k) -
//                       d3 * a_U[g](1, i + 2, j, k) + 3 * a_U[g](1, i + 3, j,
//                       k) - (1 + ot) * a_U[g](1, i + 4, j, k) + os * a_U[g](1,
//                       i + 5, j, k);
...
//             }
//             if (i == 2) {
//               duxdq = -os * a_U[g](1, i - 1, j, k) - 1.25 * a_U[g](1, i, j,
//               k) +
//                       (1 + ft) * a_U[g](1, i + 1, j, k) -
//                       ft * a_U[g](1, i + 2, j, k) +
//                       0.5 * a_U[g](1, i + 3, j, k) -
//                       ot * a_U[g](1, i + 4, j, k);
//               duydq = -os * a_U[g](2, i - 1, j, k) - 1.25 * a_U[g](2, i, j,
//               k) +
//                       (1 + ft) * a_U[g](2, i + 1, j, k) -
//                       ft * a_U[g](2, i + 2, j, k) +
//                       0.5 * a_U[g](2, i + 3, j, k) -
//                       ot * a_U[g](2, i + 4, j, k);
//               duzdq = -os * a_U[g](3, i - 1, j, k) - 1.25 * a_U[g](3, i, j,
//               k) +
//                       (1 + ft) * a_U[g](3, i + 1, j, k) -
//                       ft * a_U[g](3, i + 2, j, k) +
//                       0.5 * a_U[g](3, i + 3, j, k) -
...
//             }
//             if (j == 2) {
//               duxdr = -os * a_U[g](1, i, j - 1, k) - 1.25 * a_U[g](1, i, j,
//               k) +
//                       (1 + ft) * a_U[g](1, i, j + 1, k) -
//                       ft * a_U[g](1, i, j + 2, k) +
//                       0.5 * a_U[g](1, i, j + 3, k) -
//                       ot * a_U[g](1, i, j + 4, k);
//               duydr = -os * a_U[g](2, i, j - 1, k) - 1.25 * a_U[g](2, i, j,
//               k) +
//                       (1 + ft) * a_U[g](2, i, j + 1, k) -
//                       ft * a_U[g](2, i, j + 2, k) +
//                       0.5 * a_U[g](2, i, j + 3, k) -
//                       ot * a_U[g](2, i, j + 4, k);
//               duzdr = -os * a_U[g](3, i, j - 1, k) - 1.25 * a_U[g](3, i, j,
//               k) +
//                       (1 + ft) * a_U[g](3, i, j + 1, k) -
//                       ft * a_U[g](3, i, j + 2, k) +
//                       0.5 * a_U[g](3, i, j + 3, k) -
...
//                       (4 + fs) * a_U[g](3, i, j, k + 1) -
//                       d3 * a_U[g](3, i, j, k + 2) + 3 * a_U[g](3, i, j, k +
//                       3) - (1 + ot) * a_U[g](3, i, j, k + 4) + os * a_U[g](3,
//                       i, j, k + 5);
//             }
//             if (k == 2) {
//               duxds = -os * a_U[g](1, i, j, k - 1) - 1.25 * a_U[g](1, i, j,
//               k) +
//                       (1 + ft) * a_U[g](1, i, j, k + 1) -
//                       ft * a_U[g](1, i, j, k + 2) +
//                       0.5 * a_U[g](1, i, j, k + 3) -
//                       ot * a_U[g](1, i, j, k + 4);
//               duyds = -os * a_U[g](2, i, j, k - 1) - 1.25 * a_U[g](2, i, j,
//               k) +
//                       (1 + ft) * a_U[g](2, i, j, k + 1) -
//                       ft * a_U[g](2, i, j, k + 2) +
//                       0.5 * a_U[g](2, i, j, k + 3) -
//                       ot * a_U[g](2, i, j, k + 4);
//               duzds = -os * a_U[g](3, i, j, k - 1) - 1.25 * a_U[g](3, i, j,
//               k) +
//                       (1 + ft) * a_U[g](3, i, j, k + 1) -
//                       ft * a_U[g](3, i, j, k + 2) +
//                       0.5 * a_U[g](3, i, j, k + 3) -
          ...
          for (int j = mWindow[g][2]; j <= mWindow[g][3]; j++)
            for (int i = mWindow[g][0]; i <= mWindow[g][1]; i++) {
              ...
              if (i == 2) {
                // duxdq =
                //     -os * a_U[g](1, i - 1, j, k) - 1.25 * a_U[g](1, i, j, k)
                //     + (1 + ft) * a_U[g](1, i + 1, j, k) - ft * a_U[g](1, i +
                //     2, j, k) + 0.5 * a_U[g](1, i + 3, j, k) - ot * a_U[g](1,
                //     i + 4, j, k);
                duydq =
                ...
                // duxdq = c1 * (a_U[g](1, i + 1, j, k) - a_U[g](1, i - 1, j,
                // k)) +
                //         c2 * (a_U[g](1, i + 2, j, k) - a_U[g](1, i - 2, j,
                //         k));
                duydq = c1 * (a_U[g](2, i + 1, j, k) - a_U[g](2, i - 1, j, k)) +
                        c2 * (a_U[g](2, i + 2, j, k) - a_U[g](2, i - 2, j, k));
                duzdq = c1 * (a_U[g](3, i + 1, j, k) - a_U[g](3, i - 1, j, k)) +
              ...
              if (j == 2) {
                ...
                // duydr =
                //     -os * a_U[g](2, i, j - 1, k) - 1.25 * a_U[g](2, i, j, k)
                //     + (1 + ft) * a_U[g](2, i, j + 1, k) - ft * a_U[g](2, i, j
                //     + 2, k) + 0.5 * a_U[g](2, i, j + 3, k) - ot * a_U[g](2,
                //     i, j + 4, k);
                duzdr =
                ...
                //     os * a_U[g](2, i, j + 1, k) + 1.25 * a_U[g](2, i, j, k) -
                //     (1 + ft) * a_U[g](2, i, j - 1, k) +
                //     ft * a_U[g](2, i, j - 2, k) - 0.5 * a_U[g](2, i, j - 3,
                //     k) + ot * a_U[g](2, i, j - 4, k);
                duzdr =
                    os * a_U[g](3, i, j + 1, k) + 1.25 * a_U[g](3, i, j, k) -
                    (1 + ft) * a_U[g](3, i, j - 1, k) +
                    ft * a_U[g](3, i, j - 2, k) - 0.5 * a_U[g](3, i, j - 3, k) +
                ...
                duxdr = c1 * (a_U[g](1, i, j + 1, k) - a_U[g](1, i, j - 1, k)) +
                        c2 * (a_U[g](1, i, j + 2, k) - a_U[g](1, i, j - 2, k));
                // duydr = c1 * (a_U[g](2, i, j + 1, k) - a_U[g](2, i, j - 1,
                // k)) +
                //         c2 * (a_U[g](2, i, j + 2, k) - a_U[g](2, i, j - 2,
                //         k));
                duzdr = c1 * (a_U[g](3, i, j + 1, k) - a_U[g](3, i, j - 1, k)) +
