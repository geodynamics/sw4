...
//-----------------------------------------------------------------------
int EW::metric_ci(int ib, int ie, int jb, int je, int kb, int ke,
...
//-----------------------------------------------------------------------
void EW::metricexgh_ci(int ib, int ie, int jb, int je, int kb, int ke, int nz,
                       float_sw4* __restrict__ a_x, float_sw4* __restrict__ a_y,
