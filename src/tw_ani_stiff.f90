  ...
  do k=kfirst,klast
     do j=jfirst,jlast
        do i=ifirst,ilast
           ...
           cm(1,i,j,k)= 2+sin(omm*x+phc(1))*cos(omm*y+phc(1))*sin(omm*z+phc(1))
           ...
           cm(7,i,j,k)= 2+sin(omm*x+phc(7))*cos(omm*y+phc(4))*sin(omm*z+phc(7))
           ...
           cm(12,i,j,k)=2+sin(omm*x+phc(12))*cos(omm*y+phc(6))*sin(omm*z+phc(3))
           ...
           cm(16,i,j,k)=2+sin(omm*x+phc(16))*cos(omm*y+phc(8))*sin(omm*z+phc(7))
           ...
           cm(19,i,j,k)=2+sin(omm*x+phc(19))*cos(omm*y+phc(10))*sin(omm*z+phc(10))
           cm(20,i,j,k)=2+sin(omm*x+phc(20))*cos(omm*y+phc(10))*sin(omm*z+phc(11))
           cm(21,i,j,k)=2+sin(omm*x+phc(21))*cos(omm*y+phc(10))*sin(omm*z+phc(12))
        enddo
     enddo
  enddo
