...
class GridGenerator
{
 ...
 public:
   GridGenerator( float_sw4 topo_zmax, bool always_new, int grid_interpolation_order,
                float_sw4 zetaBreak )
     : m_topo_zmax(topo_zmax),  m_zetaBreak(zetaBreak), m_always_new(always_new),
