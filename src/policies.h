...
using DEFAULT_LOOP4 =
    RAJA::KernelPolicy<RAJA::statement::CudaKernel<RAJA::statement::For<
        ...
        RAJA::statement::For<
            ...
            RAJA::statement::For<
                2, RAJA::cuda_threadblock_exec<1024>,
...
// Increasing the 16,16 block size below can cause failures with the error
// message:
// CUDAassert: too many resources requested for launch
// /usr/workspace/wsb/deg/ramesh/RAJA_01_24_2018/RAJA/install_nomp/include/RAJA/policy/cuda/MemUtils_CUDA.hpp
// 216
