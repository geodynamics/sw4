...
//-----------------------------------------------------------------------
MaterialVolimagefile::MaterialVolimagefile(
    EW* a_ew, bool rhomula, std::string path, std::string rhofile,
    std::string mufile, std::string lambdafile, std::string qpfile,
    std::string qsfile)
    : mEW(a_ew) {
...
//-----------------------------------------------------------------------
void MaterialVolimagefile::set_material_properties(std::vector<Sarray>& rho,
  ...
  //   mEW->check_min_max_sw4_type( rho );
