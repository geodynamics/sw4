...
//-----------------------------------------------------------------------
void EW::anisomtrltocurvilinear_ci( int ifirst, int ilast, int jfirst, int jlast, int kfirst, int klast,
				float_sw4* __restrict__ a_met, float_sw4* __restrict__ a_c,
...
#define cind( i1, i2, i3, i4 ) _cind[i1-1+3*(i2-1)+9*(i3-1)+27*(i4-1)]
