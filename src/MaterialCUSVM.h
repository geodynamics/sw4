...
#ifndef MATERIALCUSVM_FILE
#define MATERIALCUSVM_FILE
...
class MaterialCUSVM : public MaterialData
{
  public:
    
    MaterialCUSVM( EW * a_ew, const std::string file, const std::string directory);
