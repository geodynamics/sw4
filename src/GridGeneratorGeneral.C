...
#pragma omp parallel for
  ...
  int ierr = 0;
  ierr = metric_ci(a_x.m_ib, a_x.m_ie, a_x.m_jb, a_x.m_je, a_x.m_kb,
...
//-----------------------------------------------------------------------
void GridGeneratorGeneral::generate_grid_and_met_new( EW *a_ew, int g, Sarray& a_x, Sarray& a_y, Sarray& a_z, Sarray& a_jac, Sarray& a_met )
{
