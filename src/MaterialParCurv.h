#ifndef MATERIALPARCURV_H
#define MATERIALPARCURV_H
...
//
//
class MaterialParCurv : public MaterialParameterization {
 protected:
 ...
 public:
  MaterialParCurv(EW* a_ew, int nx, int ny, int nz, int init, int varcase,
