...
with ${\cal O}(10,000)$ cores. We believe (hope) it will run well on even larger machines.
...
of the functionality of \emph{WPP} (version 2.2). The remaining features will be added in the future.
...
Laboratory. The underlying numerical methods were developed under partial support from
...
has already figured out some of these details for your system. You might therefore save yourself a
lot of time by talking to your local system administrator about how to run parallel programs your
system.
...
\begin{figure}
\begin{centering}
  \includegraphics[width=0.6\linewidth]{latlon.png}
...
\begin{figure}
\begin{centering}
  \includegraphics[width=0.4\linewidth]{f11-verysmoothbump.png}
  \includegraphics[width=0.4\linewidth]{f12-c6smoothbump.png}
