...
solution is simulated up to time $t=0.8$ on grids with grid size $h=1/30$, $1/60$, and $1/120$,
respectively. The results of the simulations are given in the three output files
\begin{verbatim}
...
$121$ & $8.333\cdot 10^{-3}$  & $x.yz\cdot 10^{-5}$ & xxx & xxx \\ \hline
\end{tabular}
\caption{Max norm errors in the displacement at time $t=0.8$, with a Gaussian hill topography. The
  number of grid points and the grid size are in the Cartesian grid.}
