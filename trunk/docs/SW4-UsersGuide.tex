...
shear velocity is always $C_s = C_p/\sqrt{3}$. Note that only the vertical component of the exact
solution is available, and we have only implemented the formulas for evaluating it along the free
surface ($z=0$).
