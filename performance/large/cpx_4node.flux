...
#flux: --job-name=SW4
#flux: --output='CPX_4NODE_RERUN.{{id}}.out'
#flux: --error='CPX_4NODE_RERUN.{{id}}.err'
#flux: -N 4
#flux: -l # Label I/O
...
for i in $(seq 1 50);
do
	flux run -N4 -n96 -x -l -o initrc=/collab/usr/global/tools/mpi/mpibind/utils/mpibind-flux-250109.lua hpcrun ./sw4 4node.in
done
