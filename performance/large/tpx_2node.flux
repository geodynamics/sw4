...
rocm-smi
flux run -N 2-n 24 -x -l -o initrc=/collab/usr/global/tools/mpi/mpibind/utils/mpibind-flux-250109.lua env | grep ROCR
for i in $(seq 1 50);
do
	flux run -N2 -n24 -x -l -o initrc=/collab/usr/global/tools/mpi/mpibind/utils/mpibind-flux-250109.lua ./sw4 hmr3.in.lassen
done
